...
*   Agregar en la sección `[workspace.members]`: `"packages/experimental-lisp"` and `"packages/experimental-governance"`.
...
*   Remover las importaciones directas de `crate::eval::LispSandbox` and `crate::parser::lisp::parse`.
