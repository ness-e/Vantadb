...
The numbers we stand behind for this pattern (batch throughput, competitive recall) live in `docs/operations/BENCHMARKS.md`. Reproduce them on your hardware before quoting them — that file documents the exact commands.
