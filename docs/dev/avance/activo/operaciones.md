...
- **Resultado:** ✅ Documentado el gate en docs/user/operations/ci-cd-guide.md (job table + sección dedicada con install local y scope antadb-only) + cross-ref en docs/user/operations/CI_POLICY.md (job table §1) + docs/user/operations/master-index.md last_reviewed actualizado. Contrato del plan verificado: cargo semver-checks --help → 92 líneas (path 1 ✅) + 6 matches de semver-checks en docs/user/operations/ (path 2 ✅).
- **Archivos tocados:** docs/user/operations/ci-cd-guide.md, docs/user/operations/CI_POLICY.md, docs/user/operations/master-index.md
...
- **Resultado:** ✅ ambas URLs verificadas live 404 (`github.com/vantadb/vantadb-examples` y `github.com/ness-e/vantadb-examples`); ningún repo existe en ninguna org → rama TODO-humano del contrato (no crear repos desde el agente). `docs/user/operations/pilot-onboarding-checklist.md:51` ahora TODO explícito en inglés; `rg "vantadb/vantadb-examples" docs/user/operations/ docs/api/` = 0. Fila Backlog eliminada (con ella muere la cita a la ruta vieja `pilot-onboarding-checklist.md` — la canónica es `docs/user/operations/...`).
- **Archivos tocados:** `docs/user/operations/pilot-onboarding-checklist.md`, `docs/dev/Backlog.md` (fila removida), `docs/dev/plans/2026-09-03-quality-gtm-wave.md` (Task 3 → ✅)
...
- **Archivos tocados:** `Dockerfile`, `.dockerignore`, `.github/workflows/release-binaries-63.yml`, `docs/user/operations/DEPLOYMENT_GUIDE.md`, `docs/user/operations/CI_POLICY.md`, `docs/dev/Backlog.md` (fila SRV-07 eliminada), `docs/dev/plans/2026-09-03-quality-gtm-wave.md` (Task 5 ✅ + recitation), `docs/dev/avance/activo/operaciones.md`.
