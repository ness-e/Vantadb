...
> **Cruce:** el código frontend vive en `web/` + `docs/`; SEO/docs siguen reglas en `docs/dev/avance/activo/operaciones.md` (docs site governance).
...
- **Fuente:** Plan `docs/dev/plans/archive/2026-08-19-web-design-audit.md` · Reporte: `docs/dev/reviews/web-design-audit-2026-08-24.md`
...
- **Fuente:** Plan `docs/dev/plans/2026-09-02-error-observability-excellence.md` Task 7 (Wave 3) · Task file `.opencode/skills/campaign-executor/tasks/ERR-WEB-01.md`
...
- **Fuente:** Plan `docs/dev/plans/2026-09-03-quality-gtm-wave.md` Task 7 (Wave 2) · WCAG 2.5.5 pre-Show-HN
...
- **Fuente:** Plan `docs/dev/plans/2026-09-07-backlog-triage.md` Task 7 (Wave2) · Task file `docs/dev/tasks/WEB-02.md`
