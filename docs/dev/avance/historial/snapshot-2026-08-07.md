...
**Fuente:** Backlog (plan `docs/dev/plans/2026-08-04-launch-web-campaign.md`)

**Ejecutada por:** pipeline paralelo (vanta-docs/vanta-worker + orquestador vanta-lead)

- **MKT-05:** 5/5 blog posts técnicos — 5º añadido `docs/user/blog/benchmarks_vs_lancedb_chroma.md` (run real glove-100-angular: VantaDB 241.4 QPS/recall 100%/p50 4.124ms). Commit `bf5e6c1e`.
...
- **GH-119:** guía `docs/user/tutorials/migrate-from-vectara.md` (259 líneas), issue #119 cerrado. Commit `ebfb3363`.
