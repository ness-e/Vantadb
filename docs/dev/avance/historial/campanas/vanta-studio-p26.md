...
> Plan `docs/dev/plans/2026-08-18-vanta-studio-fase0.md` (archivado). Registro completo por tarea; resumen ejecutivo en `docs/dev/Backlog.md` P26.

### VS-00: Prototipo HTML Fase 0 core (3 pantallas navegables)
- **Fuente:** Plan `docs/dev/plans/2026-08-18-vanta-studio-fase0.md`
- **Fecha:** 2026-08-18
...
- **Fuente:** Plan `docs/dev/plans/2026-08-18-vanta-studio-fase1.md`
- **Fecha:** 2026-08-18
...
- **Fuente:** Plan `docs/dev/plans/2026-08-18-vanta-studio-fase2.md`
- **Fecha:** 2026-08-19
