...
| `PERF-01` | Bench-Honestidad: re-validar claims de rendimiento del README ("100k docs en 0.6s") contra benches reales → `30e90cd9` bench revalidado; `docs/user/benchmarks/` actualizado; claims soportadas por metodología+HW | 🟡 | ✅ 2026-08-12 |
