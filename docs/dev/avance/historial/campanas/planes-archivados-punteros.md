...
- **Plan archivado:** `docs/dev/plans/archive/2026-08-12-ci-deuda.md` — 6/6 completadas (CI-02..07, deuda CI batch)
...
- **Plan archivado:** `docs/dev/plans/archive/2026-08-16-wave-p20-tsys.md` — 25/25 completadas (wave P20-TSYS: TSYS-06 + R1/R3/R5/R6/R8/R9/R10 + FND-01..24 activas; 21 commits en develop desde `ec7f947a` hasta `a159211b`)
...
- **Plan archivado:** `docs/dev/plans/archive/2026-08-18-vanta-studio-fase3.md` — 7/7 completadas (Vanta Studio Fase 3: web/embebido — transporte pluggable, REST completo del SDK, dashboard `/dashboard` servido por el server)
...
- **Plan archivado:** `docs/dev/plans/archive/2026-08-18-vanta-studio-fase2.md` — 10/10 completadas (Vanta Studio Fase 2: gaps core VS-CORE-04/05/06 + lente GRAFO R3F + lente ESPACIO + operaciones import/batch)
...
- **Plan archivado:** `docs/dev/plans/archive/2026-08-17-skills-vantadb.md` - 4/4 completadas (wave SKL: skills de VantaDB corregidas)
...
- **Plan archivado:** `docs/dev/plans/archive/2026-08-18-vanta-studio-fase1.md` — 9/9 completadas (P26 Studio Fase 1: explicabilidad y tiempo)
...
- **Plan archivado:** `docs/dev/plans/archive/2026-08-23-task-system-hardening.md` — ✅ COMPLETED (hardening I: H1-H9 campaign server + question gates HITL; contrato `node --test .opencode/task-system/mcp/` 38/38; commits `fcd7b243` + `26f68ff7`)
- **Retrospectiva:** ver header del plan (recitation final + retrospectiva en el propio archivo, commit `784e3c68`)

- **Plan archivado:** `docs/dev/plans/archive/2026-08-23-task-system-hardening-2.md` — 12/12 completadas (hardening II: R1-R7 paralelismo real multi-instancia + S1 spec-first + D1-D4 limpieza decidida; 42/42 tests; commits `1a86bd2a`, `ed6c6ae7`, `b8a23939`, `3cc0aa50`)
...
- **Plan archivado:** `docs/dev/plans/archive/2026-08-23-backlog-triage.md` — 16/17 ✅ + 1 SKIP tardío (triage del Backlog: 6 bugs 🔴 + 7 quick wins + 3 tools MCP + REVIEW-09; REVIEW-16 SKIP por ya-resuelto colateral). Fuente: triage Gate P de `docs/dev/Backlog.md` confirmado por owner.
