...
| MKT-12 | Performance claims audit vs benchmarks reales | ✅ Metodología publicada en `docs/user/operations/BENCHMARKS.md` |
| DOC-21 | Performance clarity doc: Rust core vs Python SDK | ✅ Archivo existe: `docs/user/operations/PERFORMANCE_GUIDE.md` (488L) |
| MCP-03 | WASM benchmarks + feature matrix | ✅ Feature matrix 404KB gz, benchmarks en `docs/user/operations/BENCHMARKS.md` |
...
| DOC-19 | ARCHITECTURE.md → v0.2.0 + sharded WAL docs | `docs/dev/architecture/ARCHITECTURE.md`, `docs/user/glosario/*`, `docs/user/operations/*` | ✅ v0.2.0 header, u128, StorageBackend trait, component map, sharded WAL glossary |
...
| DOC-20 | LanceDB migration guide | `docs/user/tutorials/migration-from-lancedb.md` | 380-line tutorial with full migration script |
