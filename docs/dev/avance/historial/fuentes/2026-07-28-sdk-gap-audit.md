...
- `docs/dev/plans/2026-07-28-recovery-plan.md` — plan detallado (37KB, 11 tasks, 4 fases)
- `docs/dev/Backlog.md` Phase 8 — SDK-01 a SDK-05 existentes + REC-001, REC-007–010, REC-999 agregados (filas SDK-01..05, REC-001, REC-007, REC-999 — actualizadas 2026-08-03, todas ✅ tachadas)
