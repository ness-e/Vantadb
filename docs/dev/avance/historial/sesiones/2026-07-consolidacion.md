...
> Copia verbatim de la sección — sin edición. Fuente: docs/progreso/bitacora.md líneas 70-666.
...
- **Investigar:** (1) Revisar `docs/archived-decisions/` y `docs/dev/architecture/` para decisiones existentes; (2) Escribir ADRs faltantes.
- **Fuente:** AP-36
- **Esfuerzo:** 1 día
