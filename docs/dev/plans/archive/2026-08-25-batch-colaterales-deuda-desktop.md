...
- plan-adjust [2026-08-25]: creado desde docs/dev/Backlog.md. El usuario confirmó: (a) sesiones P34/P37 ya no existen → incluir desktop; (b) eliminar registros de colisión (adenda P34, H2, AGT-05 → ✅ Resuelto).
