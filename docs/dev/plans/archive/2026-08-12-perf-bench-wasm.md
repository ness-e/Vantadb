...
> **Inicio:** 2026-08-12
> **Estado:** ⏳ EN PROGRESO
> **Fuente:** docs/dev/Backlog.md § Phase 4 (líneas 114-117), selección del usuario (4 activas de 9 PERF-* pedidas)
...
- **Archivos clave:** `src/storage/wal.rs`, ADR en `docs/dev/architecture/adr/`
