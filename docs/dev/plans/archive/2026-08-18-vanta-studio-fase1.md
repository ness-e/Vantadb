...
> **Fuente:** `docs/dev/research/human-facing-db-ui/06-synthesis/SYNTHESIS.md` §7 Fase 1 + tabla DEFER del plan Fase 0 (líneas 185-200) + contratos verificados contra el core/bridge (2026-08-18).
> **Predecesor:** `docs/dev/plans/2026-08-18-vanta-studio-fase0.md` (✅ FASE 0 COMPLETA, 14/19).
