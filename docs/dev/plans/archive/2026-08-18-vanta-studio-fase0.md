...
> **Fuente:** `docs/dev/research/human-facing-db-ui/06-synthesis/SYNTHESIS.md` (concepto "Vanta Studio" + Fase 0 §7) + decisiones del usuario 2026-08-18 (ver Decisiones).
...
- **Archivos clave:** `desktop/prototype/index.html` (nuevo, autónomo con Tailwind CDN o CSS inline), `docs/dev/research/human-facing-db-ui/06-synthesis/SYNTHESIS.md`
