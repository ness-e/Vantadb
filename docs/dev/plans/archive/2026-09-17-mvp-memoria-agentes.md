...
> **Fuente:** `docs/dev/Backlog.md` + `SPEC.md` (8/8 decisiones, 0 abiertas) + research skills/hooks/distribución/OCR 2026-09-16/17
> **Autonomous:** false
...
- **Verificación real:** `ort::init().commit()` con `let _`, sin pre-chequeo; crash BadVersion documentado en `docs/dev/tasks/EMB-10.md:148-171`.
...
- Task file `docs/dev/tasks/FIND-100.md` · ✅ COMPLETED · Ruta vanta-worker. Branch develop. Commit `fix: FIND-100 — ...`.
...
- Task file `docs/dev/tasks/FIND-107.md` · ✅ COMPLETED · Ruta vanta-worker. Branch develop. Commit `feat: FIND-107 — ...`.
...
- Task file `docs/dev/tasks/SHOW-04.md` · ✅ COMPLETED · Ruta vanta-worker. Branch develop. Commit `feat: SHOW-04 — ...`.
...
- Task file `docs/dev/tasks/FIND-103.md` · ✅ COMPLETED · Ruta vanta-worker. Branch develop. Commit `docs: FIND-103 — ...`.
...
- Task file `docs/dev/tasks/FIND-104.md` · ✅ COMPLETED · Ruta vanta-worker. Branch develop. Commit `feat: FIND-104 — ...`.
...
- Task file `docs/dev/tasks/FIND-106.md` · ✅ COMPLETED · Ruta vanta-worker. Branch develop. Commit `feat: FIND-106 — ...`.

### Wave3 — comando único + review total (disjuntos: scripts/docs vs workflows)

**Task 7: FIND-105 — comando único de instalación**
- **Appetite:** 1d · **Esfuerzo:** 🟢 · **Prioridad:** 🟠 Media-Alta · **Archivos clave:** `scripts/install.sh`, `scripts/install.ps1`, `README.md`, `docs/user/QUICKSTART.md`
...
- Task file `docs/dev/tasks/FIND-105.md` · ✅ COMPLETED · Ruta vanta-lead. Branch develop. Commit `feat: FIND-105 — ...`.
...
- Task file `docs/dev/tasks/FIND-108.md` · ✅ COMPLETED · Ruta vanta-lead. Branch develop. Commit `ci: FIND-108 — ...`.
