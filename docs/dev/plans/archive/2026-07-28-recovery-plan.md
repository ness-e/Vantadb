...
- Documento de diseño en `docs/dev/architecture/incremental-backup.md`
- ADR en `docs/dev/architecture/adr/`
...
- `docs/dev/architecture/incremental-backup.md`
- `docs/dev/architecture/adr/NNN-incremental-backup.md`
...
**Entregable:** Documento de análisis en `docs/dev/research/pq-feasibility.md`
...
- [ ] `docs/dev/architecture/incremental-backup.md` creado
- [ ] ADR de backup firmado
- [ ] `docs/dev/research/pq-feasibility.md` creado
...
- [ ] NO modificar `docs/dev/Backlog.md` — solo progreso
