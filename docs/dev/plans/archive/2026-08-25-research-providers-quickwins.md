...
> **Informe:** `docs/dev/reviews/research-providers-20260825.md` (score 4.0/10)
> **Backlog:** filas PROV-01..12 en `docs/dev/Backlog.md` P45
> **Ejecutar con:** `/pipeline run docs/dev/plans/2026-08-25-research-providers-quickwins.md`
