...
> **Fuente:** docs/dev/Backlog.md (FIND-25, MCP-34b, FIND-26 — hallazgos de RES-02; confirmación del usuario 2026-08-25)
...
- **Verificación real:** ✅ CÓDIGO-REAL — RES-02 verificó: snapshot_restore = 0 ocurrencias; patrón válido probado en tests/fjall_cold_copy_restore.rs:71 (stop→copy→reopen preserva BM25/HNSW/hybrid); diseño completo en docs/dev/research/res02-backup-restore.md §2a/§3 (S2-S5).
...
- plan-adjust [2026-08-25]: creado desde docs/dev/Backlog.md. Usuario eligió dirección "Backup/restore chain". Diseño fuente: docs/dev/research/res02-backup-restore.md (RES-02, batch anterior).
