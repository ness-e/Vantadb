...
> **Fuente:** `docs/dev/research/human-facing-db-ui/06-synthesis/SYNTHESIS.md` (Fase 2 §7: "Grafo y espacio") + `03-ai-memory-graphs/RESEARCH.md` + `04-embedding-visualization/RESEARCH.md` + `05-data-editor-ux/RESEARCH.md` + backlog VS-CORE-04/05/06 + decisiones D3/D5 del usuario (2026-08-18).
