...
Leé `docs/dev/Backlog.md` completo. Identificá:
...
```
/pipeline plan -Input docs/dev/Backlog.md -Output docs/dev/plans/<YYYY-MM-DD>-stabilization.md -Tier "bug,tech-debt,refactor,optimization"
```
