...
> **Inicio:** 2026-08-22
> **Estado: completed
> **Fuente:** `docs/dev/reviews/auditoria-documentacion-2026-08-21.md` (Volumen I+II+Addendum) + decisiones del owner D1-D14 + respuestas de confirmación T0.x/T1.x/T3.x/T4.x/T6.x/T7.x registradas en §"Plan de Revisión" del informe.
...
- **Appetite:** max 1h
- **Esfuerzo:** 🟢 | **Prioridad:** 🟡
- **Archivos clave:** `docs/TEST_MAP.md`, `docs/dev/reviews/*` (citas "2568+", "1902 passed", "1492 tests")
...
- **Appetite:** max 3h
- **Esfuerzo:** 🟡 | **Prioridad:** 🔴
- **Archivos clave:** `dev-tools/validate_doc_snippets.py` (nuevo), `docs/user/tutorials/*.md`, `vantadb-python` (venv existente)
...
- **Appetite:** max 2h
- **Esfuerzo:** 🟢 | **Prioridad:** 🔴
- **Archivos clave:** `docs/user/operations/DISASTER_RECOVERY_RUNBOOK.md` (:142,:233,:266)
...
- **Appetite:** max 3h
- **Esfuerzo:** 🟡 | **Prioridad:** 🔴
- **Archivos clave:** `docs/user/tutorials/03-migrating-from-chromadb.md:178`, `docs/user/tutorials/migration-from-lancedb.md:281`, `docs/user/glosario/hnsw.md:121`, `docs/user/FAQ.md:183,242`, URLs GitHub; `dev-tools/validate_doc_snippets.py` (de GOV-A4)
...
- **Appetite:** max 2h
- **Esfuerzo:** 🟢 | **Prioridad:** 🟠
- **Archivos clave:** `docs/dev/Backlog.md` (:703-705, Exec Summary), `docs/dev/plans/2026-08-22-vanta-final-cierre.md`, `docs/dev/plans/archive/*p29*,*p30*`, `docs/progreso/BACKLOG_HISTORY.md`
...
- **Appetite:** max 1h
- **Esfuerzo:** 🟢 | **Prioridad:** 🟠
- **Archivos clave:** `docs/dev/Backlog.md` (10 refs audit-reports/, REPORTE_EVALUACION_COMPLETO.md ×2, reviews FULL_CODEBASE_AUDIT_2026-07-11 y PROJECT_FULL_REVIEW_2026-07-13)
...
- **Appetite:** max 45min
- **Esfuerzo:** 🟢 | **Prioridad:** 🟡
- **Archivos clave:** `docs/user/operations/master-index.md` (lista 26/32)
...
- **Appetite:** max 2h
- **Esfuerzo:** 🟡 | **Prioridad:** 🟠
- **Archivos clave:** `docs/user/operations/CONFIGURATION.md`, `src/config.rs:299,659`, `src/llm.rs:40,132,147`, `src/metadata.rs:22`
...
- **Appetite:** max 30min
- **Esfuerzo:** 🟢 | **Prioridad:** 🟡
- **Archivos clave:** `docs/dev/Backlog.md` header + ROADMAP banner
...
- **Appetite:** max 4h
- **Esfuerzo:** 🟡 | **Prioridad:** 🟠
- **Archivos clave:** `docs/dev/avance/activo/{vanta-memory,vanta-proxy,context-engine}.md` (nuevos), `meta.md`, commits git agosto
...
- **Appetite:** max 1d
- **Esfuerzo:** 🟡 | **Prioridad:** 🟡
- **Archivos clave:** `docs/Investigaciones/**` (~58 archivos) → `docs/dev/research/`; citas en Backlog/planes/informe auditoría
...
- **Appetite:** max 45min
- **Esfuerzo:** 🟢 | **Prioridad:** 🟢
- **Archivos clave:** `docs/dev/reviews/propuesta-limpieza-artefactos-<fecha>.md` (nuevo)
...
- **Gate Result:** ✅ DO
- **Contrato:** reporte `docs/dev/reviews/auditoria-raiz-publica-<fecha>.md` con tabla finding/evidencia/severidad; fixes triviales aplicados inline, resto tickets.
...
- **Appetite:** max 1d
- **Esfuerzo:** 🟡 | **Prioridad:** 🟡
- **Archivos clave:** `VantaDB_Manual_Estrategico_Unified.md` (164KB), `SKILLS-MANIFEST.md`, `.opencode/{AGENTS.md,agents/,rules/,references/}`, `integrations/*/README*`, `providers/*/tests` claims, `.github/workflows/*` profundo, `docs/dev/plans/archive/` (46)
- **Verificación real:** 🟡 VERIFICAR — nunca auditados.
- **Gate Result:** ✅ DO
- **Contrato:** reporte consolidado `docs/dev/reviews/auditoria-zonas-intocadas-<fecha>.md`; para el Manual Estratégico: recomendación explícita canonizar/archivar/dividir (uphill #4 → decisión owner); SKILLS-MANIFEST: conteo real vs 154 declarado; workflows: cada CATEGORY tag justificado vs Regla 2.
...
| GOV-F2 | ✅ | docs/dev/reviews/auditoria-zonas-intocadas-2026-08-22.md — 🔴 AGENTS.md skills 111 vs manifiesto 193; Manual Estratégico recomendación DIVIDIR (uphill #4 resuelta); Regla 2 contador 7→8; skills proyecto 193/193 match |
