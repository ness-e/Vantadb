...
> **Fuente:** `docs/dev/Backlog.md` (reconteo DESKTOP-QW5 2026-08-26: 109 activas → 102 tras 7 completadas)
...
> **Cierre:** 2026-08-27 — 7/7 ✅ · Retrospectiva §Retrospectiva · Archivado `docs/dev/plans/archive/`
...
**Archive:** `docs/dev/plans/archive/2026-08-27-backlog-pipeline.md` + `docs/dev/plans/archive/2026-08-27-backlog-pipeline.budget.json` (mover desde `docs/dev/plans/` raíz).
