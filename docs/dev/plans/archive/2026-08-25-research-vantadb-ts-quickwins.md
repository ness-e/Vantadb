...
- Al completar: registrar en `docs/dev/avance/activo/bindings.md` + mover plan a archive con budget.
...
queda_pendiente: registrar en docs/dev/avance/activo/bindings.md cuando Wave 1 cierre; próximo task TS-08 (CDN ESM) o TS-07 (smoke-pack)
...
- docs/dev/plans/2026-08-25-research-vantadb-ts-quickwins.md (recitation TS-07)
...
deuda: ninguna — task verification + task file + recitation, sin código nuevo estructural; Wave 2 cierre pendiente: registrar en docs/dev/avance/activo/bindings.md + archivar plan (nota plan)
