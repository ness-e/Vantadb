...
Nota técnica defensible para Show HN en `docs/dev/architecture/FND-20-hnsw-tradeoff.md` (inglés) explicando:
...
- [x] S3 Escribir `docs/dev/architecture/FND-20-hnsw-tradeoff.md` (entregable)
