...
**Archivos leídos completos:** `src/wal_archiver.rs` (496L), `docs/dev/plans/2026-08-25-batch-backup-restore-chain.md` (130L).
...
| Doc | Línea | Acción |
|---|---|---|
| `docs/dev/architecture/FEATURES.md:59` | fila `pitr` ⚠️ experimental | marcar ❌ removed |
| `docs/user/operations/EXPERIMENTAL_FEATURES.md:58` | PITR standalone API | marcar removed |
| `docs/dev/architecture/adr/ADR-014-pitr.md` | ADR completo | nota de estado al inicio (superseded, git history) |
...
`docs/dev/reviews/*`, `docs/dev/research/*`, `docs/dev/plans/archive/*`, `docs/dev/avance/historial/*`, `.opencode/skills/campaign-executor/tasks/{AUDREP-08,MCP-34,MCP-34b,FIND-25,MOD-06,RES-02,complete/*}.md`, memoria lessons/decisions, CHANGELOG. Son snapshots históricos, no docs vivos.
