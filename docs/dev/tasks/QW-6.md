...
## Metadata
- **Plan file:** `docs/dev/plans/2026-08-25-integrations-research-wins.md`
...
| Dirección | Módulos |
|-----------|---------|
| Callers | `integrations/letta/README.md` (consumido por PyPI, docs site, `integrations/*/README.md` Why VantaDB pattern), `docs/dev/plans/2026-08-25-integrations-research-wins.md` Wave 2 reference |
...
- **Archivos leídos (completos):**
  ...
  - `docs/dev/plans/2026-08-25-integrations-research-wins.md` (Wave 2 QW-6, líneas 49-54)
...
- **Archivos que referencian a los editados (referencias entrantes):**
  - `docs/dev/plans/2026-08-25-integrations-research-wins.md` — QW-6 (H-08) referencia `integrations/letta/README.md`
...
- **Archivos:** `integrations/letta/README.md`, `integrations/letta/vantadb_letta/vectorstore.py`, `docs/dev/plans/2026-08-25-integrations-research-wins.md:49-54`
...
- **Archivos:** `.opencode/skills/campaign-executor/tasks/QW-6.md`, `docs/dev/plans/2026-08-25-integrations-research-wins.md`
