...
- **Archivos leídos completos:** `docs/dev/plans/2026-08-22-vantadb-bindings-sdk.md`, `docs/api/BINDINGS_NAMESPACES.md`, `vantadb-ts/README.md`, `docs/api/PYTHON_SDK.md`; fuente verificada vía codegraph: `vantadb-ts/src/vantadb.ts:247-343` (getters memory/graph/wiki/system frozen) y `vantadb-python/src/lib.rs:276-329` (`forward_to_db!` Memory 15 / Graph 10 / System 17 / Wiki 1) + getters `#[pyo3(name=...)]` en lib.rs:1972-2006.
