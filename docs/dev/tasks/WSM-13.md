...
## Metadata
- **Plan file:** docs/dev/plans/2026-08-29-full-backlog-parallel.md (W17-3)
...
**Referred to (out):**
- `docs/user/QUICKSTART.md` — cross-link desde estrategia de bundle
- `docs/dev/research/research-vantadb-wasm-20260825.md` H-17 referencia origen
