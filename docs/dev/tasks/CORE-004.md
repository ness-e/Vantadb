...
- **Archivos que referencian a los editados (referencias entrantes):** `grep task-definition` → `task.md` (usa template como spec 20 secciones), `pipeline-full.md` (Discovery valida template), `docs/dev/plans/2026-08-28-master-pipeline-optimization.md` CORE-004 contrato; ningún código Rust referencia el template
...
- **Archivos:** `.opencode/skills/campaign-executor/tasks/CORE-004.md`, `docs/dev/plans/2026-08-28-master-pipeline-optimization.md` (marcar COMPLETED)
