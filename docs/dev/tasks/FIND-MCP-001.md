...
## Metadata
- **Plan file:** docs/dev/plans/2026-08-31-fast-gate-residues.md
- **Creado:** 2026-08-31
...
**Acción:** agregar fila `FIND-036` a `docs/dev/Backlog.md` para fix del struct `McpConfig` / test_embed_texts.rs. NO scope-creep a FIND-MCP-001.
