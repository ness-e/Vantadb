...
## Metadata
- **Plan file:** docs/dev/plans/2026-09-08-backlog.md (Task 1, Wave0)
- **Fuente:** docs/dev/Backlog.md fila FIND-48 + plan Task 1
...
- **Archivos:** `src/index/graph/*`, `docs/dev/tasks/FIND-48.md`, `docs/dev/plans/2026-09-08-backlog.md` (sync Task 1)
