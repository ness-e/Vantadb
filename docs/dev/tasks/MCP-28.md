...
## Fase 4 — CIERRE
- [x] Actualizar nota de deuda en SKILL.md ×2 (`skills/vantadb-mcp/SKILL.md:322` + `.opencode/skills/vantadb-mcp/SKILL.md:322`: caveat "NOT addressable" → "ARE addressable") + fila Backlog ✅ (`docs/dev/Backlog.md` P25 → "✅ Resuelta (MCP-28)").
