...
## Metadata
- **Plan file:** `docs/dev/plans/2026-08-25-research-web-quickwins.md` (Wave 1, #4)
- **Creado:** 2026-09-01
...
- **Archivos:** `web/**`, `docs/dev/plans/2026-08-25-research-web-quickwins.md`, task file
- **Acción:**
