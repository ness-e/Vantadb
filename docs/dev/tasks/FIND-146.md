...
- Prohibidos: resto workflows (FIND-140/141 en paralelo — release-*, heavy-*, fuzz-40, ci-*, gate-*), `src/`, `web/`, `desktop/`, `reparacion.bat`, `.opencode`, `completions/*`, `*.lock`, stash GOV-C4, `docs/dev/Backlog.md`, plan file (solo recitation), `C:/Users/Eros/.vantadb*`, secretos.
