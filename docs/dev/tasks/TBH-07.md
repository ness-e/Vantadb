...
## Metadata
- **Plan file:** `docs/dev/plans/2026-08-30-testing-bench-harden.md` (TASK-07, mutation-testing, Phase 2)
...
- **Archivos leídos completos:**
  ...
  - `docs/dev/plans/2026-08-30-testing-bench-harden.md` líneas 88-93 (TASK-07 spec)
