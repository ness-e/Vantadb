...
## Metadata
- **Backlog:** `docs/dev/Backlog.md` L219 (fila FIND-59, Media, análisis 1-2d)
- **Creado:** 2026-09-04
...
- **Área:** `src/storage/engine/insert.rs`, `src/storage/engine/mod.rs` (solo lectura), `docs/user/operations/BENCHMARKS.md` §13, `docs/dev/architecture/adr/`. NADA en `src/` se escribe.
...
- **Verify:** `rg -c "FIND-59" docs/dev/Backlog.md` == 0 (salvo historial) + fila FIND-61 presente.
- **Estado:** ✅ DONE (2026-09-04).

### Step 4: BENCHMARKS §13 nota + avance
- **Archivos:** `docs/user/operations/BENCHMARKS.md` (§13, nota 2 líneas), `docs/dev/avance/activo/core-engine.md` (entrada FIND-59).
