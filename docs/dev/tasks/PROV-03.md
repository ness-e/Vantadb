...
- **Backlog:** `docs/dev/Backlog.md` P45 PROV-03
...
- **Referencias entrantes (qué depende de lo que cambio):**
  - Plan file `docs/dev/plans/2026-08-25-research-providers-quickwins.md` Wave 1 Task 3 → gating de quickwins (PROV-03 bloquea Wave1 5/5).
  ...
  - `docs/dev/Backlog.md` y `docs/dev/avance/` → progreso migration.
...
## Cierre
- **Recitation plan:** pendiente agregar `=== RECITATION PROV-03 ===` en `docs/dev/plans/2026-08-25-research-providers-quickwins.md`
