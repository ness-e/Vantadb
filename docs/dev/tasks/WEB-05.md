...
## Metadata
- **Plan file:** `docs/dev/plans/2026-08-25-research-web-quickwins.md` (Wave 1, #3)
- **Creado:** 2026-09-01
...
- **Context cargado:** AGENTS.md, plan quickwins WEB-05, web/AGENTS.md § Verificación Lighthouse, .opencode/references/research-modules.md fila web, docs/user/operations/BENCHMARKS.md (Regla 11), web/package.json + next.config.ts, web/src/app rutas

## Blast Radius
- **Archivos leídos completos:** `web/AGENTS.md` (60L), `.opencode/references/research-modules.md` fila web, `docs/dev/plans/2026-08-25-research-web-quickwins.md` #3, `web/package.json`, `web/next.config.ts`, `web/src/app/page.tsx` (home), `web/src/app/docs/page.tsx` (ruta interna candidata)
- **Archivos a modificar:** `web/AGENTS.md`, `.opencode/references/research-modules.md` (+ opcional `docs/user/operations/BENCHMARKS.md` si se cita, pero contrato pide solo esos dos)
...
- **Archivos leídos completos:** `web/AGENTS.md` (60L, § Verificación Lighthouse con claim stale 95-96), `.opencode/references/research-modules.md` (fila web perf 95-96 WDA-00), `docs/dev/plans/2026-08-25-research-web-quickwins.md` fila WEB-05, `web/package.json` (scripts build/lint), `web/next.config.ts` (standalone, turbopack), `docs/user/operations/BENCHMARKS.md` (Regla 11)
- **Referencias hacia dentro:** `web/AGENTS.md` es referenciado por `docs/dev/avance/activo/web-frontend.md` (cruce) y por devs; `research-modules.md` es fuente canónica para `/research web` (prompts/research-module.md)
...
- **Archivos:** `web/AGENTS.md`, `.opencode/references/research-modules.md`, `docs/dev/plans/2026-08-25-research-web-quickwins.md`
- **Acción:**
...
- **Branch:** develop
- **Plan activo:** docs/dev/plans/2026-08-25-research-web-quickwins.md Wave 1 (WEB-03 ✅, WEB-04 ✅, WEB-05 ✅, WEB-06 ⬜)
