...
| Smoke manual dónde | (a) `desktop/e2e/SMOKE-MANUAL.md` vs (b) `docs/user/operations/...` | (a) e2e/ | (a) colocada junto a specs para que `npx playwright test` y dev que abre e2e la encuentren sin buscar docs/operations. Link desde docs/avance si hace falta. |
