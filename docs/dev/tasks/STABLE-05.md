...
## Metadata
- **Plan file:** docs/dev/plans/2026-09-07-cleanup-gates.md (Task 1 — NO tocar)
- **Fuente:** docs/dev/Backlog.md P47 fila STABLE-05 (:609)
- **Esfuerzo:** 🟡 1d
- **Prioridad:** 🟠
...
| contract | ver ## Contrato; verificacion: pendiente; evidencia: abajo; artefactos: docs/dev/tasks/STABLE-05.md; invariantes/deuda: ver ## Invariantes |
...
- Working tree pre-existente ajeno: `M docs/dev/Backlog.md`, `M opencode.jsonc`, `M .opencode` — NO tocar
...
COMMIT_HASH: (lead)
ARCHIVOS: docs/dev/tasks/STABLE-05.md (único; pkg/ gitignored no se commitea)
