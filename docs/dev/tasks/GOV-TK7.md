...
| Tutorial `put` usa ints nativos | `docs/user/tutorials/02-local-rag-pipeline.md:110`: `metadata={"source": ..., "chunk_index": i, "total_chunks": len(chunks)}` (ints) ✅ funciona |
