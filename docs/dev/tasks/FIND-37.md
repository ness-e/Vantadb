...
## Metadata
- **Plan file:** docs/dev/plans/2026-08-27-backlog-pipeline.md (Task 1)
- **Fuente:** docs/dev/Backlog.md — gap verificado: 6 unwraps en src/sdk/search/mod.rs
- **Esfuerzo:** 🟡 1d
- **Prioridad:** 🔴 Alta
...
- **Archivos referenciados hacia dentro:** ningún archivo referencia `mod.rs:207` unwrap; plan file `docs/dev/plans/2026-08-27-backlog-pipeline.md:33-70` cita las 6 líneas; backlog si aplica; `src/error.rs` referenciado desde todos los search mods.
...
- `contract`:
  ...
  - `queda_pendiente`: orquestador: marcar Task 1 del plan como ✅ en `docs/dev/plans/2026-08-27-backlog-pipeline.md` y ejecutar `skill progreso` para migrar
- `nextTask`: MCP-36
