...
- **Problemas conocidos:** worktree con cambios ajenos pre-existentes (SKILLS-MANIFEST.md, docs/dev/plans/2026-08-19-web-design-audit.md) — NO tocar; pkg/ y dist-wasm/ son artefactos git-ignored; OPFS del origin 127.0.0.1 acumula datos entre runs E2E (el script usa keys únicas).
