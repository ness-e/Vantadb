...
## Metadata
- **Plan file:** `docs/dev/plans/2026-08-29-full-backlog-parallel.md` (Wave 20-3) + re-verificado bajo `docs/dev/plans/2026-09-04-durability-release-readiness.md` (Task 3, Wave 0)
