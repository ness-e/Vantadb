...
- **Fuente:** docs/dev/reviews/archive/auditoria-documentacion-2026-08-21.md Brechas Volumen II (TIR-08c ~6 líneas) + D13 (ejecución directa) + plan 2026-09-02 Wave0
- **Esfuerzo:** 🟢 30min
- **Prioridad:** 🟡 Media
...
- **Archivos:** `.opencode/task-system/prompts/research-agent.md`, `docs/dev/plans/2026-09-02-alta-prioridad-paralelo.md`, `.opencode/skills/campaign-executor/tasks/GOV-T03.md`
...
- `docs/dev/plans/2026-09-02-alta-prioridad-paralelo.md` — Wave0 GOV-T03 contrato y disjoint
- `docs/dev/reviews/archive/auditoria-documentacion-2026-08-21.md:350,442` — TIR-08c + D13
