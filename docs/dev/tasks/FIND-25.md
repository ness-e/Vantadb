...
- **Archivos tocados:** `src/storage/engine/mod.rs`, `tests/core/snapshot_certification.rs`, `docs/dev/Backlog.md` (FIND-25 removida, FIND-33 creada), `docs/dev/avance/activo/core-engine.md`
