...
## Metadata
- **Plan file:** docs/dev/plans/2026-08-16-wave-p20-tsys.md (wave P20b, Backlog.md:502)
...
- **Invariantes a preservar:** no tocar `docs/dev/Backlog.md`, `AUD-024.md`, `verify-log.jsonl`, `_vanta-cli.ps1`, `docs/dev/plans/2026-08-16-wave-p20-tsys.md`, `.opencode/agents/*`, `references/task-system.md`; NO git add/commit; NO usar `campaign_update_task_state`; no modificar los 4 pasos existentes del ritual.
