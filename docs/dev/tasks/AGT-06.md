...
## Metadata
- **Plan file:** docs/dev/plans/2026-08-25-batch-colaterales-deuda-desktop.md (Task 13)
- **Fuente:** docs/dev/Backlog.md (Wave 4)
- **Esfuerzo:** 🟢 2h
- **Prioridad:** 🟢
...
## Investigation Notes
- Probe de extracción de backticks sobre `.opencode/AGENTS.md` + `AGENTS.md`: 21 candidatos con extensión; 5 MISSING pero 4 son placeholders (`prompts/X.md`, `tasks/X.md`, `.opencode/task-system/prompts/X.md`, `docs/dev/plans/X.md` — patrones de ejemplo con `X`), el único stale REAL es `references/understand-anything.md` (el archivo existe en `.opencode/references/understand-anything.md`; la referencia en AGENTS.md omite el prefijo `.opencode/`).
