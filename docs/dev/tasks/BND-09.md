...
> **Plan:** `docs/dev/plans/2026-09-04-durability-release-readiness.md` (Task 10, Wave 3)
...
- Task file: este archivo (`docs/dev/tasks/BND-09.md`)
- Plan file update: `docs/dev/plans/2026-09-04-durability-release-readiness.md` (Task 10 → ✅
