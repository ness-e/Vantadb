...
## Metadata
- **Plan file:** ninguno activo — fuente `docs/dev/Backlog.md` P18 (línea 453)
...
| Callees | `docs/dev/architecture/task-system-chaos-resilience.md` (T19), `TSYS-06`, `gap-01 §3.3-24` (en agent-engineering) |
...
## Steps
### Step 1: Leer fuentes
- **Archivos:** `docs/dev/architecture/task-system-chaos-resilience.md` (T19), `docs/Investigaciones/2026-08-10-agent-engineering/gap-01.md` (§3.3-24), `.opencode/task-system/mcp/campaign-server.mjs` (estructura, máquina de estados)
