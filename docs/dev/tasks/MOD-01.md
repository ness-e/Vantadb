...
> **Plan:** docs/dev/plans/2026-08-23-backlog-triage.md (Task 1, Wave 1) · NO editar el plan
> **Workflow:** bug-fix · **Fuente:** docs/dev/reviews/modulos/core.md H-1 + cross-modulos F-1
