...
- **Plan file (histórico):** docs/dev/plans/archive/2026-08-22-doc-governance-plan.md
...
- `docs/dev/reviews/archive/auditoria-documentacion-2026-08-21.md` — TIR-02a + D13
- `docs/dev/plans/archive/2026-08-22-doc-governance-plan.md` — Task 1 original
- `docs/dev/plans/2026-09-02-alta-prioridad-paralelo.md` — Wave0 GOV-T01 guard
