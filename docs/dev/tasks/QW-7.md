...
- **Archivos leídos (completos):** `integrations/*/pyproject.toml` (9 files, version 0.5.0 alineada), `.github/workflows/release-adapters-62.yml` (61 lines, job build sdist/wheel + twine), `docs/dev/Backlog.md` MKT-18f
- **Archivos referenciados hacia dentro:** pyproject `dependencies = ["vantadb-py>=0.5.0"]` etc.
- **Archivos que referencian a los editados:** `docs/dev/Backlog.md` MKT-18f, `docs/dev/plans/2026-08-25-integrations-research-wins.md` Wave 3
