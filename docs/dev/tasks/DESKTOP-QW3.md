...
- **Archivos leídos completos (antes de editar):**
  ...
  - `docs/dev/plans/2026-08-25-research-desktop-quickwins.md` (58 líneas + 2 recitations QW1/QW2)
  - `docs/dev/reviews/archive/research-desktop-prod-20260825.md` (hallazgo H-05 línea 100)
