...
## Metadata
- **Plan file:** `docs/dev/plans/2026-08-18-vanta-memory.md` (Task 12, líneas 208-213)
...
- **Archivos:** `docs/dev/plans/2026-08-18-vanta-memory.md` (solo lectura), `src/sdk/api.rs`, `src/sdk/types.rs`, `src/agentic/thread.rs`, `src/sdk/serialization/mod.rs`, TDAM `l0-recorder.ts`/`auto-capture.ts`
