...
## Metadata
- **Plan:** docs/dev/plans/2026-08-16-wave-followups.md (W2)
- **Fuente:** deuda del veredicto TSYS-06 (`docs/Investigaciones/TSYS-06-chaos-runner.md` §5-8) + diseño `docs/dev/architecture/task-system-chaos-resilience.md` §6
...
## Archivos clave
- `.opencode/task-system/mcp/campaign-server.mjs` (1514L), `.opencode/task-system/config/state-tools.mjs` (94L — NO tocar la tabla STATE_TOOLS), `docs/dev/architecture/task-system-chaos-resilience.md` (§6 behavior changes), `docs/Investigaciones/TSYS-06-chaos-runner.md` (plan de implementación §7)
...
- NO tocado: docs/dev/Backlog.md, AUD-024.md, verify-log.jsonl, completions/_vanta-cli.ps1, plan file, .opencode/AGENTS.md, .opencode/agents/* (worktree ajeno intocado)
