...
> **Deuda/WIP ajeno (NO tocar ni stagear):** M .opencode, M desktop/src-tauri/Cargo.lock, M opencode.jsonc, ?? Investigacion-plan.md, ?? docs/dev/plans/2026-09-10-code.md
