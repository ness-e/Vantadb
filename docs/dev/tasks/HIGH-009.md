...
| Dirección | Módulos |
|-----------|---------|
| Callers | `.opencode/task-system/prompts/pipeline-run.md` paso 8 (8. CUANDO no haya más ⬜ PENDING — líneas 205-223), `docs/dev/plans/2026-08-28-master-pipeline-optimization.md` Task 9 (líneas 223-236, contrato grep session_track.*delete), `.opencode/task-system/mcp/campaign-server.mjs` Tool 17 campaign_session_track (líneas 1761-1850), `docs/dev/plans/2026-08-28-master-pipeline-optimization.md` Verificación por task línea 544 |
...
- **Archivos:** `.opencode/task-system/prompts/pipeline-run.md` (línea 208 paso 8 + líneas 205,43-46), `.opencode/task-system/mcp/campaign-server.mjs` (líneas 1761-1783 SESSION_DIR + z.enum delete), `docs/dev/plans/2026-08-28-master-pipeline-optimization.md` (líneas 223-236 Task 9 + 544 verif)
...
- `docs/dev/plans/2026-08-28-master-pipeline-optimization.md:223-236` — Task 9 definición + contrato grep -n session_track.*delete → en paso 8 + pre-mortem Session ID tracking
- `docs/dev/plans/2026-08-28-master-pipeline-optimization.md:544` — Verificación por task (HIGH-009: grep "session_track.*delete" pipeline-run.md → 1 ✅)
