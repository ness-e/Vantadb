...
- **Fuente:** docs/dev/Backlog.md fila MCP-38 (P0-C) — docs/dev/reviews/archive/mcp-research-20260825.md §6 P0-C + blog.modelcontextprotocol.io/posts/2026-03-16-tool-annotations
...
- **Archivos leídos completos:**
  ...
  - `docs/dev/reviews/archive/mcp-research-20260825.md` §3/§6 P0-C y Backlog fila MCP-38
