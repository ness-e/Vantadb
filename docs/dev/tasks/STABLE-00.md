...
## Metadata
- **Plan file:** docs/dev/plans/2026-08-27-backlog-pipeline.md
- **Creado:** 2026-08-27
- **last-synced:** 2026-08-27
- **Estado:** ✅ COMPLETED
- **Fuente:** docs/dev/Backlog.md P47 — Cargo.toml:636 default-members circuit breaker
- **Esfuerzo:** 🟡 4h
- **Prioridad:** 🔴 Alta
...
- **Archivos leídos completos:**
  ...
  - `docs/dev/Backlog.md:721-750` (P47 contrato 10 checks + 9 filas STABLE)
...
```
existe docs/dev/architecture/adr/ADR-031-default-members-promotion.md con:
...
- **Archivos:** `docs/dev/architecture/adr/ADR-031-default-members-promotion.md` (nuevo)
