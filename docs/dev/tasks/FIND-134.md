...
## Metadata
- **Plan file:** `docs/dev/plans/2026-09-21-workflows-repair.md` (Wave 0, paralelo con FIND-135/136 disjuntos)
...
- **Archivos:** `.github/workflows/ci-rust-10.yml`, `docs/dev/tasks/FIND-134.md`
...
- `docs/dev/Backlog.md` NO tocado (prohibido). `C:/Users/Eros/.vantadb*` y secretos: no tocados, nada a disco/logs.
