...
## Metadata
- **Plan file:** docs/dev/plans/2026-08-12-perf-bench-wasm.md (Task 2)
- **Fuente:** docs/dev/Backlog.md § Phase 4 + plan file Task 2
- **Esfuerzo:** 🟠
- **Prioridad:** 🟡
...
| Dirección | Módulos |
|-----------|---------|
| Callers | `web/src/lib/vanta-data.ts` (importa `competitive-benchmark.json` que escribe el harness) · `web/src/components/vanta/competitive-table.tsx` · `docs/user/operations/BENCHMARKS.md` (CI results) |
