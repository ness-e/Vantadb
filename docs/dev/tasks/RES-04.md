...
## Metadata
- **Plan file:** `docs/dev/plans/2026-09-02-alta-prioridad-paralelo.md` (Wave1 P38 — 20260902-alta-prioridad-paralelo)
- **Fuente:** `docs/dev/research/archive/FND-06-core-bindings-boundaries.md` H3 (score→similarity drift) + `src/planner.rs` RRF_K + `src/index/distance/metrics.rs` cosine zero-norm + `docs/api/*` 0 hits scores/semántica
...
- **Archivos:** `src/planner.rs:25 RRF_K`, `src/index/distance/metrics.rs`, `src/sdk/search/mod.rs:106 ERR-028`, `docs/api/TS_SDK.md:Distance vs Score`, `docs/dev/research/archive/FND-06*`, `integrations/*/_cosine_sim`, `desktop/retrieval-core.ts:RRF_K`
...
- **Archivos:** `docs/dev/plans/2026-09-02-alta-prioridad-paralelo.md` RES-04, este task file, git
