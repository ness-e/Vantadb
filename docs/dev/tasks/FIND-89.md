...
- **Archivos leídos (completos):**
  ...
  - `docs/user/operations/CONFIGURATION.md` (tabla env vars fuera de Config)
...
- **Invariantes a preservar:**
  ...
  6. `docs/user/operations/CONFIGURATION.md` se actualiza con las nuevas vars `VANTADB_*` y se marca breaking de legacy.
...
- **Archivos:** 
  ...
  - `docs/user/operations/CONFIGURATION.md`: añadir nuevas vars `VANTADB_OPENAI_API_KEY`, `VANTADB_OPENAI_MODEL`, `VANTADB_EMBEDDING_PROVIDER`, `VANTADB_BACKUP_DIR` a tabla; marcar legacy `VANTA_*` como deprecated/breaking
