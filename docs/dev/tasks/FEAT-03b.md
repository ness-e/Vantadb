...
3. Contrato de implementación: pasos concretos para vanta-worker, archivos, tests, verificación. ADR (docs/dev/architecture/ o docs/adr/) con la decisión.
