...
- `docs/dev/plans/2026-08-27-backlog-v2.md` (Task 1 → ✅ COMPLETED)
- `docs/dev/Backlog.md` (FIND-34 eliminado)
- `docs/dev/avance/activo/core-engine.md` (§FIND-34)
- `docs/dev/avance/historial/backlog-history.md` (FIND-34)
