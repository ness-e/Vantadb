...
## Metadata
- **Plan file:** docs/dev/plans/2026-08-25-batch-colaterales-deuda-desktop.md (Task 3)
...
- **Archivos referenciados hacia dentro:** ninguno referencia los 2 tests. El plan file cita `vantadb-server/tests/server.rs:223,235`; `docs/dev/Backlog.md` tiene el FIND-32; `MOD-13.md` recitation lo menciona.
