...
- `docs/dev/tasks/EMB-14.md` (patrón `try_provider_embed` + `is_local_model_available` + `fallback_warning` a reusar verbatim), `docs/dev/tasks/EMB-16.md` (`embed_query` existe; vector.rs ya embebe queries IQL con él)
