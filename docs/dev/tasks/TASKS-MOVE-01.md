...
## Descripción (D1)
Mover tasks fuera del submodule privado configOpencode a `docs/dev/tasks/` en repo
...
- **Archivos:** `.opencode/skills/campaign-executor/tasks/**/*.md` → `docs/dev/tasks/**`
...
- **Archivos:** `.opencode/skills/campaign-executor/tasks/README.md` (nuevo), `docs/dev/tasks/TASKS-MOVE-01.md` (este file)
...
- TASKS-MOVE-01.md no existía en origen (es esta tarea); vive solo en canónico `docs/dev/tasks/`.
