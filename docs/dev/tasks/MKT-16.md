...
| `docs/user/blog/graphrag-benchmark.md` (128 L→~145 L) | ✅ metodología + números reales |
| `docs/user/glosario/graphrag.md` | ✅ warning honesto agregado (línea 31) |
...
- **Clase:** `0xC00000FD` `STATUS_STACK_OVERFLOW`, misma familia que AUDIT-04 (`0xC0000409`). Documentado en `docs/user/blog/graphrag-benchmark.md` sección "Fase de queries".
...
- `git add benchmarks/graphrag_bench.rs docs/user/blog/graphrag-benchmark.md docs/user/glosario/graphrag.md Cargo.toml`
