...
ARCHIVOS: src/sdk/serialization/mod.rs, src/physical_plan/scan.rs, vantadb-mcp/src/handlers/tools.rs, vantadb-mcp/tests/mcp_tests.rs, .opencode/skills/vantadb-mcp/SKILL.md, .opencode/skills/vantadb/SKILL.md, docs/api/MCP.md, docs/dev/Backlog.md
...
> Nota SARL: el worktree contiene cambios NO relacionados con MCP-29 (`desktop/`, `scripts/check-avance-coverage.ps1`, `docs/dev/plans/2026-08-22-vanta-ultima-milla.md`, `.opencode/skills/campaign-executor/tasks/MEM-58.md`) — el lead debe commitear solo los ARCHIVOS listados arriba.
