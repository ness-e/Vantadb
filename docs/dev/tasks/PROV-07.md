...
## Contrato
"Compila + caso de test manual documentado (distance_metric inválido → ValueError; metadata descartada → warning)" — `docs/dev/plans/2026-08-25-research-providers-quickwins.md:19` — Wave 1 Task 4
