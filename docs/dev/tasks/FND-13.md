...
- `docs/user/operations/BENCHMARKS.md` (212 líneas) — §1 stress protocol, §2 SDK ops, §4 prefetch, §5 SIFT, §6 batch, §7 competitive, §8 canonical (FND-10)
- `docs/user/operations/PERFORMANCE_TUNING.md` (494 líneas) — claims de HNSW, sync modes, SIMD, storage
...
- NO tocar: docs/dev/Backlog.md, AUD-024.md, verify-log.jsonl, _vanta-cli.ps1, plan files, .opencode/agents/*, src/.
