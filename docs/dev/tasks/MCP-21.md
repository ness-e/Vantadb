...
## Fase 1 — DISCOVERY
- [x] Leer la fila `MCP-21` completa en `docs/dev/Backlog.md`.
...
ARCHIVOS: vantadb-mcp/src/handlers/tools.rs, vantadb-mcp/src/lib.rs, vantadb-mcp/tests/mcp_tests.rs, skills/vantadb-mcp/SKILL.md (+copia .opencode), references/api-reference.md (+copia), references/mcp-protocol.md (+copia), docs/api/MCP.md, docs/dev/Backlog.md
