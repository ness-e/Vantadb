...
- **Referencias salientes:** filas nuevas citan `wal.rs`/`planner.rs`/`diskann.rs` y la investigación archivada — solo texto, sin enlaces rotos (ruta real: `docs/dev/research/archive/...`).
...
- [x] 1. Verificar colisión IDs (`rg "FUT-1[2-9]" docs/dev/Backlog.md` → 0) y re-leer fuente §roadmap
...
- [x] 5. Registro en `docs/dev/avance/investigaciones.md` (Trigger 1)
