...
- **Archivos que referencian a los editados (referencias entrantes):** `rg -n "scalar_index|ScalarIndex" --glob "!target"` → hits en `src/engine.rs`, `src/storage/engine/{mod,insert,delete,maintenance,init}.rs`, `docs/dev/reviews/*`, `docs/dev/Backlog.md:229`
...
- **Archivos:** `docs/dev/plans/2026-08-27-backlog-pipeline.md`, `.opencode/skills/campaign-executor/tasks/FIND-39.md`
