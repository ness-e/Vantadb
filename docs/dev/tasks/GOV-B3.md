...
- `Select-String -Path "docs/user/operations/BENCHMARKS.md" -Pattern "consumo guard"` → Count >=1
...
## Resultado
**Antes:** `docs/user/operations/BENCHMARKS.md` sin guard consumo; `canonical_p99.rs` sin anchor; `verify.ps1` sin compile-gate bench → regresión p99 silenciosa posible.
