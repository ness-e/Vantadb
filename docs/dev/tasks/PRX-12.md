...
- **Plan:** `docs/dev/plans/2026-09-09-backlog.md` Task 6 (Wave1, 5/6 ✅, disjunta: tests/fixtures)
...
- WIP ajeno intacto: `.opencode`, `opencode.jsonc`, `docs/dev/Backlog.md`, `docs/dev/avance/*`,
  `Investigacion-plan.md`, `docs/dev/plans/2026-09-09-backlog.md` (untracked) — no stagear.
