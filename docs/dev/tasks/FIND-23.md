...
- **Plan file:** `docs/dev/plans/2026-08-25-batch-core-fixes-research.md`
...
- **NO commit** (regla del batch) — el lead verifica mecánico y commitea SOLO: `desktop/src/vanta-http-map.ts`, `desktop/src/vanta-http-map.test.ts`, `.opencode/skills/campaign-executor/tasks/FIND-23.md`, `.opencode/skills/campaign-executor/tasks/FIND-11.md`, `.opencode/skills/campaign-executor/tasks/UX-POLISH.md` (cleanup), `docs/dev/plans/2026-08-25-batch-core-fixes-research.md` (estado de la tarea). NO incluir archivos de agentes paralelos (AUD-047.md, src/index/search/layer.rs — trabajo de otros).
