...
- `docs/dev/tasks/EMB-17.md` (este archivo)
...
- `docs/dev/tasks/EMB-13.md` (patrón fallback avisado + `is_local_model_available` + `fallback_warning` verbatim), `EMB-14.md` (patrón `try_provider_embed` + nunca-dummies-en-puts), `EMB-15.md` (hunks `:1706,~3081,~3532` disjuntos), `EMB-18.md` (dim gate a reusar), `EMB-16.md` (`embed_query`/familias intactas)
