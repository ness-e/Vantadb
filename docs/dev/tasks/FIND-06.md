...
- **Referencias hacia dentro:** README no es importado por código. Links salientes a `../docs/user/QUICKSTART.md`, `../docs/api/BINDINGS_NAMESPACES.md`, `../docs/api/PYTHON_SDK.md`.
...
4. ✅ Marcar FIND-06 DONE en `docs/dev/Backlog.md` (fila P33 + sección completadas).
...
- El lead commitea (sub-agentes NO commitean): `vantadb-python/README.md`, `docs/api/MCP.md`, `docs/dev/Backlog.md`, task file FIND-06.md.
