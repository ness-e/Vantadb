...
## Metadata
- **Plan file:** `docs/dev/plans/2026-08-28-backlog-triage.md`
...
- **Decisiones:** tarea cerrada idempotente sin edición — el trabajo ya estaba hecho en commit a86c7e4e (2026-08-26). Solo se crea task file para trazabilidad y se actualiza plan file + docs/dev/avance/activo/bindings.md.
