...
- `docs/dev/tasks/EMB-13.md` (patrón fallback avisado), `docs/dev/tasks/EMB-16.md` (prefijos e5 se heredan gratis vía provider), EMB-18 tests `:4968-5075` (mensajes exactos a preservar)
