...
## Metadata
- **Plan:** docs/dev/plans/2026-08-16-wave-followups.md (W4)
...
## Invariantes (handoff)
- NO tocar: docs/dev/Backlog.md, AUD-024.md, verify-log.jsonl, _vanta-cli.ps1, plan file, .opencode/AGENTS.md, .opencode/agents/*, código
