...
## Metadata
- **Plan file:** docs/dev/plans/2026-08-19-vanta-studio-fase4.md
- **Creado:** 2026-08-19
- **Estado:** ✅ COMPLETED
...
5. **`docs/dev/architecture/WASM_STORAGE_REVIEW.md` parcialmente stale**: afirma que no hay rename atómico/checksum y que IDB no tiene tests; hoy opfs.rs tiene write atómico tmp+rename + footer CRC-32 y wasm_tests.rs tiene tests IDB. NOTA en el doc, no arreglado.
...
- **Problemas conocidos:** pkg/ y e2e/pkg-nomodules/ son artefactos regenerables git-ignored (no versionados); worktree tenía cambios pre-existentes ajenos (SKILLS-MANIFEST.md, desktop/src-tauri/src/connections/*, docs/dev/plans/2026-08-19-web-design-audit.md)