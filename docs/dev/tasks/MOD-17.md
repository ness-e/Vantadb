...
**Causa raíz (confirmada contra review H2 `docs/dev/reviews/modulos/vantadb-python.md:60`):**
...
## Context Save Point
- Estado: COMPLETADA — commit `50319e30`. Registro en docs/dev/avance/activo/bindings.md; fila removida de docs/dev/Backlog.md.
