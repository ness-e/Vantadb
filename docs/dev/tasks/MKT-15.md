...
- `benchmarks/competitive_bench.py` → `docs/user/blog/benchmarks_vs_lancedb_chroma.md` (glove-100-angular, 10K vecs, 100 queries, top_k=10, median of 3, `--batch-size 999`).
...
- Do NOT run `competitive_bench.py` fresh (downloads ~1GB datasets); the blog (MKT-05, published today) is the authoritative recent source. docs/user/operations/BENCHMARKS.md §7 (2026-06-06) is historical (24.3 QPS) and intentionally not used.
