...
## Metadata
- **Plan file:** `docs/dev/plans/2026-08-18-vanta-memory.md`
...
## Notas
- Nomenclatura TDAM: `docs/dev/research/tdam/01-core-pipeline.md:100-104` (metric-tracking-{l1,l2,l3,recall}-latency). Recall strategy codificado 0..3.
