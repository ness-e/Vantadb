...
- Archivos exactos: `vantadb-python/src/lib.rs` (único prod) + `vantadb-python/tests/test_sdk.py` (migrar assert fallback → error) + test nuevo error (mismo file o `test_d5b_distance_method.py`). Task file: `docs/dev/tasks/D5b.md` (este).
