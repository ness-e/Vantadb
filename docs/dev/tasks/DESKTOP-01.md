...
- **Fuente:** `docs/dev/Backlog.md` línea 166
...
## Investigation Notes
- Workflow research (`research.json`): scoping → searching → extracting → synthesizing → verifying → review → accept → close. Output final a `docs/Investigaciones/` (convención del proyecto; el workflow por defecto dice `docs/dev/research/` — usar el estándar local).
...
- **Archivos:** `docs/dev/Backlog.md`, `docs/progreso/README.md`
