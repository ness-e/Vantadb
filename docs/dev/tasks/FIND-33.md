...
- **Plan file:** `docs/dev/plans/2026-08-29-full-backlog-parallel.md` (W26-SOLO, último del run)
- **Creado:** 2026-08-30
...
| `docs/dev/research/archive/res02-backup-restore.md` | 57 | RES-02 §1 gaps; §2(a) restore via dir-swap; §3 S1-S5 plan. Confirma el gap (línea 21: "Flat copy only" + "Subdirectories silently skipped"). |
