...
- **Referencias hacia dentro:** README cita `pkg/` (generado, gitignored vía `vantadb-wasm/pkg/.gitignore:1` → `*`), `Cargo.toml` (`wasm-opt -Oz`), `build-wasm.ps1`, `vantadb-ts/README.md`, `docs/user/QUICKSTART.md`.
