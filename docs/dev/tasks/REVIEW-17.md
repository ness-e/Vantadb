...
- **Plan:** `docs/dev/plans/2026-08-25-batch-core-server-mcp.md` (Task 10)
...
- Clippy workspace falla SOLO por FIND-30 pre-existente (`cli_server.rs:1302` unused `ns`, feature `server`), fuera de blast radius → registrado como FIND-30 en `docs/dev/Backlog.md` (tabla P33). MOD-13 (dueño de cli_server.rs) puede absorberlo.
- Archivos tocados (NO commiteados — lead commitea): `src/storage/vfile_mmap.rs`, `src/storage/vfile.rs`, `src/storage/archive.rs`, `docs/dev/Backlog.md` (FIND-30), task file.
