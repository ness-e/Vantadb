...
- **NO COMMIT** (regla: el lead verifica mecánico y commitea por tarea). Worktree tiene cambios de otros agentes (AGT-04.md, lessons.md, assets borrados, docs/dev/reviews) — el commit del lead debe incluir SOLO los 5 archivos + task file.