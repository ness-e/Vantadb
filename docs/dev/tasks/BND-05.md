...
## Metadata
- **Plan file:** docs/dev/plans/2026-08-25-batch-colaterales-deuda-desktop.md (Task 9)
- **Fuente:** docs/dev/Backlog.md:762 (BND-05, detectado auditoría integración final, P31)
- **Esfuerzo:** 🟢 1h
- **Prioridad:** 🟢
...
- **Archivos:** `docs/dev/plans/2026-08-25-batch-colaterales-deuda-desktop.md` (recitation — lo actualiza el lead al commitear), este task file
