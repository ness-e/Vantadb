...
1. **JSON versionado** — `web/src/lib/data/competitive-benchmark.json` (schema_version 1):
   ...
   **Fuente (sin números inventados):** run real del harness 2026-08-04 publicado en
   `docs/user/blog/benchmarks_vs_lancedb_chroma.md` (MKT-05, glove-100-angular 10K, 100q, top_k=10,
   cosine, `--batch-size 999`). El run histórico de `docs/user/operations/BENCHMARKS.md` §7 (2026-06-06)
