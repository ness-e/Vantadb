...
## Metadata
- **Plan file:** docs/dev/plans/2026-09-10-code.md (Task 4, Wave1)
...
- WIP ajeno detectado (NO tocar ni stagear): `M opencode.jsonc`, `M .opencode` (submodule), `M desktop/src-tauri/Cargo.lock`, `M docs/dev/Backlog.md`, `M docs/dev/avance/*`, `?? Investigacion-plan.md`, `?? docs/dev/plans/2026-09-10-code.md`.
