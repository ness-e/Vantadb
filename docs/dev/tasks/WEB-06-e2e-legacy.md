...
> **Nota scope:** la parte ADR (`docs/dev/architecture/`) + Backlog la hace el lead — NO tocar.
...
- `docs/dev/plans/2026-08-18-vanta-studio-fase3.md` (141L) — Task 7 WEB-06 contrato + Wave 3
