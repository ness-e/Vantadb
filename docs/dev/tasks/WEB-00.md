...
- [x] Leer plan file (`docs/dev/plans/2026-08-18-vanta-studio-fase3.md`, Task 1) y pipeline (`pipeline-full.md`)
...
- [x] NO tocar: `docs/dev/Backlog.md`, `web/`, `vantadb-wasm/`, `src/sdk/`, `desktop/src-tauri/`, README.md
