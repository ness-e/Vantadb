...
3. Implementar: editar los textos — quitar números sin fuente; si el claim es cualitativo ("alto rendimiento"), reformular sin número o con referencia al benchmark canónico (docs/user/operations/BENCHMARKS.md)
...
## Invariantes (handoff)
- NO tocar: docs/dev/Backlog.md, AUD-024.md, verify-log.jsonl, _vanta-cli.ps1, plan file, .opencode/AGENTS.md, .opencode/agents/*, docs/user/operations/BENCHMARKS.md
