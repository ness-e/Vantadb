...
- [x] Blast radius: solo `docs/dev/architecture/adr/` (1 directorio, 39 archivos markdown)
- [x] Hot path: NO
...
- [x] Ejecutar `skill progreso` (Trigger 1) — registrado en `docs/dev/avance/activo/core-engine.md`
