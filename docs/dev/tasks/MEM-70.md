...
- **Plan:** docs/dev/plans/2026-09-10-code.md (Task 5) · **Appetite:** max 2d
...
- **Archivos leídos completos:** `docs/user/operations/BENCHMARKS.md` (§1-§16, último §16 A/B node; próximo §17 libre), `benchmarks/README.md` (tabla Scripts), `benchmarks/embed_bench.py:1-100` (patrón CLI/dummy/Regla 11), `evals/eval-metrics.mjs` (patrón evals existente, no tocado), `docs/dev/plans/2026-09-10-code.md` (Task 5 + Wave1 + stop conditions)
...
- **Referencias entrantes:** ninguna (archivo nuevo); `docs/user/operations/BENCHMARKS.md` §17 nuevo cita el comando; `benchmarks/README.md` +1 fila (docs, sin código)
