...
`desktop/src-tauri/Cargo.lock` · stash@{0} GOV-C4 · `docs/dev/Backlog.md` · plan file (solo recitation
...
- **Leídos completos:** `providers-ci.yml`, `release-wheels-60.yml`, `sec-codeql-30.yml`,
  ...
  56-80, 200-230), rename-map FIND-124 (`docs/dev/tasks/FIND-124.md` tabla + commit 797059bf).
