...
- **Plan:** docs/dev/plans/2026-08-16-wave-r2-r7-fnd.md (Task 10, Wave 2)
- **Estado:** ✅ COMPLETED
...
**DoD:** 3 ADRs en `docs/dev/architecture/adr/` con Contexto/Decisión/Consecuencias.
...
- Archivos nuevos en `docs/dev/architecture/adr/` — no rompen referencias.
