...
- NO tocar `docs/dev/Backlog.md`, `AUD-024.md`, `verify-log.jsonl`, `completions/_vanta-cli.ps1`, `docs/dev/plans/2026-08-16-wave-p20-tsys.md`.
...
- **Referencias entrantes:** `docs/dev/Backlog.md:508` (FND-16), `docs/dev/plans/2026-08-16-wave-p20-tsys.md:24,58`.
