...
## Metadata
- **Plan file:** `docs/dev/plans/2026-09-13-cleanCA-fase3.md` (Task 4, Wave 2)
- **Creado:** 2026-09-14
...
- `docs/dev/tasks/F3B.md` NO existía → DISCOVERY completo.
