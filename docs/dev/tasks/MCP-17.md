...
## Fase 1 — DISCOVERY
- [x] Leer la fila `MCP-17` completa en `docs/dev/Backlog.md`.
...
- [x] Marcar la fila como ✅ en `docs/dev/Backlog.md` con nota breve del cambio.
...
ARCHIVOS: vantadb-mcp/src/handlers/tools.rs, vantadb-mcp/tests/mcp_tests.rs, src/sdk/serialization/mod.rs, src/sdk/mod.rs, skills/vantadb-mcp/SKILL.md, .opencode/skills/vantadb-mcp/SKILL.md, skills/vantadb-mcp/references/api-reference.md, docs/api/EMBEDDED_SDK.md, docs/dev/Backlog.md
