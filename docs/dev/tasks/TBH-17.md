...
4. **Si en el futuro se introduce una primitiva no trivial** (lock-free queue custom, epoch
   ...
   Documentado en el ADR-like doc: `docs/dev/research/concurrency-testing-2026-08-30.md`.

## Fase EJECUCIÓN (pendiente)

1. Crear `docs/dev/research/concurrency-testing-2026-08-30.md` con la decisión y razonamiento.
2. Commit: `docs(TBH-17): record loom evaluation decision (not introduced; current concurrency_parity.rs sufficient)`.

## Cierre (pendiente)

- Verify `docs/dev/research/concurrency-testing-2026-08-30.md` existe y matchea "loom".
- `git add` + commit.
