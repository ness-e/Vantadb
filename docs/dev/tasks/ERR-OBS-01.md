...
## Metadata
- **Plan file:** `docs/dev/plans/2026-09-02-error-observability-excellence.md` (Task 9, Wave 3)
...
5. **Docs:** `docs/user/operations/OBSERVABILITY.md` NUEVO (cadena de error, `RUST_LIB_BACKTRACE=1`, niveles, TODO métricas, alerta `rate(5xx) > 2× baseline`, evidencia panics, verificación). Nota de gate en `CI_POLICY.md` (jobs table). Principio #6 backtrace en `docs/api/ERROR_HANDLING.md`. FIND-53 + FIND-54 en Backlog.
...
| 7 | `test -f docs/user/operations/OBSERVABILITY.md` | True ✅ |
