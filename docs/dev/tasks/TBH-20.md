...
audit CI/CD) y la investigación `docs/dev/research/validacion/07` (§"Smoke
...
- `docs/dev/research/validacion/07-repo-esencial-y-fiabilidad-first-run.md` (gap original §52)
