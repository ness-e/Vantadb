...
- **Archivos leídos completos (antes de editar):**
  ...
  - `docs/dev/plans/2026-08-25-research-desktop-quickwins.md` (48 líneas)
  - `docs/dev/reviews/archive/research-desktop-prod-20260825.md` (hallazgo H-03 vía git show 093beee1, commit a7ed0d22 diff)
