...
- **Acción:** nota en `docs/user/operations/OBSERVABILITY.md`... verificar archivo natural; si no, registrar en este task file + `campaign_memory_write(lessons)`.
...
### Step 7: Cierre
- Fila FIND-52 fuera de `docs/dev/Backlog.md`, avance `docs/dev/avance/activo/bindings.md` + `core-engine.md`, task file ✅, memory lesson.
