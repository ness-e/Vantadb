...
## Fase 1 — DISCOVERY
- [x] Leer la fila `MCP-26` completa en `docs/dev/Backlog.md`.
...
ARCHIVOS: mismos que MCP-20 (mismo commit/superficie): tools.rs, mcp_tests.rs, SKILL.md x2, api-reference.md x2, mcp-protocol.md x2, docs/dev/Backlog.md, este task file. list_snapshots INCLUIDA (wrapper trivial <10 líneas).
