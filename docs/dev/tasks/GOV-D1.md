...
- Leídos completos: `docs/dev/avance/meta.md`, `docs/dev/avance/fuentes-vivas.md` (no lista dominios activos → sin cambios), `docs/dev/avance/activo/core-engine.md` (formato + ya tiene P27 completo), `docs/dev/avance/activo/bindings.md` (ya tiene MEM-21).
