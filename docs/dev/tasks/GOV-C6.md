...
## Metadata
- **Plan file:** docs/dev/plans/2026-08-22-doc-governance-plan.md (NO editar)
...
- **Archivos:** docs/user/operations/CONFIGURATION.md
...
- **Comando:** `npx markdownlint-cli2 "docs/user/operations/CONFIGURATION.md"`
