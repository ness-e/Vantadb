...
- **Prohibidos (intocables):** rediseño IQL, resto del CLI, `src/wal*.rs`, approval/skill/scheduler, spec ingesta FIND-112, `reparacion.bat`, `.opencode`, `Justfile`, `ocr-*`, `completions/*`, `desktop/src-tauri/Cargo.lock`, stash@{0} GOV-C4, `docs/dev/Backlog.md`, plan file (solo recitation), `C:/Users/Eros/.vantadb*`.
