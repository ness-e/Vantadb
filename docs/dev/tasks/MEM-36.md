...
## Metadata
- **Fuente:** `docs/dev/Backlog.md` fila MEM-36 + decisiones del usuario 2026-08-21 ("campaña separada, con esta meta-tarea que produce el plan")
- **Tipo:** Planning/spec (NO código) — **Ruta: vanta-lead** (pipeline)
- **Esfuerzo:** 🟢 | **Prioridad:** 🟡
- **Creado:** 2026-08-22
- **Estado:** ⬜ PENDING
- **Entregable ÚNICO:** `docs/dev/plans/<FECHA>-vantadb-bindings-sdk.md` — plan completo de la campaña de bindings, con sus tareas listas para `/pipeline run`
...
## Contrato
"Existe `docs/dev/plans/<FECHA>-vantadb-bindings-sdk.md` con ≥4 tareas ✅ DO, cada una con archivos clave, contrato mecánico verificable y task file referenciado; commit hecho"
