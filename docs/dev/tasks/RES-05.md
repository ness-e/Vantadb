...
- `docs/user/operations/BENCHMARKS.md` §9 (nuevo)
...
Select-String -Path "docs/user/operations/BENCHMARKS.md" -Pattern "scores_semantics|Score Semantics" | Measure-Object Count # >=1
...
- `Select-String docs/user/operations/BENCHMARKS.md scores_semantics` → >=1 ✅
