...
| C3 Formula sin placeholders | `rg -c "0000000000000000" Formula/vantadb.rb` | ✅ exit 1 (0 matches). Rama "artefacto docs/dev/plans/artifacts/mkt-18h/" N/A: fórmula accesible → fix in-place |
