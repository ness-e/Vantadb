...
## Metadata
- **Plan file:** docs/dev/plans/2026-08-16-wave-p20-tsys.md
- **Creado:** 2026-08-16
...
- **Archivos leídos completos:** `.opencode/AGENTS.md` (Reglas 1-11, Ritual, Doc Language Split), `AGENTS.md` raíz, `docs/dev/Backlog.md` (P20d), `Justfile`, `CONTRIBUTING.md` (estado actual), `.github/ISSUE_TEMPLATE/bug_report.yml`, `feature_request.yml`, `config.yml`, `.github/pull_request_template.md`, `docs/dev/plans/2026-08-16-wave-p20-tsys.md`.
...
- `## Where to Find Work` (NUEVA): `docs/dev/Backlog.md` (formato ID | descripción | archivos | esfuerzo | prio | estado), etiquetas `good first issue` / `bug` / `enhancement`, enlace a reglas `.opencode/rules/` y AGENTS.md.
