...
## Metadata
- **Plan file:** docs/dev/plans/2026-08-25-batch-colaterales-deuda-desktop.md (Task 12)
- **Fuente:** docs/dev/Backlog.md (colateral batch)
- **Esfuerzo:** 🟢 30m
- **Prioridad:** 🟢
...
- **Estado:** ❌ FAILED (WIP huérfano — plan `docs/dev/plans/2026-08-25-batch-colaterales-deuda-desktop.md` no existe (batch cerrado/archivado); cerrado 2026-08-25 por MOD-15 executor para desbloquear one-task-at-a-time. Reversible: re-abrir si el batch revive.)
