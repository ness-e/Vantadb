...
- **Problemas conocidos:** `pkg/` y `e2e/pkg-nomodules/` son artefactos regenerables git-ignored; worktree tenía cambios pre-existentes ajenos (SKILLS-MANIFEST.md, desktop/src-tauri/src/connections/*, docs/dev/plans/2026-08-19-web-design-audit.md); scripts temp del smoke en `%TEMP%\opencode\` (smoke-wasm02.mjs, debug*-wasm02.mjs) — no versionados