...
## Archivos clave
- `docs/user/operations/BENCHMARKS.md` (212L), `docs/user/operations/PERFORMANCE_TUNING.md` (494L), `docs/Investigaciones/FND-13-benchmarks-honestos.md` (inventario con la deuda), `benchmarks/vanta_benchmark_report.json` (gitignored — fuente del README), `docs/user/operations/BENCHMARKS.md` §8 (baseline canónico FND-10)
...
## Invariantes (handoff)
- NO tocar: docs/dev/Backlog.md, AUD-024.md, verify-log.jsonl, _vanta-cli.ps1, plan file, .opencode/AGENTS.md, .opencode/agents/*, código, JSON gitignored
