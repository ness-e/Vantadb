...
## Metadata
- **Plan file:** docs/dev/plans/2026-08-25-batch-desktop-ux-core.md (Task 2)
- **Fuente:** docs/dev/Backlog.md (auditoría P34, grupo pulido desktop)
- **Esfuerzo:** 🟡 1d
- **Prioridad:** 🟢
...
- **git status:** el worktree tiene cambios de otros agentes (AGT-04, TIR-08, FIND-11, assets, docs/dev/plans) — NO incluirlos en el commit de UX-POLISH. Commit del lead = solo `desktop/src/**` de este diff + task file.
