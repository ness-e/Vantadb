...
**Regla 11:** N/A justificado — sin claims de performance nuevos; no se documentan tiempos, solo se preservan defaults. Si se citara un número, fuente = `docs/user/operations/BENCHMARKS.md`.
