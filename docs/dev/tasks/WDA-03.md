...
- **Fuentes de verdad leídas completas:** `docs/user/operations/BENCHMARKS.md` (231L), `README.md` §instalación/quickstart (60-140), `docs/CHANGELOG.md` §0.4.0/0.5.0 (650-701). Primer commit repo: `2026-04-02` (`git log --reverse`). API Python verificada en código: `vantadb-python/vantadb_py/__init__.py` → `put()`, `get_memory(ns,key)`, `search_memory(ns,query_vector,top_k)`; import canónico `import vantadb` (README.md:66-68).
