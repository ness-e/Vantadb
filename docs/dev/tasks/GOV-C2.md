...
## Blast Radius
- **Callers:** docs/README.md (Main Index link), docs/user/operations/master-index.md (See Also), workflows gate-docs-21.yml (si valida master-index)
- **Callees:** filesystem docs/* (~26 dirs, ~649 md), docs/api/* (18 files incl. scores.md nuevo), docs/user/operations/* (35 files)
