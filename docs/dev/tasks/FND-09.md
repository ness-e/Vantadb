...
## Metadata
- **Plan file:** docs/dev/plans/2026-08-16-wave-r2-r7-fnd.md
- **Fuente:** docs/dev/Backlog.md P20b / plan Task 4
- **Esfuerzo:** 🟢 1h
- **Prioridad:** 🔴
...
- **Invariantes a preservar:** no romper el estado commiteado de vanta-worker.md (R7 ya aplicado); no tocar otras reglas (FND-11/12/13/14 son tareas separadas); no tocar archivos protegidos (docs/dev/Backlog.md, AUD-024.md, vantadb-wasm/src/lib.rs, plan file)
...
- NO ejecutar skill progreso (toca docs/dev/Backlog.md — migración la hace el lead)