...
- `docs/user/benchmarks/COMPETITIVE_SDK_BENCH.md` (57L, 2026-08-12): ya cura el run — tabla 5 motores, comando, caveats (Chroma 1 iter, sintético no extrapolable, adaptación Milvus IndexParams). ✅ Curado existe.
...
- `docs/user/benchmarks/COMPETITIVE_ANALYSIS.md` (2026-07-31): histórico + post-mortem B2/batch-size; tablas fechadas, comparabilidad advertida (§6 banner pre-Jul-31). Sin cambios necesarios.
...
- **Archivos leídos completos:** `docs/user/benchmarks/_run_stdout.md` (121L), `docs/user/benchmarks/COMPETITIVE_SDK_BENCH.md` (57L), `docs/user/benchmarks/COMPETITIVE_ANALYSIS.md` (§1–§13 muestreados), `docs/user/operations/BENCHMARKS.md` (1–951, leído §1–§17 + tail 838–951), `docs/user/benchmarks/competitive_sdk_bench.json` (vía python), `docs/user/benchmarks/ivf_bench.md` (73L).
- **Referencias hacia dentro:** §18 enlaza a `docs/user/benchmarks/_run_stdout.md`, `docs/user/benchmarks/COMPETITIVE_SDK_BENCH.md`, `docs/user/benchmarks/competitive_sdk_bench.json`, `benchmarks/competitive_bench.py`; §7 (glove 06-06) referenciado como no-comparable.
...
- Grep adjetivos/claims en `docs/user/benchmarks/*.md`; verificar cada número con fuente (bench + comando + entorno).
