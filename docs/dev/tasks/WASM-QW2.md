...
## Metadata
- **Plan file:** docs/dev/plans/2026-08-25-wasm-quickwins.md
...
- **Archivos leídos completos (antes de editar):**
  ...
  - `docs/dev/plans/2026-08-25-wasm-quickwins.md` (54 líneas) — contrato QW-2: cursor viaja como string decimal, roundtrip >2^53 testeado, archivo lib.rs:943
...
- **Archivos:** `docs/dev/plans/2026-08-25-wasm-quickwins.md` (plan file), este task file
