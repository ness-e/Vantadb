...
## Metadata
- **Plan file:** `docs/dev/plans/2026-08-16-wave-p20-tsys.md` (wave P20)
- **Fuente:** docs/dev/Backlog.md:437 (P17) · misma brecha en P18 → `TIR-07` (Backlog.md:453)
...
| Dirección | Módulos |
|-----------|---------|
| Callers | `docs/dev/Backlog.md` (P17 TSYS-06:437, P18 TIR-07:453), `docs/dev/architecture/task-system-chaos-resilience.md` (diseño T19), `docs/Investigaciones/2026-08-10-agent-engineering/REPORTE-FINAL.md:361` (§3.3-24), plan wave P20 |
...
- **Invariantes a preservar:**
  ...
  2. NO se toca `docs/dev/Backlog.md`, `verify-log.jsonl`, `completions/_vanta-cli.ps1`, plan wave P20 — la migración de la fila es del lead al cerrar la wave
