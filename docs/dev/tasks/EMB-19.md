...
- `docs/dev/tasks/EMB-19.md` (este archivo — NUEVO en DISCOVERY).
...
- `docs/dev/tasks/EMB-10.md` (binario + matriz 3 casos + ORT≥1.27 + FIND-100/101/102) · `docs/dev/tasks/EMB-12.md` (lanzador + smoke 79 + `dim==384`) · `docs/dev/tasks/EMB-13.md` (señal 0.9282 + fallback) · `docs/dev/tasks/EMB-15.md` (sinónimos `["d1","d0","d2"]` + `hybrid`) · `docs/dev/tasks/EMB-11.md` (ORT persistente `%LOCALAPPDATA%/VantaDB/onnxruntime/onnxruntime.dll` 16.46MB 2026-09-10) · `docs/dev/tasks/EMB-17.md` (switch + `MAX_CACHED_LOCAL_MODELS=2`) · `docs/dev/tasks/FIND-69.md` (precedente matriz parcial documentada).
...
- `git diff --check` pendiente al commitear (solo `docs/dev/tasks/EMB-19.md` untracked + WIP ajeno excluido).
...
| **Commit** | Atómico `chore: EMB-19` (solo `docs/dev/tasks/EMB-19.md`; install NO se commitea), `git diff` solo propios, fmt+clippy verdes |
