...
- **Plan file:** `docs/dev/plans/2026-09-18-cierre-mvp.md` (Task 7, Wave2 primera en secuencia)
- **Fuente:** spec cerrada `docs/dev/tasks/FIND-112.md` (P2-01 approve; § `llm-driver` + G2 + tests 7-8 nombrados) + slice S1 `1dd9019c` (`docs/dev/tasks/IMPL-112-S1.md`)
...
- `docs/dev/tasks/FIND-112.md` (spec: §(a) tabla variante×transporte/config/secret/test `:151-163`, §(b) TOML+env `:165-207`, §(c) lifecycle dueño por llamada `:209-240`, §(d) gates G2/G3 + tests 7-8 `:242-264`, §(e) degradado declarado `:265-275`, decisiones S1-S6 `:279-288`)
- `docs/dev/tasks/IMPL-112-S1.md` (base + veredicto fricción `:206` + S7 desviación documentada `:127`)
