...
## Metadata
- **Plan file:** `docs/dev/plans/2026-08-21-vanta-context-engine.md` (Task 9)
...
- [x] `docs/dev/architecture/adr/ADR-029-vanta-memory-context-engine.md` con banner "Borrador técnico para revisión del autor" (Regla 5 forcing function)
...
- **contract:**
  ...
  - evidencia:
    - claim: ADR-029 publicado como BORRADOR técnico | evidencia: docs/dev/architecture/adr/ADR-029-vanta-memory-context-engine.md (banner línea 1) | confianza: alta
  ...
  - artefactos: docs/dev/architecture/adr/ADR-029-vanta-memory-context-engine.md, docs/api/VANTA_MEMORY.md, docs/api/EMBEDDED_SDK.md (editado), .opencode/skills/campaign-executor/tasks/MEM-38.md
