...
## Metadata
- **Plan file:** docs/dev/plans/2026-08-08-admin-console.md
- **Creado:** 2026-08-08
...
- **Próxima tarea:** siguiente ADMIN en docs/dev/plans/2026-08-08-admin-console.md (verificar con `campaign_get_next_task`).