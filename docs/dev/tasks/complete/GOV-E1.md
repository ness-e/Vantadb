...
2. ✅ ACT — escribir `docs/dev/reviews/propuesta-limpieza-artefactos-2026-08-22.md`
...
|---|---|---|---|---|---|
| 1 | `docs/user/book/book/` | sí (83 files) | **NO** (0 tracked) | sí (:15) | auditoría, master-index (mención), snapshots históricos |
...
- Item 1 NO está "commiteado": `git ls-files docs/user/book/book` = 0. Ya ignorado. Es artefacto local → acción = borrado local opcional, NO `git rm --cached`.
...
- Doc creado: `docs/dev/reviews/propuesta-limpieza-artefactos-2026-08-22.md`
