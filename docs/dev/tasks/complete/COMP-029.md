...
- **Fuente:** docs/dev/Backlog.md:293
- **Esfuerzo:** 🟡 2-3 sem
- **Prioridad:** 🟠
...
- **Archivos:** `docs/api/TS_SDK.md` (o nuevo `docs/api/NODE_SDK.md`), `docs/dev/architecture/adr/NNN_napi-rs-node-bindings.md`, `docs/dev/Backlog.md` (COMP-029 → ✅), `VantaDB_Manual_Estrategico_Unificado.md` (P9: marcar "Node nativo (napi-rs)" como decidido/implementado)
