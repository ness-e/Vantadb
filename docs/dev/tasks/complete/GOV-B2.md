...
- **Archivos clave:** docs/user/operations/DISASTER_RECOVERY_RUNBOOK.md; src/cli.rs + src/cli_handlers/{backup,diagnostics}.rs (read-only)
...
**Referencias entrantes:** docs/user/operations/master-index.md lista el runbook (solo nombre). Sin inbound a líneas específicas.
...
3. ✅ Grep global docs/user/operations/ por comandos fantasma residuales: también corregidos `restore --from` en CONFIGURATION.md:330 y DEPLOYMENT_GUIDE.md:499,502.
