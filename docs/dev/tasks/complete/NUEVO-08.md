...
- **Fuente:** docs/dev/Backlog.md línea 118 — "Learning path estructurado en tutorials/ (5-7 ejemplos)" / audit backlog-validation-2026-07-28
- **Esfuerzo:** 🟡 2-3d
- **Prioridad:** 🟠
...
- `docs/user/tutorials/` tiene **4 tutoriales** (meta 5-7):
...
- **Archivos:** `docs/user/tutorials/*.md`
...
- **Archivos:** 1-3 tutoriales nuevos en `docs/user/tutorials/`
