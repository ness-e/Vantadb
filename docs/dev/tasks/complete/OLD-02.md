...
- **Fuente:** `docs/dev/Backlog.md:172` — Phase 9 (Old Docs Rescue)
- **Esfuerzo:** 🟡 1-2 sem
- **Prioridad:** 🗺️ Roadmap
...
- `docs/user/glosario/graphrag.md` — definición conceptual + fórmula de reducción de tokens + ejemplos idealizados de API
...
- **Archivos:** `docs/api/GRAPH_RAG.md` (nuevo), actualizar `docs/user/glosario/graphrag.md`
