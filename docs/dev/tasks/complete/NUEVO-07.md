...
- **Fuente:** docs/dev/Backlog.md línea 117 — "⚠️ Tutoriales OK, scripts ejecutables faltan"
- **Esfuerzo:** 🟡 1d
- **Prioridad:** 🟠
...
- Tutoriales SÍ existen: `docs/user/tutorials/03-migrating-from-chromadb.md` (331 líneas, status: draft) y `docs/user/tutorials/migration-from-lancedb.md` (483 líneas, status: active). Ambos prometen "a migration script you can run" — el script no existe.
...
| Dirección | Módulos |
|-----------|---------|
| Callers | docs/user/tutorials/03-migrating-from-chromadb.md, docs/user/tutorials/migration-from-lancedb.md, README (potencial) |
...
- **Archivos:** `docs/user/tutorials/03-migrating-from-chromadb.md`, `docs/user/tutorials/migration-from-lancedb.md`
