...
- **Fuente:** docs/dev/Backlog.md:172
- **Esfuerzo:** 🔴 2-3d
- **Prioridad:** 🟡
- **Tipo:** Rust
...
### Step 6: Docs + cierre
- **Archivos:** `docs/user/operations/CONFIGURATION.md` (sección `audit_log_path` + env var), `docs/api/EMBEDDED_SDK.md` (nota: operaciones auditan si está configurado), `docs/dev/Backlog.md:172` (✅)
