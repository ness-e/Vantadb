...
> **Backlog fuente:** [`docs/dev/Backlog.md`](../Backlog.md) — ver `docs/dev/Backlog.md` para conteo actual (regla de sync en Backlog header; el "165" original, "~24" intermedio y "~45" 2026-08-22 quedaron obsoletos)
