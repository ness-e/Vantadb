...
> **Plan ref:** Task 48 of `docs/dev/plans/2026-08-05-backlog-validation-actions.md`
> **Fulfills:** the `docs/dev/research/pq-feasibility.md` deliverable declared by REC-009,
...
(`docs/dev/architecture/STORAGE-TIERS.md`) maps
...
Band references: `docs/user/glosario/memory-efficiency.md` (XL "1M-10M -> 12GB",
...
- A public competitive bench requests a PQ/SQ "compression trade-off" column
  ...
  see docs/dev/research/INV-019-pinecone-architecture-competitor.md).
