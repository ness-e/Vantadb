...
the Mem0 memory-decay / Cognee memify pattern (research `docs/dev/research/human-facing-db-ui/`,
...
- Plan: `docs/dev/plans/2026-08-19-vanta-studio-fase4.md` Task 17, DEFER:207, Riesgos:217.
