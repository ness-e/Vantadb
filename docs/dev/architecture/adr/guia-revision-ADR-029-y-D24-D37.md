...
**Evidence.**
- `docs/dev/research/tdam/08-knowledge-panel-sdk.md:102` — "Ingest wiki = 1 servicio, no 2: un solo worker (`realWikiWorker`, module.ts:174-202)"; `:116` main finding repeats it.
...
**Evidence.**
- `docs/dev/research/tdam/08-knowledge-panel-sdk.md:45` — TDAM `PRIVATE_ADDR_RE` blocklist (10./172.16-31./192.168./169.254./127./0./localhost/::1/fe80:) disablable via `KNOWLEDGE_SSRF_CHECK=off` (git-fetcher.ts l.32-37).
