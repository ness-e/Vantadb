...
Los hallazgos ya trackeados previamente que este reporte menciona (**CORE-02** — hallazgo #1: grafo no persistido, hipótesis fuerte para ese bug) → referenciados en su fila existente en `docs/dev/Backlog.md`, no duplicados aquí.
