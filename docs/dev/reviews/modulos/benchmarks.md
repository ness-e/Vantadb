...
| `update_markdown.py` | Auto-actualiza tabla de métricas en `docs/user/operations/BENCHMARKS.md` | ✅ Utilitario simple. ⚠️ Ruta relativa al CWD — solo funciona desde la raíz o vía fallback. |
