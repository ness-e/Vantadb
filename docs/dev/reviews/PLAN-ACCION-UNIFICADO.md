...
> **Fuente:** consolidación de los 30 archivos de `docs/dev/reviews/`. Cada fila indica el reporte origen y fue **verificada hoy contra el código/repo/registries**.
...
- **Lectura completa** de los 30 archivos de `docs/dev/reviews/`.
...
- **Deduplicación contra `docs/dev/Backlog.md`**: cada fila propuesta verifica que no exista ya (MCP-34/35/36/37/38, BND-08, MKT-18f, MOD-22, TS-01, AUD-045 ya están; no se recrean).
