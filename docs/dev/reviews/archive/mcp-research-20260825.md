...
Nuevas filas añadidas a `docs/dev/Backlog.md` § P26 (formato canónico, sin esquemas nuevos):
...
- Interno: codegraph_explore (vantadb-mcp handlers, axioms, scene_tools), docs/api/MCP.md, mcp_tests.rs, docs/dev/Backlog.md P25/P26, task-system memory lessons+decisions
