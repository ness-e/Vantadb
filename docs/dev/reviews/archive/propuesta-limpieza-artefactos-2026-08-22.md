...
- `docs/dev/reviews/auditoria-documentacion-2026-08-21.md` (este mismo hallazgo)
- `docs/master-index.md` (mención)
- Snapshots históricos: `docs/progreso/campanas/engineering-health-waves.md`,
  `docs/dev/avance/historial/snapshot-*.md`, planes archivados
...
### Referencias entrantes
- `docs/dev/reviews/auditoria-documentacion-2026-08-21.md` (única referencia en todo el workspace)
...
- `docs/dev/research/human-facing-db-ui/*/RESEARCH.md` — menciones contextuales a Obsidian como herramienta
