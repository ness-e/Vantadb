...
- **Performance:** sin números reproducibles publicados del SDK (Regla 11);
  ...
  `docs/user/operations/BENCHMARKS.md`.
...
| H-06 | Sin benchmarks reproducibles publicados del SDK (competidores publican los suyos) | AGREGAR | media | 🟡 | ausencia en `docs/user/operations/BENCHMARKS.md`; existe `tests/test_perf_15_16.py` |
