...
| H-07 | Sin gate CI para los 261 tests del SDK (TEST_MAP: "no CI gate for TS SDK") — regresiones pueden mergear silenciosamente | MEJORAR | 🟠 media | 🟢 | `docs/dev/operations/TEST_MAP.md:18,137` |
