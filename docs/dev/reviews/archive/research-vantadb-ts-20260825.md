...
**Fuentes:** codegraph (67 símbolos), lectura completa `vantadb-ts/src/*` + package.json + README, npm registry API (2026-08-25), GitHub API vía `gh`, README oficial Orama, reviews previas (`docs/dev/reviews/modulos/vantadb-ts.md` 2026-08-22, score 7.0).
...
| H-05 | Trazabilidad rota: review 2026-08-23 afirma derivación de MOD-22/23/24 a Backlog fase P32 pero las filas NO existen → pérdida de datos en pipeline | APLICAR | 🟠 media | 🟢 | `rg MOD-2[234] docs/dev/Backlog.md` → 0 hits; `docs/dev/reviews/modulos/vantadb-ts.md:105-111` |
...
| H-07 | Sin gate CI para los 261 tests del SDK (TEST_MAP: "no CI gate for TS SDK") — regresiones pueden mergear silenciosamente | MEJORAR | 🟠 media | 🟢 | `docs/user/operations/TEST_MAP.md:18,137` |
