...
- `docs/dev/Backlog.md` §P17: columna de estado actualizada TSYS-02/03/04/06/07/08/10/11/12/13/16 (Pendiente → Implementado con commit ref) + header sincronizado. Commit a registro.
