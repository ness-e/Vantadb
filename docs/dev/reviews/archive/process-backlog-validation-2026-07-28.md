...
| **Plan files** (`docs/dev/plans/`) | 3 planes, 15 tasks | 14 | 0 | 0 | 1 (WONTFIX) |
...
| **MKT-05** | Blog posts (5+) | ⚠️ | 3 archivos en `docs/user/blog/` (backlog dice 4/5). Faltan 2. |
...
| **OLD-17** | Migration guides | ✅ | `docs/user/tutorials/migration-from-lancedb.md` + `03-migrating-from-chromadb.md` |
...
|------|-------------|----------|-----------|
| **MKT-05** | "4/5 blog posts" | 3 archivos en `docs/user/blog/` | ⚠️ Backlog **infla** conteo |
