...
> **Contrato:** `Select-String -Path "docs/dev/reports/*" -Pattern "registros live" | Measure-Object Count` >=1
...
- `docs/dev/reports/INDEX.md` — este file `GOV-A5-registros-live.md` debe indexarse como `verify` vigente 2026-09-02

## Verificación mecánica

```powershell
Select-String -Path "docs/dev/reports/*" -Pattern "registros live" | Measure-Object Count  # >=1 ✅
Select-String -Path "docs/dev/reports/GOV-A5-registros-live.md" -Pattern "crates\.io|PyPI|npm" | Measure-Object Count  # >=3 ✅
