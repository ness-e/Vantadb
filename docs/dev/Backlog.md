...
> **Total open items:** 125 abiertas de 155 filas (+38 filas P52–P56 post-investigación integral 2026-09-24) (medido 2026-09-24; delta desde 2026-09-16: +26 FIND-63..88 ingeridos, −cerradas a `docs/dev/avance/` vía progreso) (previo 2026-09-16: 70 abiertas de 73 filas)
---
...
| **P53** 🧬 Esquema v0.7.0 — migración única (IMPL-MGR, consume P49) | 8 (SCH-01..08: bitemporalidad + confianza + cuarentena; decisión owner 2026-09-24) | ~4-5 semanas | 🔴 Alta (es el v0.7 real de datos; trigger: research-doc MGR-10/12/13 cerrado + P2-01) |
...
| **P57** 🧹 Estabilización residual (EST/C → catálogo, 2026-09-24) | 8 (EST-03 ci-gate re-propuesta, EST-05 bench verde, EST-09 post-merge, EST-10 barrido API stale, EST-12 puertas owner, C-07 curar PRs, C-08 CodeQL setup, C-10 cierre README) | ~1-2 semanas | 🟠 Media (pre-requisito de anuncio) |
...
| ID | Descripción | Archivos | Esfuerzo | Prio | Estado Real |
|----|-------------|----------|----------|------|-------------|
| `EST-03` | **ci-gate: re-propuesta corregida (HEAD de `main` + `skipped` como pass)** — 🎯 OP: la propuesta anterior fue refutada por evidencia (run `36061913564`: checks `<not found>` → fail-closed eterno); re-proponer al owner con opciones A/B y solo aplicar tras aprobación. Refs: plan EST §EST-03 + `sesion-continuidad.md` §4.3. Dep: aprobación owner. DoD: job verde en PR con CI por correr (no exigir checks inexistentes). | `.github/workflows/ci-gate.yml` | 🟡 1-2d | 🔴 | 🆕 Pendiente (P57 2026-09-24) |
...
| `C-10` | **Cierre README (paridad ES/EN + badges)** — 🎯 OP: cierre total tras C-02 verificado (workflows de badges existen, links resuelven). Refs: plan total §C-10. | `README.md`, `README_ES.md` | 🟢 0.5d | 🟡 | 🆕 Pendiente (P57 2026-09-24) |
