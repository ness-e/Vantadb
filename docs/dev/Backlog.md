...
> **Execution state lives in:** `docs/dev/plans/YYYY-MM-DD-<campaign>.md` (plan file) + task files — per campaign-executor RULES.md §2. This file is the task catalog; the plan file is the execution state.
...
> **Total open items:** 125 abiertas de 155 filas (+38 filas P52–P56 post-investigación integral 2026-09-24; +5 filas auditoría externa verificada 2026-09-25: SCH-09, WIRE-11, HIG-01..03) (medido 2026-09-25; delta desde 2026-09-16: +26 FIND-63..88 ingeridos, −cerradas a `docs/dev/avance/` vía progreso) (previo 2026-09-16: 70 abiertas de 73 filas)
---
...
| **P12** 🖥️ DESKTOP App (Tauri) + Consola Admin | 0 — ✅ **Cerrada 2026-08-24** (campaña DESKTOP-23..39: 17/17 ejecutadas, ver `docs/dev/avance/activo/desktop.md`; ADMIN-01..09 + DESKTOP-20 ✅; resto archivadas por P26). Deuda menor: smoke-test instalador en VM limpia + validación manual dashboard proxy con upstream LLM | — | ✅ Cerrada |
...
| **P23** 🔒 VantaDB Pro (Open Core) | 0 — 6 filas Pro movidas a `docs/dev/Backlog-negocio.md` (trigger de inicio = decisión de negocio; vuelven aquí al arrancar Pro) | ~8-12 semanas | 🔵 Futuro |
...
| **P26** 🖥️ Vanta Studio (consola human-facing desktop) | Fase 0 ✅ (14/19) + Fase 1 ✅ (9/9) + Fase 2 ✅ (10/10: VS-CORE-04/05/06 + GRAFO-01..03 + ESPACIO-01..02 + OP-01..02) + Fase 3 ✅ (7/7: WEB-00..06) + **Fase 4 ✅ (18/18: DOC-01..04 + REST-01..06 + WASM-01..04 + FEAT-01..03 + VER-01)** | Planes archivados `docs/dev/plans/archive/2026-08-18-vanta-studio-fase{1,2,3}.md` + `docs/dev/plans/archive/2026-08-19-vanta-studio-fase4.md` | 🟢 Completada 2026-08-20 (ADR-027; E2E server + standalone WASM/OPFS PASS) |
| **P27** 🧠 Vanta Memory Engine (TDAM, orden F1–F7) | 38 (MEM-01..38) | ~8-12 semanas | 🔴 Alta (decisión de producto) |
| **GOV** 📋 Gobernanza Documental (post-auditoría 2026-08-21, plan `docs/dev/plans/2026-08-22-doc-governance-plan.md`) | 30 tareas (T0: TIR ×3 · A: medición ×5 · B: Show-HN ×6 · C: maestros ×7 · D: taxonomía ×6 · E: limpieza ×1 · F: auditoría intocadas ×2) | ~6 días | 🔴 Alta (Wave B bloqueante Show HN; decisiones D1-D14 del owner en `docs/dev/reviews/auditoria-documentacion-2026-08-21.md`) |
...
| **P56** 🔌 Cableado post-investigación | 11 (WIRE-01..11: loop proxy, perfil MCP, query_sparse, TTL, entity linking, batching, refactors, range/cursor, seguridad P0, distribución P0, llm-driver; +WIRE-11 2026-09-25) | ~5-8 semanas | 🔴 Alta (hacer real lo prometido) |
...
| **P58** 🧹 Higiene post-auditoría externa (2026-09-25) | 3 (HIG-01..03: CHANGELOG dedup, ADR-041 numeración+firma, dead code) | ~2-3 días | 🟡 Media (pre-anuncio) |
...
> **Nuevo 2026-09-24 (post-investigación integral):** auditoría de 2 informes (módulos + arquitectura/producto/competencia) + investigación web (17 sistemas de memoria, 10 BDs multi-modelo) + revisión de definición de producto (`docs/dev/research/product-definition-gap-2026-09-24.md`) → **P52** Verificabilidad (VER-01..09), **P53** Esquema v0.7.0 migración única (SCH-01..08), **P54** Tracks ICP (ICP-01..03), **P55** Frontera de producto (DEF-01..08), **P56** Cableado (WIRE-01..10); negocio `Backlog-negocio.md` BIZ-10..13; Notion `backlog-notion.md` N-12..N-17. Plan: `docs/dev/plans/2026-09-24-post-investigacion-integral.md`. Decisiones owner: 3 tracks ICP · migración única MGR-10+12+13 en 0.7.0 · harness completo + head-to-head · cobro PayPal/Binance/Payoneer. Renumeración documentada: "P51 Verificabilidad"/"P52 ICP" del análisis → P52/P54 por colisión con Phase 51 (Estandarización 11 APIs); la fila "P51 IMPL-MGR" previa de este Exec Summary quedó como P53. Ampliación misma fecha: **P57** Estabilización residual (EST-03/05/09/10/12 + C-07/08/10 catalogados desde los planes `2026-09-24-estabilizacion-pendiente.md` y `2026-09-20-estabilizacion-total.md` para visibilidad del pipeline).
> **Nuevo 2026-09-25 (auditoría externa verificada):** verificación de los 3 informes externos (síntesis + `VantaDB-Analisis-Arquitectura-Producto-Competencia.md` + `VantaDB-Informe-Analisis-Completo.md`) contra HEAD (~20 claims con evidencia file:line). Resultado: casi todo ya estaba catalogado (P49–P57, API-05, WIRE-09/10, DEF-06, FIND-98); **solo 5 hallazgos verificados sin fila** → `SCH-09` (P53), `WIRE-11` (P56) y **P58** Higiene (HIG-01 CHANGELOG duplicado, HIG-02 ADR-041 numeración duplicada, HIG-03 dead code 44). Descartados por ya resueltos: mojibake en `src/` (0 hits), mirrors 86 tools (0), export/import sandbox (fix `fc069a06f`), gate-docs trigger (`81263fb1`), bench script (`4b5b137e`). Claims falsos del informe no ticketeados: "confidence no expuesto", "12 crates", "604 completadas". Observación aparte: `MEM-55` (scheduler host, verificado `conversation_trigger: None`) existe como task file activo sin fila de catálogo — decidir catalogar o cerrar.
> **Nuevo 2026-09-25 (release 0.7.0):** merge #222 → publish completo (crates.io `0.7.0`, npm `vantadb`/`vantadb-wasm` 0.7.0, PyPI `vantadb-py` 0.7.0, 4 wheels en el Release, SBOM) + fix mojibake CHANGELOG (PR #226) + EST-09/C-08 cerrados + `FIND-154` (perf gate falso positivo por varianza de runner).
...
>
> **RES-15-C 2026-09-03:** la única fila de esta fase (enterprise features → negocio) se movió a `docs/dev/Backlog-negocio.md` §P8. El lado código que aparezca al planificarla se ticketea acá.
...
## P14 — REVIEW items (hallazgos de `docs/dev/reviews/review-full-2026-07-27-0309.md`, validado 2026-08-05)
...
> Origen completo: `docs/dev/research/investigacion-equipo-2026-08-09.md`. **Ejecutada 2026-08-09 por plan `docs/dev/plans/archive/2026-08-09-backlog-pipeline.md` — 19/19 tareas ✅** (FEAT-01..07, REVISAR-01, COV-001/003/004, PERF-01/04/06, DOC-02..08; RELEASE-01/02/03 + SEC-01 en Wave 0). Commit por feature en `docs/progreso/README.md`. Residuales viven en sus secciones: `CI-01` (hallazgos pendientes/CI), `REVIEW-05` (P14).

---

## Phase 11: 🧠 Embeddings Local-First — 0 — ✅ 9/9 COMPLETADA 2026-08-28

> **Cerrada 2026-08-28 — 9/9 EMB-01..09** (commits `2c185021`→`d24eeb1c`, plan `docs/dev/plans/2026-08-28-embeddings-local.md`): `embeddings/` + `embed-local` (ort+tokenizers) + `vanta-memory` L1 + MCP `embed_texts` + SQL auto-embed + bench + docs + Qwen3 excepción. Registro en `docs/dev/avance/activo/core-engine.md` §Phase11 + `backlog-history.md`. Plan archivado `docs/dev/plans/archive/2026-08-28-embeddings-local.md`.
...
- **RC items:** PROJECT_FULL_REVIEW_2026-07-13 (ARCHIVADO - generado por vantadb-full-review; ver docs/dev/reviews/)
> **Nota GOV-C3 2026-08-22:** los reportes citados en esta seccion (audit-reports/*, REPORTE_EVALUACION_COMPLETO.md, FULL_CODEBASE_AUDIT_2026-07-11, PROJECT_FULL_REVIEW_2026-07-13) fueron disueltos/archivados; contenido procesado en docs/dev/reviews/ y BACKLOG_HISTORY.md. Rutas = referencia historica.
...
| `FIND-123` | Alta | `memory_recall` declara `outputSchema` pero devolvía solo `content` texto (sin `structuredContent`): clientes MCP estrictos rechazan la llamada ("did not return structured content"), dejando `memory_recall` inutilizable vía agente aunque el hook MEM-18 funcione. Root cause: brazo `memory_recall` usaba `text_content(serialize_content(...))` en vez de `text_content_structured(...)` (patrón ya usado por `memory_put`/`memory_get`). Fix: 2 líneas + assert en `test_mcp_structured_output_and_output_schema`. Alcance extra: `opencode.jsonc` sigue lanzando `vanta-cli server --mcp` directo sin env de embeddings (sin `VANTADB_EMBEDDING_PROVIDER`/`VANTADB_LOCAL_MODEL`/`ORT_DYLIB_PATH`) → todo el MCP corre en fallback BM25; migrar al launcher `vanta-mcp-local.ps1` (EMB-12) + rebuild con `embed-local` para señal vectorial real. Origen: E2E OpenCode 2026-09-24 (put/get/search/IQL/threads/scenes OK; `memory_recall` 2/2 FAIL + `embed_texts fallback:true provider=unconfigured`) | `vantadb-mcp/src/handlers/tools.rs:1786-1793`, `vantadb-mcp/tests/mcp_tests.rs`, `opencode.jsonc` | 🟢 | 🔴 Alta | ✅ Verificado 2026-09-24 (fix `text_content_structured` + test `test_mcp_structured_output_and_output_schema` GREEN 1/1; hallazgo raíz: `vanta-cli server --mcp` delega en binario `vantadb-server` — el build EMB-10 apuntaba al binario equivocado; rebuild `cargo build -p vantadb-server --features vantadb-mcp/embed-local,vantadb-mcp/remote-inference` 47s + smoke stdio `embed_texts` → `fallback:false`, dim 384, normas 1.0, cos(par)=0.92; `opencode.jsonc` migrado al launcher EMB-12. Pendiente: reinicio OpenCode del usuario + retest vivo recall/semántico) |
| `EMB-11` | Alta | Asistente de instalación con defaults (Q1/Q2: 3 verificados + resto avisado; secrets nunca a disco) | `setup-embeddings.ps1` (nuevo), `embeddings/`, `docs/dev/tasks/EMB-11.md` | 🟡 | 🟠 Media-Alta | ✅ Completada 2026-09-16 (`-NonInteractive` exit 0 + `download.py --check` verde + ORT 1.30 store persistente; commit `a3c4d903`; review P2-01 approve) |
| `EMB-12` | Alta | Script lanzador (env + arranque MCP, `--db` explícito) | `vanta-mcp-local.ps1` (nuevo), `opencode.jsonc`, `docs/dev/tasks/EMB-12.md` | 🟢 | 🟠 Media-Alta | ✅ Completada 2026-09-16 (params `-DbPath` mandatory + env sesión + ORT autodetect + smoke vivo `initialize` OK/`tools/list` 79/`embed_texts` dim==384; commit `f80b9886`; review P2-01 approve) |
| `EMB-13` | Alta | `embed_texts` al proveedor real + fallback avisado `"fallback": true` (núcleo FIND-99, Q5) | `vantadb-mcp/src/handlers/tools.rs:2607`, `docs/dev/tasks/EMB-13.md` | 🟡 | 🔴 Alta | ✅ Completada 2026-09-16 (vía provider real par 0.9282 vs impares 0.8427/0.8366 + `fallback:true`+warning sin modelo + budgeting intacto + 7/7 ambas cfgs + full MCP 181/181; commit `ad8af1d1`; review P2-01 approve) |
| `EMB-14` | Alta | Auto-embed en `memory_put`/`put_batch` (respeta vector provisto; fallo → guarda + aviso) (cierra FIND-99 con EMB-13) | `vantadb-mcp/src/handlers/tools.rs`, `docs/dev/tasks/EMB-14.md` | 🟡 | 🔴 Alta | ✅ Completada 2026-09-16 (auto-embed vía 1 `embed_batch` + provisto byte-exacto + `fallback:true`+warning + señal real par 0.9282; commit `11de0d42`; review P2-01 approve) |
| `EMB-15` | Media | Embed de query con el mismo proveedor + prueba sinónimos (FIND-99) | `vantadb-mcp/src/handlers/tools.rs`, `docs/dev/tasks/EMB-15.md` | 🟡 | 🟠 Media-Alta | ✅ Completada 2026-09-16 (query vía `embed_query` activo + sinónimos felino↔gato + keyword avisado sin proveedor; commit `9f4fd725`; review P2-01 approve) |
| `EMB-16` | Media | Prefijos e5 (`query:`/`passage:`) por familia + margen medido | `src/llm.rs`, `docs/dev/tasks/EMB-16.md` | 🟢 | 🟡 Media | ✅ Completada 2026-09-16 (`embed_query` default + familia por substring + margen asimétrico 0.1204 (+48%) + llm 14/14 + clippy 0; commit `be6a3c27`; review P2-01 approve) |
| `EMB-17` | Media | Parámetro `model` honrado (caché por modelo + error claro; Q2) | `vantadb-mcp/src/handlers/tools.rs`, `src/llm.rs`, `docs/dev/tasks/EMB-17.md` | 🟡 | 🟡 Media | ✅ Completada 2026-09-16 (switch por id manifest + caché tope 2 avisado + error lista válida + download hint; commit `34b6ca63`; review P2-01 approve) |
| `EMB-18` | Media | Regla una-dim-por-base: error claro + comando reindex (Q4, nunca auto silencioso) | `vantadb-mcp/src/server.rs`, `docs/dev/tasks/EMB-18.md` | 🟢 | 🟡 Media | ✅ Completada 2026-09-16 (4 gates put/put_batch/search_semantic/parse_search + helper `dim_mismatch_guidance` + 2 tests + base vacía sin gate; commit `43405be3`; review P2-01 approve) |
| `EMB-19` | Alta | Verificación e2e + reinstalación coordinada (matriz local/ollama/openai condicional) | `~/.cargo/bin/vanta-cli.exe`, `docs/dev/tasks/EMB-19.md` | 🟡 | 🔴 Alta | ✅ Completada 2026-09-16 (rebuild final + cat 0.9158 vs 0.8427/0.8423 + suites mcp/memory verdes + test-mcp 4/4×3 + reinstall 79 vía PATH; commit `a5d549af`; review P2-01 approve) |
| `EMB-20` | Baja | Docs: README tabla + MCP doc + SKILL (Regla 11) | `embeddings/README.md`, `docs/api/MCP.md`, `docs/dev/tasks/EMB-20.md` | 🟢 | 🟢 Baja | ✅ Completada 2026-09-16 (tabla 9 modelos + 3 proveedores + dim-gate + `embed_texts` real + coverage 0 gaps; commit `46992d8c`; review P2-01 approve) |
...
| `FIND-134` | Alta | `ci-rust-10.yml` hardening: quitar `develop` de push (dedup), fast-fail `needs:[fmt,clippy]`, politica por `continue-on-error`, condicion `wasm-test` valida en PR. Contrato: 1 push = 1 run. Origen: auditoria workflows 2026-09-21 (CI-core) | `.github/workflows/ci-rust-10.yml` | ?? | ?? Alta | ? Pendiente |
| `FIND-135` | Media | `timeout-minutes` a jobs sin limite (default 6h): `desktop.yml` x3, `ci-gate.yml`, `ocr-delegate.yml`, `ocr-nightly.yml` x3, `opencode.yml`. Origen: auditoria workflows 2026-09-21 (CI-core + gates) | `.github/workflows/desktop.yml`, `.github/workflows/ci-gate.yml`, `.github/workflows/ocr-delegate.yml`, `.github/workflows/ocr-nightly.yml`, `.github/workflows/opencode.yml` | ?? | ?? Media | ? Pendiente |
| `FIND-136` | Media | Cobertura + cache: `providers-ci.yml` (branches + toolchain SHA), `chaos-45.yml` (paths + concurrency), `ci-examples-12.yml` (`cache:pip`), `adapters-compat.yml` (cache Rust/pip, sin `|| true`). Origen: auditoria workflows 2026-09-21 (CI-core) | `.github/workflows/providers-ci.yml`, `.github/workflows/chaos-45.yml`, `.github/workflows/ci-examples-12.yml`, `.github/workflows/adapters-compat.yml` | ?? | ?? Media | ? Pendiente |
| `FIND-137` | Media | Unificar rustdocs (`ci-rustdoc.yml` vs `rustdoc-70.yml`, se cancelan entre si) en uno + badges README. Origen: auditoria workflows 2026-09-21 (CI-core) | `.github/workflows/ci-rustdoc.yml`, `.github/workflows/rustdoc-70.yml`, `README.md` | ?? | ?? Media | ? Pendiente |
| `FIND-152` | Media | L7 residual warn-mode: ~39 `unwrap` en contexto prod (`vantadb-wasm/src/lib.rs` 14, `shred/mod.rs` 4, tauri 6) + 14 unchecked-ops ast-grep + 67 unsafe-review pointers. Disposar antes del endurecimiento a ERROR (fila por fila: `?`/expect con contexto o justificacion). Origen: baseline semgrep/ast-grep FIND-149 2026-09-24 | `src/**`, `vantadb-wasm/src/**`, `desktop/src-tauri/src/**` | 🟡 | 🟡 Media | ⬜ Pendiente (baseline en `docs/dev/tasks/FIND-149.md` §Dictamen; NO implementar desde rol audit — asignar a worker/engine) |
| `FIND-154` | Media | perf-bench gate falso positivo por varianza de runner: mismos commits verdes en develop (dispatch `36094025761`, 04:20Z) → rojo en main (push `36101773914`, 06:11Z): `query_hybrid.p50` 5.76→12.01ms (+108.5%), `p95` +88.1%, `p99` +18.8%, `query_text.p99` 0.01→0.04ms (µs = ruido). Baseline `benchmarks/python_baseline.json` calibrado en una máquina concreta → tolerancia por métrica / banda de varianza / re-baseline. Origen: release 0.7.0 post-merge 2026-09-25 | `.github/workflows/perf-bench.yml`, `benchmarks/python_baseline.json` | 🟡 | 🟡 Media | ⬜ Pendiente (evidencia: `docs/dev/avance/activo/ci-cd.md`) |
| `FIND-138` | Media | Flake 'Generate API reference 0s' (2 muertes sin log): diagnosticar causa y fix o declarar infra externa. Origen: PR #202 CI 2026-09-21 | `.github/workflows/ci-rustdoc.yml` (o el que genere el job) | ?? | ?? Media | ? Pendiente |
| `FIND-139` | Media | `ci-gate.yml` (timeout, concurrency, `*)` no traga pending, REQUIRED con semver/ADR) + `gate-docs-21.yml` (PR a develop tambien). Origen: auditoria workflows 2026-09-21 (CI-core + gates) | `.github/workflows/ci-gate.yml`, `.github/workflows/gate-docs-21.yml` | ?? | ?? Media | ? Pendiente |
| `FIND-140` | Alta | Publishing hardening: `release.yml` solo `main` + timeout/env/concurrency; triggers npm-61/node validos (+PR a node); gate version en adapters prod; binaries trigger vs upload; namespaces de tags. Re-run por archivo. Origen: auditoria workflows 2026-09-21 (release) | `.github/workflows/release.yml`, `.github/workflows/release-npm-61.yml`, `.github/workflows/release-npm-node.yml`, `.github/workflows/release-adapters-62.yml`, `.github/workflows/release-binaries-63.yml` | ?? | ?? Alta | ? Pendiente |
| `FIND-141` | Media | Schedules: desolapar heavy-cert vs heavy-bench (03:00), guard `[skip ci]` en auto-push baseline, `retention-days` corpus fuzz. Origen: auditoria workflows 2026-09-21 (gates) | `.github/workflows/heavy-certification-50.yml`, `.github/workflows/heavy-bench-nightly-51.yml`, `.github/workflows/fuzz-40.yml` | ?? | ?? Media | ? Pendiente |
| `FIND-142` | Media | Renombres sin numeros (`ci-rust-10.yml` -> `ci-rust.yml`, etc. via `git mv`) + badges README. ULTIMO edit de archivos (tras Waves 0-2). Origen: auditoria workflows 2026-09-21 | `.github/workflows/*.yml`, `README.md` | ?? | ?? Media | ? Pendiente |
| `FIND-143` | Media | `docs/dev/workflow/` (vanta-docs): inventario 28 + matriz triggers + flujo publish por registro + runbook + FAQ. Origen: auditoria workflows 2026-09-21 | `docs/dev/workflow/` (nuevo) | ?? | ?? Media | ? Pendiente |
| `FIND-144` | Media | `docs/dev/workflow/RULES.md` + refresh `CI_POLICY.md` (26 -> 28) + 1 fila puntero en `AGENTS.md` raiz (NO duplicar; `.opencode` es local-only). Tras FIND-143. Origen: auditoria workflows 2026-09-21 | `docs/dev/workflow/RULES.md`, `docs/dev/operations/CI_POLICY.md`, `AGENTS.md` | ?? | ?? Media | ? Pendiente |
...
> Items §3.3 (FALTA, cobertura 0-30%) y §3.5 (MAL/CONTRADICTORIO) de `docs/dev/research/2026-08-10-agent-engineering/REPORTE-FINAL.md` no asignados a los planes P0-P3 (Task 14 de `docs/dev/plans/archive/2026-08-10-docs-task-system-consolidation.md`). **TSYS-01..05, 07..11, 13..16 implementados 2026-08-11 → migrados a progreso** (plan `docs/dev/plans/archive/2026-08-11-residuo-consolidado.md`). Pendientes: TSYS-06 (runner DEFER) y TSYS-12 (runtime opcional, NO gate-CI). Los de runtime con datos dependen de Task 2 (poblar `verify-log.jsonl`).
...
> **Origen:** `docs/dev/strategy/VANTADB-PRO-FEATURES.md` § "Backlog Pro" + verificación multi-agente 2026-08-17. **Meta-modelo implementado** (repo privado `vantadb-pro` existe con `license.rs::verify_string` + `generate-license.ps1` + 4 tests; workspace aislado `Cargo.toml:620-626`; core sin refs Pro — D4 respetado). **Las 6 features NO tienen código** (solo `lib.rs`+`license.rs`) **ni tracking** — esta sección las trackea. Nacen en `vantadb-pro` (repo privado, fuera del workspace). Proceso: D5 entrega manual Enterprise hasta entidad.
>
> **RES-15-C 2026-09-03:** las 6 filas Pro se movieron a `docs/dev/Backlog-negocio.md` §P23 — el trigger de inicio (pricing/licensing/entidad) es decisión de negocio; las features son implementables por agentes cuando Pro arranque, y vuelven a esta sección al activarse.

---

## P24 - I+D futura (v3.0+, re-verificada 2026-08-17)

> **Origen:** `docs/dev/backlog-futuro.md` — catálogo de I+D diferido (freeze R5). Re-verificación multi-agente 2026-08-17: **FUT-01 ✅ IMPLEMENTADO (sacado)** — RaBitQ 1-bit + Hamming ya existe (`quantization.rs:16,33-46`, `Binary(Box<[u64]>)`); **FUT-07/FUT-09 redefinidos** (bloques base existen, falta cableado); **FUT-02/03/04/05/06/08/10/11 siguen sin implementar**. Documento fuente es la versión canónica de cada fila. **Actualización 2026-09-03 (RES-09):** +FUT-12/13/14 del roadmap huérfano → `docs/dev/research/archive/investigacion-equipo-2026-08-09.md` §roadmap.
...
> Origen: auditoría `docs/dev/research/human-facing-db-ui/` (03-gaps, 04-gaps, 05-vigente, 06-§8, 07-vigente). Lo consumido (F0–F4) no se re-trabaja.
...
> **Origen:** investigación completa `docs/dev/research/tdam/` (PLAN + 01..09 verificados + SYNTHESIS) — TencentDB-Agent-Memory (clon completo `97f9465`, v2.0.0-beta.1). **Decisión arquitectónica:** core VantaDB puro (sin LLM, WASM-compatible); features LLM-driven en crate nuevo `vanta-memory`; se extiende `vantadb-mcp`/`vantadb-server`; binario opcional `vanta-proxy`. **NO copiar** split 4 servicios, Redis, SQLite/dual-write, store Mongo, `@colbymchenry/codegraph`, agent-adapters, 3 imágenes Docker, prompts chinos Kenty. Análisis multi-agente (3× vanta-research 2026-08-18) → 38 tareas consolidadas (2 propuestas duplicadas fusionadas: telemetría). **Se ejecuta por plan** `docs/dev/plans/2026-08-18-vanta-memory.md`. **Decisiones resueltas 2026-08-18 (D1-D12):** LLMRunner ambos sync+async · nodo escena entra · tiktoken o200k_base (validar WASM) · entity_* en InternalMetadata · vanta-proxy crate aparte · checker 7 eslabones · skills síncrona · MMD Mermaid literal · callback hook local + estado en store · **F6/F7 segunda iteración** · vanta-memory interno del workspace. **Relación con P26:** integración por contratos (no ejecución) — tabla "Relación con P26" en el plan; no bloqueante.
...
> **Origen:** auditoría documental completa docs/dev/reviews/auditoria-documentacion-2026-08-21.md (Volumen I+II+Addendum, salud 6.5/10) + **decisiones del owner D1-D14** registradas en su sección final. **Plan de ejecución:** docs/dev/plans/2026-08-22-doc-governance-plan.md (formato campaign, triage 30 DO / 2 DEFER). Task files se crean bajo demanda vía /pipeline task GOV-XX. Wave B es bloqueante del Show HN.
...
> **✅ Cerrada 2026-08-26 — DESKTOP-QW5 (H-13):** 9/9 DAUD verificadas y archivadas. Fixes D1-D11 ya commitados: E2E-VISUAL `480935a7` (DAUD-01), DAUD-LIMPI `3c53d8b2` (DAUD-03/04/05/07) + `b865c625` (DAUD-06/11), filterActive `ad0f34b1` (DAUD-02/QW4). Stash `06aa1a86` consumido por `b865c625` (DAUD-08). Registro en `docs/dev/avance/activo/desktop.md` §P37 + `backlog-history.md` §Limpieza DAUD 2026-08-26. Plan: `docs/dev/plans/2026-08-25-research-desktop-quickwins.md` Wave1 Task5.
>
...
|----|--------|-------------|--------|--------|
| `DEC-01` | 🟠 | **Session layer VantaDB MCP: go/no-go y alcance.** Roadmap de 4 fases propuesto (session cache, Claude Code plugin, sync/improve, lesson extraction) pero las 5 open questions siguen abiertas. Decidir vía ADR antes de escribir código | `COGNEE_EVALUATION.md`; research `docs/dev/research/res03-session-layer-gonogo.md` | ✅ Resuelta por research (2026-08-25): **defer-as-scoped** — F1 no-go (threads/scenes/genlog ya lo cubren), F2 defer docs-only (guía conexión Claude Code), F3/F4 no-go (sync auto requiere benches Regla 9). Owner escribe ADR citando el doc |
...
> **Origen:** `/research vantadb-wasm` → `docs/dev/reviews/research-vantadb-wasm-20260825.md` (score 6.8/10, apéndice H-01..H-23). Decisiones HITL 2026-08-25: 14 filas nuevas WSM + plan quick wins (`docs/dev/plans/2026-08-25-wasm-quickwins.md` con H-01/H-05/H-07/H-08/H-16) + 2 estrategias aprobadas (H-21 adopción npm, H-22 ADR browser-first) + 1 wontfix (H-23 static-hosting read-only). Duplicados ya trackeados NO recreados: H-19=`P2-8`. MOD-25..28 derivados del review 2026-08-22 nunca materializados (H-02): absorbidos por este batch (fallback→WSM-01, cuotas→WSM-02, nits→plan quick wins).
...
> 10. ADR breve en `docs/dev/architecture/adr/` registrando la promoción y el coste (tiempo CI + toolchain extra) — reversible
...
- **Plan completo:** `docs/dev/plans/2026-08-30-testing-bench-harden.md` (7 decisiones, 3 fases, riesgos, verificación)
...
**Plan file:** `docs/dev/plans/2026-08-30-testing-bench-harden.md` (archivado a `docs/dev/plans/archive/` 2026-08-31)
...
**CI/CD (`docs/dev/avance/activo/ci-cd.md`):**
...
**Benchmarks (`docs/dev/avance/activo/ci-cd.md` o `core-engine.md`):**
...
**Tests (`docs/dev/avance/activo/ci-cd.md`):**
...
**Datasets/docs (`docs/dev/avance/activo/ci-cd.md` o `operaciones.md`):**
...
- `TBH-16` — `divan` NO introducido (D1+D5) — `docs/dev/research/bench-framework-evaluation-2026-08-30.md` — commit `42cce02c`
- `TBH-17` — `loom` NO introducido — `docs/dev/research/concurrency-testing-2026-08-30.md` — commit `ef4652bf`
- `TBH-18` — `dhat` NO introducido (YAGNI) — `docs/dev/research/dhat-evaluation-2026-08-30.md` — commit `fa87bbe2`
...
> **Cierre MGR (obligatorio en las 25 filas):** (1) escribir `docs/dev/research/mgr-XX-<tema>.md` con TODA la información conseguida; (2) hacer las preguntas necesarias con question-opencode al owner; (3) crear el plan de implementación o grupo de tareas de implementación con el mismo nivel de detalle.
...
| ID | Descripción | Archivos | Esfuerzo | Prio | Estado Real |
|----|-------------|----------|----------|------|-------------|
| `MGR-19` | **Benchmarks propios y externos (Anexo B)** — 🎯 OP: correr `canonical_p99`, definir suite LoCoMo/LongMemEval/BEAM, adueñar los números. OS: fijar baseline en BENCHMARKS.md. Tipo: validación. Cobertura: Propuesta Anexo B; transversal. Refs: `benches/*` (23), `benchmarks/*.py`, `docs/user/operations/BENCHMARKS.md`. Dep: ninguna (puede correr en paralelo). DoD: números publicados + Cierre MGR. **Decisión owner 2026-09-14: alcance completo (canonical_p99 + LoCoMo/LongMemEval/BEAM).** | `benches/`, `benchmarks/`, `docs/user/operations/BENCHMARKS.md` | 🟡 3-5d | 🔴 | 🆕 Pendiente (P49 2026-09-14) |
...
## Phase 51: 🔌 Estandarización 11 APIs — Ejecución (de síntesis API-STD-15, 2026-09-24)

> Origen: `docs/dev/plans/2026-09-24-api-estandarizacion.md` + síntesis normativa `docs/dev/tasks/API-STD-15.md` (Gate P 4/4 aprobado) + re-validación `API-STD-16.md`. Breaking ilimitado (`feat!:`) — nadie usa los paquetes; todo debe quedar funcional para el siguiente release. MCP local (`vanta-mcp-local.ps1`) se refresca ante cualquier cambio de tools. Orden estricto por waves (dependencias); cada fila con verify + rollback (detalle en `docs/dev/tasks/API-STD-18.md`).

| ID | Descripción | Archivos | Esfuerzo | Prio | Estado Real |
|----|-------------|----------|----------|------|-------------|
| `API-01` | **W0 fundación: tipos base + error + casing + u128 (síntesis 15)** — 🎯 OP: 1 schema → codegen Rust/Python/TS; error `code+message+context` + RFC 9457 en HTTP; casing fronteras (camelCase JSON/MCP, kebab CLI); `u128→string` decimal en TODAS (incl. napi FIND-NEW-01 + `Write.node_id` R4). OS: pagar P2-5/P2-8 (Regla 6); benchmark si toca hot (Regla 9). Tipo: implementación breaking. Cobertura: síntesis 15 (tipos, errores, casing). Refs código: `src/sdk/types/`, `src/error.rs`, `src/sdk/types/graph.rs:18-24`, bindings tipos. Dep: ninguna (primera). DoD: `verify_changed.ps1` + `sdk_serialization` verdes + wire >2^53 con test. | `src/sdk/types/`, `src/error.rs`, `vantadb-python/src/types.rs`, `vantadb-ts/src/types.ts`, `vantadb-node/index.d.ts`, `vantadb-wasm/src/lib.rs` | 🔴 3-5d | 🔴 | 🆕 Pendiente (P51 2026-09-24) |
| `API-02` | **W1 bindings: score + firmas + getNode + u128 (Gate P)** — 🎯 OP: `score` en TS (quitar `distance` sin invertir); `put_batch` array-objetos en Py; flat nodo Py → `getNode/deleteNode`; `roots: number\|bigint[]`; `searchMulti` en Py; `bulk_import` en TS/Node; `method` inline Node; sparse-escritura + `exclude_superseded` Node; fix wasm `import_records` (aceptar `MemoryInput`/u64-string) para que TS delegue. OS: mapear `tests/api/python.rs` antes; `feat!:` por binding. Tipo: implementación breaking. Cobertura: síntesis 15 (nombres, firmas). Refs código: `vantadb-python/src/lib.rs`, `vantadb-ts/src/vantadb.ts`, `vantadb-node/`, `vantadb-wasm/src/lib.rs`. Dep: API-01 (tipos). DoD: `python_sdk_boundary` + `tsc` + `npm test` verdes + matriz 4 bindings pareja. | `vantadb-python/src/`, `vantadb-ts/src/`, `vantadb-node/src/`, `vantadb-wasm/src/` | 🔴 1-2sem | 🔴 | 🆕 Pendiente (P51 2026-09-24) |
| `API-03` | **W2 HTTP/OpenAPI-first: REST + paginación + YAML owner** — 🎯 OP: YAML pasa a owner + `openapi_yaml_parity` en CI; plurales sin verbos (`/maintenance/*`, `/conversation/add`, `/skill/listing`, `/threads/{id}/messages`); `/api/v2` total (gemelos conversation/skill/dashboard); cursor opaco + `has_more` en todos; status=YAML; `RecordInput` opcional; case/tipos únicos. OS: docs `HTTP_API.md` mismo-PR (Regla 3). Tipo: implementación breaking. Cobertura: síntesis 15 (REST, OpenAPI). Refs código: `src/server/router.rs`, `src/server/handlers.rs`, `docs/api/openapi.yaml`, `tests/api/openapi_yaml_parity.rs`. Dep: API-01 (tipos/error). DoD: parity verde + curl por grupo + tabla ruta-a-ruta. | `src/server/`, `docs/api/openapi.yaml`, `tests/api/` | 🔴 1sem | 🔴 | 🆕 Pendiente (P51 2026-09-24) |
| `API-04` | **W3 MCP: 1 nombre + schemas + errores ( + refresh local)** — 🎯 OP: 1 nombre canónico por tool (quitar alias `search_memory`, `collection_list` duplicado); JSON Schema estricto (Schemars); `invalid_params` temprano en `query_iql`; errores tipados siempre; separar prompts/resources/tools; `thread_id` u128-string. OS: refrescar MCP local (`vanta-mcp-local.ps1` + restart + re-listar + smoke) en el mismo PR. Tipo: implementación breaking. Cobertura: síntesis 15 (MCP). Refs código: `vantadb-mcp/src/handlers/tools.rs`, `validation.rs`, `error.rs`. Dep: API-03 (contrato). DoD: smoke `server --mcp` + lista tools sin duplicados. | `vantadb-mcp/src/`, `vanta-mcp-local.ps1`, `opencode.jsonc` | 🟡 3-5d | 🟠 | 🆕 Pendiente (P51 2026-09-24) |
| `API-05` | **W4 proxy: auth `/snapshot` + endpoints + config (SEGURIDAD)** — 🎯 OP: auth en `GET /snapshot` YA (expone sessions/cost); plurales sin verbos; `space_id` snake; upstream sin self-loop (default vacío + error claro); `ttl_secs=0` = desactivado; rate-limit en UN punto. OS: `feat!:` seguridad. Tipo: implementación breaking + fix seguridad. Cobertura: síntesis 15 (proxy). Refs código: `vanta-proxy/src/server.rs:744-840`, `vanta-proxy/src/config.rs`, `config.toml`. Dep: API-03 (auth/paginación). DoD: `/snapshot` con 401 sin credencial + tests proxy verdes. | `vanta-proxy/src/`, `vanta-proxy/config.toml` | 🟡 2-3d | 🔴 | 🆕 Pendiente (P51 2026-09-24) |
| `API-06` | **W5 IQL: `IQL_VERSION` + sintaxis + literales + AST** — 🎯 OP: `IQL_VERSION` con gate (`PROFILE` y futuro); 1 sintaxis documentada (FROM/MATCH/SELECT con defaults idénticos); case definido; fix `==`, int→float, quotes; exponer AST JSON plano a bindings. OS: actualizar `IQL.md` + ejemplo YAML mismo-PR. Tipo: implementación breaking. Cobertura: síntesis 15 (IQL). Refs código: `src/parser/grammar.rs`, `src/parser/lexer.rs`, `src/parser/mod.rs`, `src/sdk/api.rs:328-331`. Dep: API-01 (tipos). DoD: tests parser verdes + repros `==`/`42`/`from`/quotes. | `src/parser/`, `docs/api/IQL.md` | 🟡 3-5d | 🟠 | 🆕 Pendiente (P51 2026-09-24) |
| `API-07` | **W6 CLI: POSIX + `--json` global + flags** — 🎯 OP: flags simétricos (`--in/--out`, `limit` vs `top_k`); `--json` global con salida COMPLETA; humano truncado solo TTY; `count` exit≠0 sin DB; `cmd_put` vía SDK; lecturas RO (auditar lock order, Regla 8). OS: Clap ya en uso (S8). Tipo: implementación breaking. Cobertura: síntesis 15 (CLI). Refs código: `src/cli.rs`, `src/cli_handlers/`. Dep: API-06 (IQL estable para `query`). DoD: `--help` × comando + snapshot `--json` + `verify_changed`. | `src/cli.rs`, `src/cli_handlers/` | 🟡 2-3d | 🟡 | 🆕 Pendiente (P51 2026-09-24) |
| `API-08` | **W7 vanta-memory: API Rust estable (NO exponer, Gate P)** — 🎯 OP: estabilizar API Rust del crate (L0–L3 core-only); pagar D37 (dedup embeddings), D21 (`TokenEstimator`), MEM-16 (context↔worker) con benchmark (Regla 9); mantener P4 degradado con test. OS: NO crear bindings (DEFER D42 explícito). Tipo: estabilización. Cobertura: síntesis 15 (memory). Refs código: `vanta-memory/src/`, `docs/api/VANTA_MEMORY.md`. Dep: API-01 (tipos/error). DoD: `cargo test -p vanta-memory` + degradado sin `llm-driver` verificado. | `vanta-memory/src/` | 🟡 2-3d | 🟡 | 🆕 Pendiente (P51 2026-09-24) |
...
## Phase 52: 🔐 Verificabilidad — "memoria verificable y gobernable" (post-investigación 2026-09-24)

> Origen: investigación integral 2026-09-24 (`VantaDB-Informe-Analisis-Completo.md` + `VantaDB-Analisis-Arquitectura-Producto-Competencia.md` §9). Hueco competitivo exclusivo verificado contra 17 sistemas de memoria + 10 BDs multi-modelo: **ninguno** ofrece verificación criptográfica, borrado certificado, redacción persistida ni governance de inyección. Las piezas ya existen en el repo (WAL durable, shred, proxy con redacción, MCP, desktop) — estas filas las cablean. Plan: `docs/dev/plans/2026-09-24-post-investigacion-integral.md` §P52. Regla de marcas aplica.

| ID | Descripción | Archivos | Esfuerzo | Prio | Estado Real |
|----|-------------|----------|----------|------|-------------|
| `VER-01` | **Tamper-evident: hash-chain sobre operaciones de memoria + `vanta-cli verify`** — 🎯 OP: extender el WAL (CRC32C por registro) con encadenamiento incremental de hash sobre operaciones de memoria (add/update/invalidate/forget/supersede) firmadas por el motor + comando `vanta-cli verify` que detecte manipulación/extirpación con registro exacto. OS: evaluar coste de escritura (hash incremental, no re-hash de cadena); referencia técnica: Certificate Transparency / Trillian; decidir alcance WAL completo vs log dedicado de memoria. Tipo: implementación. Cobertura: hueco #1 §9; C5/AM10. Refs código: `src/wal*.rs`, `src/storage/engine/`, `src/cli_handlers/`. Dep: ninguna (paralelo; post-API-01 para tipos). DoD: test de manipulación (1 registro alterado → verify falla) + bench de coste ≤5% escritura + doc `docs/api/`. | `src/wal*.rs`, `src/cli_handlers/`, `docs/api/` | 🔴 3-5d | 🔴 | 🆕 Pendiente (P52 2026-09-24) |
| `VER-02` | **Borrado certificado (certified forgetting): cablear delete-path + attestation de purga** — 🎯 OP: cablear el delete-path shred→GC→WAL (hoy el shred no purga entradas huérfanas) y formalizar certificado de purga con timestamp (JSON firmado: qué salió de TODOS los índices/respaldos/WAL). OS: refs SISA/encuestas de unlearning (borrado de índices+WAL+respaldos con attestation — alcanzable; NO unlearning paramétrico); consumir MGR-09 (retención) cuando cierre. Tipo: implementación + spec. Cobertura: hueco #2 §9; C4/C6. Refs código: `src/shred/`, `src/sdk/api/memory.rs`, gc/offload. Dep: SCH-02; coordinar con WIRE-09. DoD: test purga E2E (índices+WAL) + certificado emitido por CLI/MCP + doc. | `src/shred/`, `src/sdk/api/memory.rs`, `vantadb-mcp/src/` | 🟡 2-3d | 🔴 | 🆕 Pendiente (P52 2026-09-24) |
| `VER-03` | **Redacción-on-write persistida + namespaces cifrados** — 🎯 OP: la versión redactada como fuente de verdad de memoria; el original solo en envelope cifrado por namespace (keys por usuario/proyecto); persistir la redacción que el proxy ya hace en vivo. OS: formato envelope (AEAD por namespace), rotación de claves, degradación explícita sin clave. Tipo: implementación. Cobertura: hueco #3 §9; AM10/D6. Refs código: `vanta-proxy/src/` (redact), core record/payload. Dep: WIRE-01, SCH-02. DoD: test PII no aparece en claro en store/índices + envelope descifrable solo con key + doc. | `vanta-proxy/src/`, `src/sdk/types/record.rs`, `docs/api/` | 🟡 2-3d | 🔴 | 🆕 Pendiente (P52 2026-09-24) |
| `VER-04` | **Governance de inyección (proxy): presupuesto de contexto + ACLs + audit log** — 🎯 OP: presupuesto de tokens por request para el bloque `<vanta-memory>` (protege prompt-cache del upstream), ACLs por tool/namespace, audit log de qué memoria se inyectó en qué prompt con qué score (WORM-ready). OS: reutilizar métricas del proxy; alinear con VER-01 (firma). Tipo: implementación. Cobertura: hueco #9 (solo VantaDB tiene proxy+memoria en el mismo paquete). Refs código: `vanta-proxy/src/server.rs:403` (`build_memory_block`), `inject`, `report`. Dep: WIRE-01. DoD: presupuesto respetado en test e2e + audit consultable + doc. | `vanta-proxy/src/` | 🟡 2-3d | 🟠 | 🆕 Pendiente (P52 2026-09-24) |
| `VER-05` | **Importadores Mem0/Zep/Letta→VantaDB + formato de intercambio documentado** — 🎯 OP: captura de usuarios de la competencia (estrategia Cognee COGX): import de export Mem0 (memories JSON), Zep/Graphiti (episodios+facts), Letta (archivos/bloques) preservando metadata y procedencia; documentar formato de intercambio VantaDB (JSONL + semántica temporal/dedup/conflicto). OS: fixtures por sistema; input = export del usuario (sin credenciales). Tipo: implementación + docs. Cobertura: A8 §8; COGX. Refs: cognee.ai/migrating-from-mem0. Dep: ninguna. DoD: 3 importadores con test + guía de migración publicada. | `vanta-memory/src/`, `src/sdk/`, `docs/` | 🟢 1-2d | 🟠 | 🆕 Pendiente (P52 2026-09-24) |
| `VER-06` | **Export file-native Markdown (git-friendly) + `rebuild_index`** — 🎯 OP: proyección de memoria a Markdown+frontmatter con wikilinks (ReMe/Claude-filesystem) reconstruible (`rebuild_index` ya existe) — transparencia y auditabilidad por editor/git. OS: round-trip fiel; el índice es regenerable (Markdown NO es fuente de verdad primaria); consume FUT-11. Tipo: implementación. Cobertura: A6; D3/AM7. Refs código: `src/sdk/serialization/impl_export.rs`, `vanta-memory/src/seed/md_import.rs`. Dep: ninguna. DoD: export→edit→rebuild→search recupera cambios + doc. | `src/sdk/serialization/`, `vanta-memory/src/seed/`, `docs/` | 🟢 1-2d | 🟡 | 🆕 Pendiente (P52 2026-09-24) |
| `VER-07` | **Dreams: dry-run + diff report + `promote_dream_run` real (ADD/UPDATE/DELETE/NOOP)** — 🎯 OP: paridad con Mem0 Dream/ChatGPT Dreaming/Claude Auto Dream: `dry_run:true` (patrón MIRIX) que muestre diff sin mutar, informe de merges/dedups/supersessions propuestos, y promover real a L1 con puerta de calidad (hoy `promote` es stub preview-only). OS: consumir MEM-69/70 y MGR-08; invariante L1 byte-identical preservado en dry-run. Tipo: implementación. Cobertura: A7; C4/D3. Refs código: `vanta-memory/src/core/dream/mod.rs`, `vantadb-mcp/src/handlers/dreams.rs`, `skills.rs`. Dep: ninguna (post-API-04 para nombres MCP). DoD: dry-run test byte-identical + promote E2E verificado + tools MCP + docs. | `vanta-memory/src/core/dream/`, `vantadb-mcp/src/handlers/dreams.rs` | 🟡 2-3d | 🔴 | 🆕 Pendiente (P52 2026-09-24) |
| `VER-08` | **Harness propio de benchmarks de memoria + CI (dataset commiteado)** — 🎯 OP: medir y publicar con protocolo propio: canonical_p99 + LoCoMo + LongMemEval-S + BEAM-subset (dataset commiteado, como la suite criterion) + reporte write-quality, abstención, tokens por retrieval y p99 en CI. OS: scores en pares accuracy+tokens; documentar modelo-juez/stack (lección Mem0 y auditoría LoCoMo 6.4%/63%); consumir MGR-19 (P49). Tipo: validación + CI. Cobertura: D3; EXE-02 prep; hueco #12. Refs: `benches/`, `benchmarks/`, `docs/user/operations/BENCHMARKS.md`; LongMemEval arXiv 2410.10813; BEAM ICLR 2026. Dep: ninguna (correr tras W3). DoD: reporte publicado con comandos de reproducción + gate p99 en CI. | `benches/`, `benchmarks/`, `docs/user/operations/BENCHMARKS.md` | 🟡 3-5d | 🔴 | 🆕 Pendiente (P52 2026-09-24) |
| `VER-09` | **Head-to-head vs Mem0/Zep/Letta con protocolo publicado (absorbe EXE-02)** — 🎯 OP: correr los 3 sistemas con el MISMO harness de VER-08 y publicar win/loss honesto por capacidad (extracción, multi-sesión, temporal, updates, abstención) + tokens y latencia. OS: no competir en tablas ajenas; publicar protocolo completo (modelo-juez, stack, reranking) — la auditoría LoCoMo se convierte en ventaja de credibilidad. Tipo: validación. Cobertura: EXE-02 (P50 conserva la fila madre) + hueco #12. Refs: mem0.ai/blog/ai-memory-benchmarks-in-2026; `benchmarks/`. Dep: VER-08. DoD: reporte en `BENCHMARKS.md` + post técnico con metodología. | `benchmarks/`, `docs/user/operations/BENCHMARKS.md` | 🔴 1-2sem | 🟠 | 🆕 Pendiente (P52 2026-09-24) |

---

## Phase 53: 🧬 Esquema v0.7.0 — migración única (IMPL-MGR, consume P49)

> Origen: decisión owner 2026-09-24 (D2 del plan post-investigación) — **migración única** de MGR-10 (bitemporalidad) + MGR-12 (confianza) + MGR-13 (cuarentena) en UN solo breaking change de schema, condicionada a que cada MGR cierre su research-doc (Cierre MGR = research-doc + preguntas owner + plan de implementación). Alcance 0.7.0: primitivas + superficies; derivación/grounding completo y automatización total quedan v1.0. Breaking ilimitado pre-lanzamiento (nadie usa los paquetes). Esta fase sustituye la fila "P51 IMPL-MGR" previa del Exec Summary.

| ID | Descripción | Archivos | Esfuerzo | Prio | Estado Real |
|----|-------------|----------|----------|------|-------------|
| `SCH-01` | **Plan único + ADR de migración (diseño conjunto dims 5-6)** — 🎯 OP: consolidar specs de MGR-10/12/13 en un plan de implementación único con ADR (`docs/dev/architecture/adr/`): campos, semántica valid vs transaction time, alcance 0.7.0 vs v1.0, plan de migración/backfill, compat de export/import. OS: exigir Cierre MGR de los 3 research-docs antes de tocar `record.rs` (pre-requisito duro). Tipo: análisis + ADR. Cobertura: A4; D5/D6/AM4/AM8. Refs: MGR-10/12/13 (P49), Snodgrass, Zep/Graphiti (arXiv 2501.13956). Dep: MGR-10/12/13 research-doc. DoD: ADR aceptado + plan de implementación con comandos. | `docs/dev/architecture/adr/`, `docs/dev/research/` | 🟡 2-3d | 🔴 | 🆕 Pendiente (P53 2026-09-24) |
| `SCH-02` | **Schema v2: campos + migración + backfill** — 🎯 OP: `valid_at_ms`/`invalid_at_ms` + `asserted/derived` + `confidence` + `last_validated` + estado `quarantined` en records; migración determinista v1→v2 + backfill (registros históricos: `valid_at=created_at`, `invalid_at=superseded_at` si existe). OS: `#[serde(default)]` + versión de schema explícita; export/import compat. Tipo: implementación breaking. Cobertura: M1 del plan. Refs código: `src/sdk/types/record.rs`. Dep: SCH-01. DoD: migración sobre DB v1 real + roundtrip export/import + tests deterministas. | `src/sdk/types/record.rs`, `src/sdk/serialization/` | 🔴 3-5d | 🔴 | 🆕 Pendiente (P53 2026-09-24) |
| `SCH-03` | **Queries `AS OF` / point-in-time + filtros `valid_at` + `exclude_superseded` extendido** — 🎯 OP: consultar "qué era verdad en T" (evidence-before-belief): operador `AS OF` en IQL + parámetros en search/list + filtros por ventana de validez; extender `exclude_superseded` a la semántica nueva. OS: LanceDB checkout / Graphiti como referencia de UX. Tipo: implementación. Cobertura: M2; AM4/D5. Refs código: `src/server/`, `src/sdk/search/`, `src/parser/`. Dep: SCH-02. DoD: test "el spec decía X en fecha del incidente" devuelve el estado histórico correcto. | `src/server/`, `src/sdk/search/`, `src/parser/` | 🟡 2-3d | 🔴 | 🆕 Pendiente (P53 2026-09-24) |
| `SCH-04` | **Scores asserted/derived consumibles (slice 0.7.0)** — 🎯 OP: exponer scores por registro, jerarquía asserted/derived y `last_validated` en SDK/HTTP/MCP + uso en ranking/UI (derivación completa + grounding con jueces queda v1.0). OS: calibración básica; documentar límites. Tipo: implementación. Cobertura: M1/MGR-12 slice; D6/AM1. Refs código: `src/sdk/types/record.rs`, `vantadb-mcp/src/axioms.rs`. Dep: SCH-02. DoD: scores visibles y consultables + doc + tests. | `src/sdk/`, `vantadb-mcp/src/` | 🟡 2-3d | 🟠 | 🆕 Pendiente (P53 2026-09-24) |
| `SCH-05` | **Cuarentena + abstención + trust-aware retrieval** — 🎯 OP: estado `quarantined` + gates de promoción, abstención selectiva (no responder con baja confianza) y retrieval que respeta clase de confianza. OS: threat model write-time (AgentPoison NeurIPS 2024 / MINJA arXiv 2503.03704); consumir MGR-04 (namespaces trusted/tainted) y MGR-13. Tipo: implementación + spec. Cobertura: M1/MGR-13 slice; AM10/D6. Refs: `src/server/middleware.rs`, `vanta-memory/src/core/dream/`. Dep: SCH-02. DoD: test de contención (contenido dudoso no se inyecta por defecto) + doc. | `src/sdk/`, `src/server/`, `vanta-memory/src/` | 🟡 2-3d | 🟠 | 🆕 Pendiente (P53 2026-09-24) |
| `SCH-06` | **Tests de migración/time-travel/roundtrip + chaos** — 🎯 OP: suite que pruebe migración determinista (misma DB → mismo resultado), time-travel (AS OF por fecha), roundtrip export/import con campos nuevos, y chaos (crash durante migración → recuperación). OS: failpoints existentes. Tipo: test. Cobertura: invariantes del slice. Dep: SCH-02..05. DoD: suite verde + cobertura de bordes (TTL+quarantine, supersede+invalid). | `tests/`, `src/sdk/` | 🟡 2-3d | 🔴 | 🆕 Pendiente (P53 2026-09-24) |
| `SCH-07` | **Superficies: bindings/server/MCP/IQL + docs/api mismo-PR** — 🎯 OP: exponer los campos nuevos en py/ts/node/wasm + HTTP + MCP + IQL; docs `docs/api/` sincronizadas mismo-PR (Regla 3). OS: coordinar con API-01..09 (mismo sistema de tipos). Tipo: implementación + docs. Cobertura: transversal. Dep: SCH-02..06. DoD: matriz de paridad de bindings verde + docs actualizadas. | bindings, `src/server/`, `vantadb-mcp/`, `docs/api/` | 🟡 2-3d | 🟠 | 🆕 Pendiente (P53 2026-09-24) |
| `SCH-08` | **Corte 0.7.0: migration guide + CHANGELOG + release notes** — 🎯 OP: guía de migración v1→v2 (campos, semántica, queries AS OF) + release notes + bump. OS: release-plz; todo funcional al final del release. Tipo: docs + release. Dep: SCH-01..07. DoD: guía publicada + tag 0.7.0 con la migración incluida. | `docs/`, `CHANGELOG.md` | 🟢 1d | 🔴 | 🆕 Pendiente (P53 2026-09-24) |
| `SCH-09` | **Edge: `properties` + validez temporal (`valid_at_ms`/`invalid_at_ms`) en el grafo** — 🎯 OP: `Edge` hoy tiene 5 campos (`target/label_id/weight/reverse/created_at_ms`, `src/node/edge.rs:9`) sin propiedades ni ventana de validez; añadir `properties: BTreeMap<String, FieldValue>` + `valid_at_ms`/`invalid_at_ms` opcionales (semántica grafo-bitemporal Zep/Graphiti; SurrealDB RELATE) + backfill (`valid_at=created_at_ms`) + filtros por ventana en las queries de SCH-03. OS: diseñar dentro de SCH-01 (misma migración v2, sin segundo breaking). Evidencia: verificado 2026-09-25 contra HEAD. Tipo: implementación breaking. Cobertura: §B3/§II.2 informes; dim 5; ámbitos 2/3. Refs código: `src/node/edge.rs`, `src/graph.rs`, `src/sdk/serialization/`. Dep: SCH-01. DoD: edges con properties/t_valid + roundtrip export/import + query por ventana + tests. | `src/node/edge.rs`, `src/graph.rs`, `src/sdk/serialization/` | 🟡 2-3d | 🟠 | 🆕 Pendiente (P53 2026-09-25) |

---

## Phase 54: 🎯 Tracks ICP (decisión owner 2026-09-24)

> Origen: decisión owner 2026-09-24 (D1) — desarrollar los 3 tracks ICP a profundidad (BIZ-08 resuelta). Cada track: one-pager comercial (consume BIZ-05), superficie mínima, demos CI (alimentan EXE-01) y métrica en la North Star. El núcleo (motor de memoria embebido gobernado) es único; los tracks son puertas de entrada, no productos separados.

| ID | Descripción | Archivos | Esfuerzo | Prio | Estado Real |
|----|-------------|----------|----------|------|-------------|
| `ICP-01` | **Track AI-IDEs vía MCP (Cursor/Claude Code/OpenCode)** — 🎯 OP: memoria de proyecto con 1 integración → N clientes: one-pager + repo-map/watcher (MGR-22) + viewer desktop + hooks robustos (sin `pwsh`) + demo CI (sesión 1 guarda, sesión 2 recupera por sinónimo) + entrada en `COMPARISON.md`. Métrica: **sesiones con put+search la misma semana (7d)** medible en proxy/MCP. OS: consumir FIND-106/120 y hooks del informe (C9). Tipo: producto + validación. Cobertura: D1; A3; GTM Vertical 3. Refs: `docs/dev/strategy/GO_TO_MARKET.md` §Vertical 3, `vantadb-mcp/`. Dep: MGR-22 (research), FIND-106/120, WIRE-01 (métrica). DoD: demo verde en CI + one-pager + métrica instrumentada. | `vantadb-mcp/`, `desktop/`, `docs/` | 🟡 1-2sem | 🔴 | 🆕 Pendiente (P54 2026-09-24) |
| `ICP-02` | **Track privacidad / devs local-LLM** — 🎯 OP: narrativa anti-cloud con garantías verificables: one-pager + redacción-on-write persistida (VER-03) + namespaces cifrados + forget certificado (VER-02) + auditoría PII (0 PII en claro en store/índices) + demo CI. Métrica: **0 PII en store en auditoría**. OS: consumes VER-02/03; narrativa "la memoria vive en tu proceso y es verificable". Tipo: producto + validación. Cobertura: D1; A3; GTM Vertical 1. Refs: `docs/dev/strategy/GO_TO_MARKET.md` §Vertical 1. Dep: VER-02/03. DoD: auditoría PII verde + one-pager + demo. | `vanta-proxy/`, `src/shred/`, `docs/` | 🟡 1-2sem | 🔴 | 🆕 Pendiente (P54 2026-09-24) |
| `ICP-03` | **Track frameworks (LangChain/LlamaIndex/CrewAI/DSPy/…)** — 🎯 OP: one-pager + publicar los 9 adapters en PyPI (MKT-18f) + importadores desde Mem0/Zep (VER-05) + demo CI (LangGraph dev→prod sin cambiar código) + métrica. Métrica: **installs/semana de adapters**. OS: `INTG-01/02` (P44) son la materia prima; verificar pins del gate. Tipo: distribución + validación. Cobertura: D1; A3; GTM Vertical 2. Refs: `integrations/`, `docs/dev/Backlog.md` P44. Dep: MKT-18f, VER-05. DoD: adapters publicados + demo + métrica. | `integrations/`, `docs/` | 🟡 1sem | 🟠 | 🆕 Pendiente (P54 2026-09-24) |

---

## Phase 55: 🧭 Frontera de producto (research 2026-09-24)

> Origen: `docs/dev/research/product-definition-gap-2026-09-24.md` — la definición oficial no gobierna lo que se construye (8 fallas verificadas: dos productos en la misma definición, frontera stale/no verificable, alcance desbordado, claims README, benchmarks auto-descalificados, zero-config frágil, churn de nombres, sin why-not-X ni north-star). Esta fase restaura un límite verificable por release, congela naming y define el north-star. Los fixes inmediatos de `EXPERIMENTAL_FEATURES.md` (4 claims falsos) ya se aplicaron 2026-09-24.

| ID | Descripción | Archivos | Esfuerzo | Prio | Estado Real |
|----|-------------|----------|----------|------|-------------|
| `DEF-01` | **Decisión única de producto + alineación SPEC/README/VISION** — 🎯 OP: jerarquía explícita: un núcleo (motor de memoria embebido gobernado, "SQLite para agentes") + 3 puertas de entrada (tracks ICP); resolver el conflicto README (RAG/edge) vs SPEC (memoria de agentes de código) en un solo contrato; documentar en SPEC §Adenda + README + VISION. Tipo: decisión + docs. Cobertura: hallazgo #1. Refs: `SPEC.md`, `README.md`, `docs/dev/vision/VISION.md`. Dep: ninguna. DoD: los 3 docs dicen lo mismo; cero targets en conflicto. | `SPEC.md`, `README.md`, `docs/dev/vision/VISION.md` | 🟢 1d | 🔴 | 🆕 Pendiente (P55 2026-09-24) |
| `DEF-02` | **Regeneración de `EXPERIMENTAL_FEATURES.md` a 0.7.0 + categorías labs** — 🎯 OP: cerrar la regeneración (fixes inmediatos de 4 claims falsos ya aplicados 2026-09-24): versionar a 0.7.0, verificar cada fila contra código, añadir categorías explícitas para proxy/desktop/web/memory (core-promise vs labs), y dejar el doc listo para el gate de DEF-03. Tipo: docs + verificación. Cobertura: hallazgo #2. Refs: `docs/user/operations/EXPERIMENTAL_FEATURES.md` (+ espejo book `{{#include}}`). Dep: DEF-07 (categorización). DoD: 0 claims no verificables; cada fila con evidencia. | `docs/user/operations/EXPERIMENTAL_FEATURES.md` | 🟡 2-3d | 🟠 | 🆕 Pendiente (P55 2026-09-24) |
| `DEF-03` | **Frontera verificable en CI (`validate-frontier`)** — 🎯 OP: extender `scripts/validate-docs-coverage.ps1` (o script nuevo) para validar la frontera contra features de Cargo y rutas reales (p.ej. cada fila "Production-facing" con su feature/ruta; "Deferred/Archived" no puede existir en código vivo sin marca). OS: correr en `gate-docs`/CI docs. Tipo: tooling + CI. Cobertura: hallazgo #2. Refs: `scripts/validate-docs-coverage.ps1`, `.github/workflows/gate-docs.yml`. Dep: DEF-02. DoD: gate verde y sensible (falla si una feature REAL no está listada). | `scripts/`, `.github/workflows/` | 🟡 2d | 🟠 | 🆕 Pendiente (P55 2026-09-24) |
| `DEF-04` | **Naming freeze 0.7.0→1.0 (ADR)** — 🎯 OP: congelar los 9 artefactos (vantadb, vantadb-py, vantadb-node, vantadb-ts, vantadb-server, vantadb-mcp, vanta-cli, vanta-proxy, vanta-memory) + política de alias/deprecación (alias con fecha de remoción, nunca breaking en minor post-1.0) + repo `ness-e/Vantadb` vs marca VantaDB. OS: coordinar con API-01..09 (último breaking pre-lanzamiento) y el dictamen de marca LEG-01. Tipo: ADR. Cobertura: hallazgo #7. Refs: `docs/dev/architecture/adr/`. Dep: ninguna. DoD: ADR aceptado + tabla de artefactos congelada. | `docs/dev/architecture/adr/` | 🟢 1d | 🔴 | 🆕 Pendiente (P55 2026-09-24) |
| `DEF-05` | **North-star + success criteria de producto (SPEC/VISION)** — 🎯 OP: North Star = **agentes activos que recuperan una memoria con éxito en ventana de 7 días** (medible en proxy: sesiones MCP con put+search la misma semana) + guardrails (0 hallazgos high sin parche ≤7d; 0 regresión p99 >15%; 100% artefactos con versión sincronizada) reemplazando success criteria de campaña. Tipo: decisión + docs. Cobertura: hallazgo #8. Refs: `SPEC.md` §Success Criteria. Dep: ninguna. DoD: criterios de producto en SPEC/VISION + fuente de medición definida. | `SPEC.md`, `docs/dev/vision/VISION.md` | 🟢 1d | 🔴 | 🆕 Pendiente (P55 2026-09-24) |
| `DEF-06` | **README↔BENCHMARKS reconciliados (claims)** — 🎯 OP: corregir claim "Fjall default o fallback a RocksDB" (no hay fallback: opt-in por feature; `VANTADB_BACKEND` solo reconoce rocksdb/memory) + regenerar §2 de BENCHMARKS (fósil pre-SIMD) + reconciliar README↔§1↔§8 con hardware normalizado + degradar claims de benchmark a "en progreso" hasta VER-09. Tipo: docs. Cobertura: hallazgos #4/#5. Refs: `README.md`, `docs/user/operations/BENCHMARKS.md`, `src/config.rs`. Dep: VER-08 (para §2). DoD: 0 claims no reproducibles en README/BENCHMARKS. | `README.md`, `docs/user/operations/BENCHMARKS.md` | 🟡 2d | 🔴 | 🆕 Pendiente (P55 2026-09-24) |
| `DEF-07` | **Presupuesto de alcance: core-promise vs labs** — 🎯 OP: categorizar proxy/desktop/web/memory (labs vs core-promise), decidir qué consume presupuesto de la promesa "1 comando, 0 config" y qué vive como superficie secundaria declarada; documentar la guía de inversión (qué se congela, qué se acelera). Tipo: decisión + docs. Cobertura: hallazgo #3. Refs: `docs/dev/strategy/GO_TO_MARKET.md`, `ROADMAP-v0.7.md`. Dep: ninguna. DoD: categorías en EXPERIMENTAL_FEATURES + decisión escrita. | `docs/` | 🟢 1d | 🟠 | 🆕 Pendiente (P55 2026-09-24) |
| `DEF-08` | **Install SLO + telemetría opt-in de éxito + fallback visible** — 🎯 OP: definir SLO de instalación (tiempo máximo al primer recall, tasa de éxito), telemetría opt-in de éxito/fallo (privacidad-first) y fallback visible cuando ORT/modelo no cargan (nunca abort silencioso — historial FIND-100/EMB-10..18). Tipo: decisión + instrumentación mínima. Cobertura: hallazgo #6. Refs: `SPEC.md` (riesgo admitido), `setup-embeddings.ps1`, `src/llm.rs`. Dep: ninguna. DoD: SLO escrito + evento de telemetría + path de fallback probado. | `SPEC.md`, `scripts/`, `src/llm.rs` | 🟢 1d | 🟠 | 🆕 Pendiente (P55 2026-09-24) |
...
| ID | Descripción | Archivos | Esfuerzo | Prio | Estado Real |
|----|-------------|----------|----------|------|-------------|
| `WIRE-01` | **Loop de memoria del proxy completo + cost real + presupuesto de inyección** — 🎯 OP: verificar end-to-end capture L0 (existe, D47/MEM-50) → L1 → search/injection (namespaces disjuntos pendientes); cablear `record_response_usage` (output tokens; hoy "wired by a future SSE drain") + FIND-88 (output-side cost SSE); presupuesto de tokens del bloque `<vanta-memory>` (`server.rs:403`). OS: decisión de producto (depurar el loop) — re-verificar informe A4/A5 contra HEAD. Tipo: implementación. Cobertura: A2/A4/A5; M3. Refs código: `vanta-proxy/src/server.rs:241-251,403`, `cost.rs:201`. Dep: ninguna. DoD: test e2e sesión 1 captura → sesión 2 recupera + costo output ≠ 0 + presupuesto respetado. | `vanta-proxy/src/` | 🟡 1-2d | 🔴 | 🆕 Pendiente (P56 2026-09-24) |
| `WIRE-02` | **MCP: enforce de perfil en `tools/call` + default `agent` (~45) + fusión 87→~65** — 🎯 OP: el perfil no se enforcea (una tool no listada sigue llamable; el error documentado en `MCP.md:254` no existe en código); default `full` ≈ 22-25K tokens de overhead; fusionar proyecciones redundantes (code_*, introspección triple) y absorber alias. OS: coordinar con API-04 (nombres canónicos). Tipo: implementación. Cobertura: A3 informe; M4. Refs código: `vantadb-mcp/src/handlers/tools.rs`, `config.rs`, `docs/api/MCP.md`. Dep: API-04. DoD: tool fuera de perfil → error real + default `agent` + smoke `tools/list` ≤45 + doc corregida. | `vantadb-mcp/src/`, `docs/api/MCP.md` | 🟡 2-3d | 🟠 | 🆕 Pendiente (P56 2026-09-24) |
| `WIRE-03` | **`query_sparse` + text-only + filtros avanzados en bindings** — 🎯 OP: `query_sparse` existe en core/HTTP pero no se expone en ningún binding (hardcodeado None) — exponer en py/node/wasm; text-only search (`query_vector: []` = solo-BM25) por la puerta principal; filtros intercambiables (`$and`/`$or`, range/datetime) py↔js. OS: `FilterOp` hoy AND-only plano. Tipo: implementación. Cobertura: A1/A5; M5. Refs código: bindings, `src/sdk/search/`. Dep: API-02. DoD: matriz de paridad 3 bindings con tests de sparse y text-only. | bindings, `src/sdk/search/` | 🟡 2-3d | 🔴 | 🆕 Pendiente (P56 2026-09-24) |
| `WIRE-04` | **TTL superficie completa: server HTTP + default por colección + sweeper al índice** — 🎯 OP: TTL real en SDK/MCP pero no en server HTTP; añadir param en API HTTP + default por colección + sweeper que purgue índices (no solo lazy en lectura). OS: consumir MGR-09 (retención) al cerrar; Qdrant/Weaviate/Milvus tampoco tienen default por colección — oportunidad. Tipo: implementación. Cobertura: A3; M8. Refs código: `vantadb-server/`, `src/sdk/types/record.rs`, sweeper. Dep: MGR-09 (research). DoD: TTL via HTTP + default + purga física verificada. | `vantadb-server/`, `src/sdk/` | 🟢 1-2d | 🟠 | 🆕 Pendiente (P56 2026-09-24) |
| `WIRE-05` | **Entity linking determinista + boost multi-señal en RRF** — 🎯 OP: paridad Mem0 sin LLM: matching multi-señal (Fellegi-Sunter + embeddings, LLM-juez solo sobre candidatos) + boost de entidades en la fusión RRF existente (determinista, ms, coste 0). OS: consumir MGR-05 (spec); cascada vector-first top-K; fusión reversible con proveniencia. Tipo: implementación. Cobertura: B5; M6; MGR-05. Refs código: `src/entity/`, `src/sdk/search/fusion.rs`. Dep: MGR-05. DoD: fusión determinista con test + boost medido en harness (VER-08). | `src/entity/`, `src/sdk/search/fusion.rs` | 🟡 3-4d | 🔴 | 🆕 Pendiente (P56 2026-09-24) |
| `WIRE-06` | **Batching productizado (9.1× prototipado)** — 🎯 OP: productizar el prototipo de batch insert (1,016 ops/s vs 74 rec/s; techo = `insert_lock` FairMutex global + HNSW serial; fsync solo 1.5%) con segmentos appendables + compactación background (patrón LanceDB). OS: consumir `FUT-12-spec` (Backlog P24) y ADR-038; benchmark anti-regresión. Tipo: implementación de performance. Cobertura: A5 informe; M12. Refs código: `src/storage/engine/insert.rs`, `src/wal.rs`. Dep: FUT-12-spec. DoD: ≥5× ingesta sostenida + p99 sin regresión >15% + bench nightly. | `src/storage/`, `benches/` | 🔴 1sem | 🔴 | 🆕 Pendiente (P56 2026-09-24) |
| `WIRE-07` | **Refactors: `ffi-core` compartido + trait-split storage↔index + desacoplar `server→cli`** — 🎯 OP: crate `vantadb-ffi-core` (OpGate + guards MAX_* + mapeo de errores, hoy triplicado node/python/wasm); ejecutar trait-split `storage↔index` firmado en BOUNDARIES §3; quitar `server→cli` del feature-coupling (`Cargo.toml:179-187`). OS: ADRs existentes mandan; un commit por refactor. Tipo: refactor. Cobertura: M13; deudas 2.7-2.8. Refs: `docs/dev/architecture/BOUNDARIES.md`, bindings, `Cargo.toml`. Dep: ninguna. DoD: triplicación eliminada + grafo de crates sin ciclo + `cargo check` por-crate verde. | bindings, `src/index_port.rs`, `Cargo.toml` | 🔴 1-2sem | 🟠 | 🆕 Pendiente (P56 2026-09-24) |
| `WIRE-08` | **Range/group_by + cursor en search + RRF en CBO + rewriting + MMR** — 🎯 OP: paridad Milvus/Qdrant: radius/range_filter + group_by; cursor con resume en search (extender el de list); fusión RRF como operador del planner (hoy solo SDK) + query rewriting + diversidad MMR (`fetch_k` 5-10×). OS: consumir MGR-16. Tipo: implementación. Cobertura: B8/B10; M14. Refs código: `src/sdk/search/`, `src/planner.rs:181`, `search_profile.rs`. Dep: API-06, MGR-16. DoD: tests de cada capacidad + doc. | `src/sdk/search/`, `src/planner.rs` | 🟡 3-5d | 🟠 | 🆕 Pendiente (P56 2026-09-24) |
| `WIRE-09` | **Seguridad P0: sandbox de paths export/import/snapshots + refuse-to-start proxy** — 🎯 OP: `POST /api/v2/export`/`import` aceptan `path: String` arbitrario (escritura/lectura arbitraria de archivos) y snapshots permiten traversal (paridad con el guard del MCP); proxy `/snapshot` auth → API-05, pero falta refuse-to-start si bind no-loopback sin key (copiar FIND-07 del server). OS: re-verificar contra HEAD (informes v0.6.1; puede haber fixes parciales) — validar con test de escape. Tipo: implementación de seguridad. Cobertura: A2; C1-C4. Refs código: `src/server/handlers.rs:676-741,1514-1529`, `vanta-proxy/src/config.rs`. Dep: ninguna. DoD: test de path traversal falla (sandbox) + refuse-to-start con test. | `src/server/handlers.rs`, `vanta-proxy/src/` | 🟡 2-3d | 🔴 | 🆕 Pendiente (P56 2026-09-24) |
| `WIRE-10` | **Distribución P0: `install.sh` macOS, Colab a `Client`, hooks sin `pwsh`** — 🎯 OP: `install.sh:119` usa `sha256sum` (inexistente en macOS) → `command -v sha256sum \|\| shasum -a 256`; Colab usa API removida (`VantaDB(`/`search_memory`/`get_memory`) → migrar a `Client`/`search`; hooks de skills dependen de `pwsh` y del protocolo JSON-RPC equivocado (inyectan nothing en silencio) → bridge sin `pwsh` con binario one-shot (`vanta-cli mcp-call`). OS: re-verificar contra HEAD ([EST-10](../../docs/dev/plans/2026-09-24-estabilizacion-pendiente.md) ya barre parte). Tipo: fix + distribución. Cobertura: A2; C5/C9/C12. Refs código: `scripts/install.sh`, `examples/colab/`, `skills/vantadb-mcp/assets/hooks/`. Dep: ninguna. DoD: install macOS verde en CI/docs + notebook ejecuta + hooks inyectan contexto real sin `pwsh`. | `scripts/install.sh`, `examples/colab/`, `skills/` | 🟡 2-3d | 🔴 | 🆕 Pendiente (P56 2026-09-24) |
| `WIRE-11` | **`llm-driver` en consumidores shipped: cablear o degradar explícito (MCP/proxy)** — 🎯 OP: ningún consumidor habilita la feature: `vantadb-mcp` depende de `vanta-memory` (`Cargo.toml:14`) con features solo `embed-local`/`remote-inference` y `vanta-proxy` usa `default-features = false` (`Cargo.toml:30`) → `StandaloneLlmRunner` = `NotConfigured` y `VANTADB_INGEST_PROVIDER=ollama\|openai` queda decorativa en silencio. Fix: habilitar `llm-driver` (1 línea por consumidor) o emitir error/warn explícito cuando la feature no está compilada. OS: re-verificar contra HEAD (la degradación P4 es decisión documentada — el defecto es el no-op silencioso). Evidencia: verificado 2026-09-25. Tipo: fix. Cobertura: C11 informe; A13. Refs código: `vantadb-mcp/Cargo.toml:14,23-25`, `vanta-proxy/Cargo.toml:30`, `vanta-memory/src/llm_runner.rs`. Dep: ninguna. DoD: `ollama\|openai` funciona o falla con mensaje claro + test. | `vantadb-mcp/Cargo.toml`, `vanta-proxy/Cargo.toml`, `vanta-memory/` | 🟢 0.5d | 🟠 | 🆕 Pendiente (P56 2026-09-25) |

---

## Phase 57: 🧹 Estabilización residual (EST/C → catálogo, 2026-09-24)

> Origen: pendientes de `docs/dev/plans/2026-09-24-estabilizacion-pendiente.md` (EST) y `docs/dev/plans/2026-09-20-estabilizacion-total.md` (C) que vivían solo como execution-state. Se catalogan aquí para que `/pipeline task <ID>` los encuentre siempre (MODO TAREA busca plan más reciente → Backlog). El contrato/acciones de cada fila vive en el plan origen citado — no duplicar. Ejecutar en W0 (pre-0.7.0) salvo nota.
...
## Phase 58: 🧹 Higiene post-auditoría externa (2026-09-25)

> Origen: verificación 2026-09-25 de los 3 informes externos contra HEAD — solo hallazgos verificados que no estaban catalogados (el resto ya vive en P49–P57, API-05, WIRE-09/10, DEF-06 y FIND-98; sin filas duplicadas). Cada fila cita evidencia file:line y se re-verifica al ejecutar.

| ID | Descripción | Archivos | Esfuerzo | Prio | Estado Real |
|----|-------------|----------|----------|------|-------------|
| `HIG-01` | **CHANGELOG deduplicado (2× `# Changelog` / `[Unreleased]`) + release-plz verificado** — 🎯 OP: `docs/CHANGELOG.md` contiene dos documentos concatenados (`# Changelog` en L1 y L1847; `## [Unreleased]` en L8 y L1854) — residuo git-cliff/release-plz. Deduplicar preservando el historial (0.5.0/0.6.1) y verificar que el próximo Release PR no lo reintroduzca (`release-plz.toml` → `docs/CHANGELOG.md`). Evidencia: verificado 2026-09-25. Tipo: docs. Dep: ninguna (coordinar con AST-011). DoD: 1× H1 + 1× Unreleased + historial íntegro. | `docs/CHANGELOG.md`, `release-plz.toml` | 🟢 0.5d | 🟡 | 🆕 Pendiente (P58 2026-09-25) |
