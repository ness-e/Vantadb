...
> **Total open items:** 122 abiertas de 152 filas (+38 filas P52–P56 post-investigación integral 2026-09-24) (medido 2026-09-24; delta desde 2026-09-16: +26 FIND-63..88 ingeridos, −cerradas a `docs/dev/avance/` vía progreso) (previo 2026-09-16: 70 abiertas de 73 filas)
---
...
| **P57** 🧹 Estabilización residual (EST/C → catálogo, 2026-09-24) | 5 (EST-09/12 + C-07/08/10; EST-03/05/10 ✅ 2026-09-24) | ~1-2 semanas | 🟠 Media (pre-requisito de anuncio) |
...
| `FIND-153` | Media | **perf-bench regression gate INERTE**: `benchmarks/python_baseline.json` vacío (`"benchmarks": {}`, `updated: 2026-08-12`) → el step "Compare vs baseline" sale con warning y `exit 0` (`perf-bench.yml:126-130`); un run verde NO cubre regresiones. Activar: `workflow_dispatch` con `update_baseline=true` + commitear el artifact. Fold-in: metadata stale `workflow: perf-bench-40.yml` (archivo inexistente) + paths no-gate (`update_markdown.py \|\| echo ::warning`, `if-no-files-found: warn`). Origen: review P2-01 EST-05 2026-09-24 | `benchmarks/python_baseline.json`, `.github/workflows/perf-bench.yml` | 🟢 | 🟡 Media | ⬜ Pendiente |
