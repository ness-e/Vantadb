...
| `FIND-143` | Media | `docs/workflow/` (vanta-docs): inventario 28 + matriz triggers + flujo publish por registro + runbook + FAQ. Origen: auditoria workflows 2026-09-21 | `docs/workflow/` (nuevo) | ?? | ?? Media | ? Pendiente |
| `FIND-144` | Media | `docs/workflow/RULES.md` + refresh `CI_POLICY.md` (26 -> 28) + 1 fila puntero en `AGENTS.md` raiz (NO duplicar; `.opencode` es local-only). Tras FIND-143. Origen: auditoria workflows 2026-09-21 | `docs/workflow/RULES.md`, `docs/user/operations/CI_POLICY.md`, `AGENTS.md` | ?? | ?? Media | ? Pendiente |
