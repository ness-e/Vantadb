...
> **Fuente:** `docs/dev/Backlog.md:437` (P17 TSYS-06) y `docs/dev/Backlog.md:453` (P18 TIR-07 — misma brecha) · `docs/dev/architecture/task-system-chaos-resilience.md` (diseño T19) · `REPORTE-FINAL.md:361` (§3.3-24)
...
- `Test-Path docs/dev/research/TSYS-06-chaos-runner.md` → **True** (este doc).
- `rg "Veredicto|IMPLEMENTAR|DEFERIR|state-tools\.mjs:|chaos-resilience\.md:" docs/dev/research/TSYS-06-chaos-runner.md` → veredicto explícito + citas archivo:línea presentes.
...
> **Ejecutor:** vanta-arch · **Task:** `.opencode/skills/campaign-executor/tasks/TSYS-06-F1.md` · **Plan:** `docs/dev/plans/2026-08-16-wave-followups.md` (W2)
