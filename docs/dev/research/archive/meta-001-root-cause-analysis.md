...
- **Causa Raíz:** Los sub-agentes completaban el código y pasaban los tests, pero **no tenían el mandato ni el hook automatizado** para ir a editar `docs/dev/Backlog.md`. 
...
- **Causa Raíz:** Culturas de "decisión en chat" o comentarios de GitHub que no persisten en la documentación del repositorio (`docs/dev/architecture/adr/`).
...
**Acción:** Ningún PR generado por agente debe aprobarse si no incluye la modificación de estado en el `docs/dev/Backlog.md`.
