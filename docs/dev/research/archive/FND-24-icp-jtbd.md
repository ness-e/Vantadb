...
|---|---|---|
| GitHub stars | ⭐ 2 | `docs/dev/research/investigacion-equipo-2026-08-09.md:119` |
...
| H6 | Onboarding <15 min es decisivo | Analytics de docs: % que completa quickstart, % que activa hybrid search, % que abandona en install | `docs/dev/research/VantaDB-28-07-2026.md:474-475` (métricas propuestas) | lead |
