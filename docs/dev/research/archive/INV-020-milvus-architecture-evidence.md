...
- Nota: VantaDB ya documenta MMap HNSW + SQ8 para 1M–10M en `docs/user/operations/PERFORMANCE_TUNING.md`; este insight valida el approach y añade la alternativa tiered (S3 + LRU) como siguiente nivel.
