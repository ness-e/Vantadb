...
Fuentes canónicas internas: `docs/dev/Backlog.md`, `docs/dev/reviews/errors-found.md`, `docs/CHANGELOG.md`, código en `src/`.
...
- `docs/dev/Backlog.md` — estado de backlog, P0-P15, prioridades.
- `docs/dev/reviews/errors-found.md` — catálogo ERR (ERR-010, ERR-016, ERR-021, ERR-022, ERR-035/036, ERR-050…).
