...
> Origin of DEC-01: `docs/dev/research/COGNEE_EVALUATION.md` §8 (ADR sketches) + §9 (5 open questions)
...
- `docs/dev/research/COGNEE_EVALUATION.md` §8-9, App. A (in-repo source)
