...
`docs/dev/research/ACID_TRANSACTIONS.md` as a "14-page analysis with 3 evaluated
...
```
git show 8b1c52cd^:docs/dev/research/ACID_TRANSACTIONS.md
```

(created/touched by `0b3b8353` "feat: fase 4 completada", deleted by
`8b1c52cd`). Recommendation: restore it to `docs/dev/research/ACID_TRANSACTIONS.md`
...
`docs/dev/research/MVCC_SNAPSHOT_ISOLATION.md`). What the original doc deferred —
...
Reference: recovered `docs/dev/research/ACID_TRANSACTIONS.md` (restore pending).
...
| ACID_TRANSACTIONS.md (recovered) | `git show 8b1c52cd^:docs/dev/research/ACID_TRANSACTIONS.md` | research source |
