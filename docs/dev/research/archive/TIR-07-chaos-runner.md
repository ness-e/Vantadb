...
> **Fuente:** backlog P18 (re-verificado 2026-08-12) · **Contrato:** `docs/dev/Backlog.md` P18
...
El diseño T19 (`docs/dev/architecture/task-system-chaos-resilience.md`, 2026-08-11) declara en §6 tres behavior changes "no implementados" como pre-condición de la suite. **Verificación del código actual (2026-08-17) — los tres YA están implementados:**
...
- `docs/dev/architecture/task-system-chaos-resilience.md` (T19 — diseño, escenarios C1-C12, §5 estrategia, §6 pre-condiciones)
- `docs/dev/research/2026-08-10-agent-engineering/gap-01-agents.md` — fila 36 / FALTA #24 (chaos/resilience del pipeline, P3) y §6.1-8 fallas reales
