...
**Fecha:** 2026-08-16
**Prioridad:** 🟡 (P20a)
**Fuente:** docs/dev/Backlog.md:483
...
**Alcance:** `src/index/` (lectura), `src/storage/` (solo lectura DISCOVERY), `src/metrics/` (solo lectura), `benches/` (bench NUEVO), `.opencode/rules/` (regla NUEVA), `docs/dev/research/`
**Archivos tocados:** `benches/memory_budget.rs` (nuevo), `Cargo.toml` (entrada `[[bench]]`, ver §7), `.opencode/rules/memory-budget.md` (nuevo), `.opencode/rules/README.md` (índice), `docs/dev/research/FND-01-memory-budget.md` (este reporte), `src/storage/engine/stats.rs` (F1), `src/metrics/core/mod.rs` (F1), tests (F1)
