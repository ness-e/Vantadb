...
| `experimental-governance` eliminado; design doc preservado | ✅ Confirmado | `docs/dev/architecture/EXPERIMENTAL_GOVERNANCE_DESIGN.md` existe |
...
| Tutorial usa `import vantadb` roto (ALT-10) | 🕐 Corregido tras auditoría | `docs/user/tutorials/01-ai-agent-memory.md:33,177` ahora usa `from vantadb_py import VantaDB`; README documenta dual-import `vantadb`/`vantadb_py` (README.md:67,97) |
...
| "10 ADRs públicos" | ⚠️ Parcialmente cierto | Había **12** ADRs en `docs/dev/architecture/adr/` al commit auditado; hoy 37 |
