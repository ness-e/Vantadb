...
| `docs/user/QUICKSTART.md` | ✓ | Excelente: venv por OS, 3 rutas de instalación, ejemplo Python verificado contra API, embeddings opcionales (Ollama/OpenAI), TS SDK, CLI audit, TTFT medido (Python ~6s, TS ~2s), límites de IDs u128 documentados |
