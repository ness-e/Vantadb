...
2. Cada agente **lee el código real** (Read/Grep/Glob sobre el path de TDAM), cita `archivo:línea`, extrae lógica/algoritmos/flujos, y **escribe su archivo de investigación** en `docs/dev/research/tdam/`.
...
## RESULTADO
- Estado: ✅ COMPLETO
- Archivo: docs/dev/research/tdam/XX-*.md
...
- 9 archivos de investigación (`docs/dev/research/tdam/01..09-*.md`) — 01–08 por sub-agentes + 09 de cobertura deploy/uso
