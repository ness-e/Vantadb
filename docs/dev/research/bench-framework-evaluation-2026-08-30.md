...
- Plan: `docs/dev/plans/2026-08-30-testing-bench-harden.md` (TBH-16)
- Task file: `.opencode/skills/campaign-executor/tasks/TBH-16.md`
- Sister decision: `docs/dev/research/concurrency-testing-2026-08-30.md` (TBH-17, loom eval — same
