...
- [TypeScript SDK](api/TS_SDK.md)
- [HTTP API](api/HTTP_API.md)
- [IQL — Interactive Query Language](api/IQL.md)
- [MCP Protocol](api/MCP.md)
- [Embedded SDK (Rust)](api/EMBEDDED_SDK.md)

# Architecture
- [Overview](architecture/ARCHITECTURE.md)
- [Text Index Design](architecture/TEXT_INDEX_DESIGN.md)
- [Storage Versioning](architecture/STORAGE_VERSIONING.md)
- [Advanced Tokenizer](architecture/ADVANCED_TOKENIZER.md)
- [Mutation Recovery Protocol](architecture/MUTATION_RECOVERY_PROTOCOL.md)
- [Experimental Governance Design](architecture/EXPERIMENTAL_GOVERNANCE_DESIGN.md)
- [Architecture Decision Records](architecture/adr/index.md)

# Operations
- [Configuration](operations/CONFIGURATION.md)
- [Deployment Guide](operations/DEPLOYMENT_GUIDE.md)
- [CI/CD Policy](operations/CI_POLICY.md)
...
- [Disaster Recovery Runbook](operations/DISASTER_RECOVERY_RUNBOOK.md)
- [Monitoring & Grafana](operations/GRAFANA_SETUP.md)
- [Durability Guarantees](operations/DURABILITY_GUARANTEES.md)
- [Reliability Gate](operations/RELIABILITY_GATE.md)
- [Experimental Features](operations/EXPERIMENTAL_FEATURES.md)
- [Editor Integrations](operations/EDITOR_INTEGRATIONS.md)
- [Memory & Telemetry](operations/MEMORY_TELEMETRY.md)
- [SQLite Migration Guide](operations/SQLITE_MIGRATION_GUIDE.md)
