...
> Plan: `docs/plans/2026-09-22-vulnerabilities.md` (Wave B) · Rama: `fix/vuln-ts-060` desde `develop`
...
`docs/` salvo task file, plan file (edición), `docs/Backlog.md`, secretos, WIP ajeno, publicar.
