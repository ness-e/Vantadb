...
> **Plan:** `docs/plans/2026-09-18-cierre-mvp.md` (Task 9, Wave2 última — ÚLTIMA del plan)
...
> **Commit:** `docs: SHOW-05 — ...` (selectivo: README.md + docs/QUICKSTART.md + este file). NO PUSH.
...
- `docs/QUICKSTART.md:51-53` — blockquote `Note` del §0; se añade 1 línea TS
...
stash@{0} GOV-C4 · `docs/Backlog.md` (lo cierra el orquestador con progreso) ·
...
- **Archivos leídos completos:** `examples/README.md` (50L entero),
  `README.md:40-99` + `:180-209`, `docs/QUICKSTART.md:1-60`,
  ...
  `docs/tasks/FIND-74.md` (vía grep, evidencia histórica).
...
2. **Costo:** referenciar = 2 líneas añadidas, 0 rotos. Mover = mudanza de
   ...
   `docs/tasks/FIND-74.md` (evidencia histórica), snapshots de avance y book
...
- Grep referencias: `rg -n "vantadb-ts" README.md docs/QUICKSTART.md SKILLS-MANIFEST.md`
...
- WIP ajeno en `git status` (submodule `.opencode`/`skills`, `completions/*`,
  `reparacion.bat`, `docs/Backlog.md`, plan file untracked): INTOCABLE —
