...
## Metadata
- **Plan file:** docs/plans/2026-09-10-fixes.md
- **Creado:** 2026-09-10
...
Ninguno. Warnings `ExperimentalWarning: Importing WebAssembly module instances` (Node experimental, informativo, no falla tests). WIP ajeno intacto (`M opencode.jsonc`, `M .opencode`, `M docs/Backlog.md`, `?? Investigacion-plan.md` — no tocados ni stageados).
