...
> **Plan:** `docs/plans/2026-09-19-publicacion.md` (Wave1, primera en secuencia) · **Ruta:** vanta-worker
...
- MGR-25 (`docs/Backlog.md:817` — alcance ingestores; esta fila = demo, MGR-25 = diseño)

**Prohibidos (WIP ajeno que NO se toca):** implementar ingestores nuevos en el core (MGR-25) · credenciales/LLM externo (100% local obligatorio) · `reparacion.bat` · `.opencode` · `Justfile` · `ocr-*` · `completions/*` · `desktop/src-tauri/Cargo.lock` · stash@{0} GOV-C4 · `docs/Backlog.md` · plan file (solo recitation al cierre) · `C:/Users/Eros/.vantadb*` (datos vivos) · `src/` Rust core (cero cambios) · `web/` (SHOW-02 cerrado).
...
- **Archivos leídos completos:** `src/wiki/sources.rs` (vía codegraph verbatim :15-121) · `examples/agent_memory_cli/agent_memory_demo.py` · `.../README.md` · `.../test_agent_memory_cli.py` · `examples/python/haystack_documentstore.py` · `examples/README.md` · `docs/Backlog.md` filas SHOW-03/MGR-25 · plan file Wave1 · rules `server-mcp.md` + `python-bindings.md` · `definition-of-done.md`.
