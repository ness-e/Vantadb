...
> **Plan:** `docs/plans/2026-09-21-workflows-repair.md` (Wave 1, paralelo disjunto con FIND-137/138)
> **Estado:** ✅ COMPLETED
...
Resto workflows (FIND-137/138 en paralelo), `src/`, `web/`, `desktop/`, `reparacion.bat`, `.opencode`, `completions/*`, `*.lock`, stash GOV-C4, `docs/Backlog.md`, plan file (solo recitation vía `campaign_update_task_state`), `C:/Users/Eros/.vantadb*`, secretos.
