...
**Relacionados:**
- `docs/tasks/EMB-10.md` (evidencia build: ORT_API_VERSION=27, `ORT_DYLIB_PATH` soportado por ort `lib.rs:224`, ORT 1.30.0 en `Temp/opencode/ort130` efímero, FIND-100 abort ort).
...
- Archivos leídos completos: `embeddings/download.py`, `embeddings/verify.py`, `embeddings/manifest.json`, `embeddings/README.md`, `docs/tasks/EMB-10.md`, plan EMB-11 (§Wave1), `src/config.rs:925-959`, clean-code Apéndice V, definition-of-done, Notion ×4.
