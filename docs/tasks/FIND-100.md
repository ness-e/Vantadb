...
> **Plan:** `docs/plans/2026-09-17-mvp-memoria-agentes.md` (Wave0, sin dependencias)
...
- **Contexto:** SPEC.md raíz (8/8 decisiones, 0 abiertas); `docs/tasks/EMB-10.md:148-171`
...
**Evidencia previa:** `docs/tasks/EMB-10.md:148-171` — crash ort 1.x era:
