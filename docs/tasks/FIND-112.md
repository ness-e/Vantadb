...
- **Plan file:** `docs/plans/2026-09-17-seguimiento-mvp.md` (Task 4, Wave1 primera en secuencia)
...
**Contrato (plan):** `docs/tasks/FIND-112.md` spec con 5 puntos ((a) trait del
...
`docs/Backlog.md` (decisiones ya registradas por el lead), plan file (solo
...
- `docs/tasks/FIND-112.md` (este file — el entregable ES la spec).
