...
> **Plan:** `docs/plans/2026-09-19-publicacion.md` · **Wave:** Wave2 primera en secuencia · **Ruta:** vanta-lead
...
- `docs/operations/CI_POLICY.md:424-431` (§9 workflow wheels: build+smoke, TestPyPI manual, PyPI diferido)
...
- **Refs:** `.opencode/references/definition-of-done.md` (DoD standing + DoD VantaDB comandos + shippable trunk-based), `docs/operations/CI_POLICY.md` §9, `dev-tools.md` (vía AGENTS).
...
- WIP ajeno en `git status` (`.opencode`, `completions/*`, `docs/Backlog.md`, plan file, `skills/*`, `reparacion.bat` untracked) → staging SELECTIVO: solo `docs/tasks/PROV-12.md` (+ workflow si hay fix mínimo, no esperado).
