...
## Metadata
- **Plan file:** docs/plans/2026-09-15-find-correcciones.md
- **Fuente:** plan file Task 9 (Wave2) + docs/Backlog.md FIND-70
- **Esfuerzo:** 🟢 2h
- **Prioridad:** 🟡
...
- **Archivos leídos (completos):** `.github/workflows/heavy-bench-nightly-51.yml` (327 líneas, completo), `Cargo.toml:105-135` (features) + `:221-240` (benches incl. `ingestion_concurrent` + `required-features`), `docs/operations/BENCHMARKS.md:413-579` (§13 + post-FIND-57 + FIND-61), `.opencode/rules/release-ci.md` (completo), `docs/operations/CI_POLICY.md:419-422` (§8 nightly)
...
- **Archivos:** `.github/workflows/heavy-bench-nightly-51.yml`, `docs/operations/BENCHMARKS.md`
