...
> **Plan:** `docs/plans/2026-09-17-mvp-memoria-agentes.md` (Wave2, con FIND-104 ✅ `a1bea54b` en paralelo)
...
`completions/*`, `desktop/src-tauri/Cargo.lock`, `stash@{0}` GOV-C4, `docs/Backlog.md`, plan file (solo append
...
- **Wave2 paralelo:** FIND-104 ✅ `a1bea54b` — split respetado por directorio: él scripts + `assets/install/`,
  ...
  (`M .opencode`, `M completions/*`, `M docs/Backlog.md`, `M plan`, `?? reparacion.bat`) intocable.
...
- Patrón in-repo citado por la política: `docs/research/archive/COGNEE_EVALUATION.md:390` (`additionalContext`
  en SessionStart) + `docs/tasks/complete/ECO-001.md:10-17` (OpenCode `session.created` vía JS plugin).
