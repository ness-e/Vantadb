...
> **Plan:** `docs/plans/2026-09-07-followup-bench-a11y.md` (Task 2, Wave0)
> **Estado:** ⏳ IN PROGRESS
...
Nueva § BENCHMARKS (`docs/operations/BENCHMARKS.md`) con tabla insert/search p50/p99 + tamaño
...
- **Leídos completos:** `vantadb-node/bench/bench-abi.mjs` (241L), `vantadb-ts/bench/bench.mjs` (132L), `docs/operations/BENCHMARKS.md` (§10 L263-340, §15 L739-804)
