...
> **Plan:** `docs/plans/2026-09-10-fixes.md` (Task 3) · **Campaign:** 1b2c3d4e-5f6a-7b8c-9d0e-1f2a3b4c5d01
...
- Commit: `feat: FIND-20 — persistencia estado ventana desktop` (solo `docs/tasks/FIND-20.md` + `desktop/src-tauri/src/window_state.rs` + `desktop/src-tauri/src/lib.rs` + sync plan)
