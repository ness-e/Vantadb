...
> **Plan:** `docs/plans/2026-09-15-find-correcciones.md` (Task 3, Wave0 — disjunto de FIND-90/91: workflow vs Rust)
...
> `docs/operations/CI_POLICY.md` (contexto two-tier Fast Gate; paths citados en `:157,438`). Sin símbolos → sin Spec.
...
- **Archivos leídos completos:** `.github/workflows/ci-rust-10.yml` (608L — triggers `:3-36`, resto jobs solo contexto),
  `.github/workflows/ci-rustdoc.yml:16-35` (gap gemelo), `docs/Backlog.md:204-207` (fila FIND-64 = scope CI),
...
| 4 | Hallazgo gap gemelo (`ci-rustdoc.yml:24,33`) → fila `FIND-92` en Backlog (no scope-creep) | ✅ DONE — fila añadida tras FIND-91 (findings.md: ticket en el momento, no solo anotado) | `rg FIND-92 docs/Backlog.md` |
...
> Plan origen: `docs/plans/2026-09-07-backlog-triage.md` (Task 1, Wave0). Scope: fix `put_batch` legacy roto en
