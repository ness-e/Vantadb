...
> **Plan:** docs/plans/2026-09-21-workflows-repair.md (Wave 3, tras Waves 0-2 verdes)
...
- 0 refs rotas (grep) en alcance: `.github/workflows/ + README.md + README_ES.md + docs/workflow/ + docs/operations/CI_POLICY.md`.
