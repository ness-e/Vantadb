...
## Metadata
- **Plan file:** docs/plans/2026-09-18-cierre-mvp.md (Wave1, Task 5)
...
- **Relacionados (solo lectura):**
  ...
  - `docs/tasks/FIND-114.md` (precedente Gate C + mapeo 6 filas + smoke `PYTHONUTF8=1`)
...
| `contract` | verificacion: task file creado; evidencia: claim mapeo 1:1 / evidencia lib.rs:1018+1241-1255+1563+1577, types.rs:132-156+211-238, test_subclients.py:316-335, probe hasattr en vivo / confianza alta; artefactos: docs/tasks/FIND-116.md; invariantes: comportamiento idéntico, prohibidos intactos; deuda: Steps 2-4 pendientes; queda_pendiente: edición + smokes + README + commit + FIND-119 |
...
- **Archivos:** `docs/tasks/FIND-116.md` (este file)
...
- **Archivos:** `docs/tasks/FIND-116.md` (sync), plan file (recitation FIND-116)
