...
## Metadata
- **Plan file:** docs/plans/2026-09-10-code.md (Task 8, Wave2 con PRX-06 + PROV-11, disjuntos)
- **Fuente:** docs/Backlog.md fila SRV-06 + plan Task 8
...
| `contract` | verificacion: pendiente | evidencia: plan Task 8 + docs.rs jsonwebtoken 11.0.0 | artefactos: docs/tasks/SRV-06.md, docs/architecture/adr/ADR-039-jwt-hs256-offline.md | invariantes: ver arriba | deuda: OIDC DEFER | queda_pendiente: MVP + verify + commit |
...
- **Archivos:** `docs/tasks/SRV-06.md`, `docs/architecture/adr/ADR-039-jwt-hs256-offline.md`
