...
> (`docs/plans/2026-09-13-cleanCA-fase2.md`, Wave 0, Task A1)
> **Inputs:** M1 baseline (`docs/tasks/C2M1.md`) · Config decision data
> (`docs/tasks/C2D0.md`) · Full architecture: `ARCHITECTURE.md`
>
...
- Plan: `docs/plans/2026-09-13-cleanCA-fase2.md` (Wave 0 · A1 · §Fase 3)
- Metrics: `docs/tasks/C2M1.md` (+ `docs/reviews/dsm-baseline.json`,
  `coupling-baseline.json`, `acyclic-baseline.txt`)
- Config decision data: `docs/tasks/C2D0.md` (human decision pending)
- Architecture: `ARCHITECTURE.md` (layered view — layers live *inside*)
- Task file: `docs/tasks/C2A1.md`
- ADRs: `docs/architecture/adr/` (convention: existing files rule)
