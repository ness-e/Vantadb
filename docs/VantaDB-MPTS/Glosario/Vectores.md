...
## El Problema de la Búsqueda Vectorial
...
- [HNSW](HNSW.md) — Índice ANN para búsqueda vectorial eficiente
- [Vector Similarity](Vector Similarity.md) — Métricas de distancia
- [mmap](mmap.md) — Para datasets que exceden RAM
- [BM25](BM25.md) — Búsqueda léxica complementaria
- [RRF](RRF.md) — Fusión de búsqueda vectorial + léxica
