...
La **búsqueda léxica** es una técnica de recuperación de información basada en la coincidencia exacta de términos (keywords) entre la consulta y los documentos, utilizando modelos estadísticos como [BM25](BM25.md) para calcular la relevancia.

## Diferencias con Búsqueda Vectorial

| Característica | Búsqueda Léxica | Búsqueda Vectorial |
|----------------|-----------------|-------------------|
...
- [Búsqueda Híbrida](Búsqueda Híbrida.md) - Combinación con vectorial
