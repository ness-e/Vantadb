...
|-----------|-----|-----|-----|
| Búsqueda vectorial (Rust) | 1.2 ms | 3.5 ms | 8.2 ms |
| Búsqueda vectorial (Python) | 62.0 ms | 67.1 ms | 71.9 ms |
| Búsqueda BM25 (Python) | 115.3 ms | 127.1 ms | 137.5 ms |
| Búsqueda híbrida (Python) | 179.8 ms | 191.8 ms | 211.1 ms |
...
- [Búsqueda Vectorial](Búsqueda Vectorial.md) - Contexto de uso
