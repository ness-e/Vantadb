...
| `FIND-67` | `docs/QUICKSTART.md` stale (v0.4.x + wheel 0.1.1 vs 0.5.0) — actualizar boundary + paths + revalidar | `docs/QUICKSTART.md` | 🟡 |
...
| `FIND-74` | `examples/README.md` índice + requirements 0.5.0 + enlazar QUICKSTART + decidir TS | `examples/`, `docs/QUICKSTART.md` | 🟢 |
| `FIND-75` | `vantadb-wasm/README.md` bundle stale 1.35 vs 1.58MB + input zero-copy pendiente | `vantadb-wasm/` | 🟢 |
| `FIND-76` | Documentar `jwt_secret` en CONFIGURATION.md + corregir link roto `HTTP_API.md:600` | `docs/operations/CONFIGURATION.md`, `docs/api/HTTP_API.md` | 🟢 |
