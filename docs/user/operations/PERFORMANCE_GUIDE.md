...
| Document | Contents |
|----------|----------|
| `docs/user/operations/BENCHMARKS.md` | Certified performance metrics for Rust core and Python SDK |
| `docs/user/glosario/benchmarks.md` | Benchmark glossary, methodology, definitions |
| `docs/user/glosario/pyo3.md` | PyO3 binding architecture and GIL management |
| `docs/user/glosario/latency.md` | Latency glossary with per-layer breakdowns |
| `vantadb-python/src/lib.rs` | Python SDK implementation (PyO3 bindings) |
| `docs/dev/Backlog.md` (DOC-21) | Performance clarity documentation task |
