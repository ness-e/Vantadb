...
Remote Ollama/LLM integration remains an external optional path; the preferred offline path is now `embed-local` (no external service). See `docs/user/operations/EXPERIMENTAL_FEATURES.md` for the full boundary.
