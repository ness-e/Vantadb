...
- Task file `docs/tasks/C2M1.md` · ⬜ PENDING · Ruta vanta-worker.
...
- Task file `docs/tasks/C2C1.md` · ⬜ PENDING · Ruta vanta-worker.
...
- Task file `docs/tasks/C2D0.md` · ⬜ PENDING · Ruta vanta-arch.
...
- Task file `docs/tasks/C2A1.md` · ⬜ PENDING · Ruta vanta-docs (con revisión vanta-arch).
...
- Task file `docs/tasks/C2S1.md` · ⬜ PENDING · Ruta vanta-worker. Depende de: M1 (números antes/después).
...
- Task file `docs/tasks/C2S7.md` · ⬜ PENDING · Ruta vanta-worker.
...
- Task file `docs/tasks/C2M2.md` · ⬜ PENDING · Ruta vanta-worker. Depende de: M1.
...
- Task file `docs/tasks/C2S2.md` · ⬜ PENDING · Ruta vanta-worker (diseño previo vanta-arch si DISCOVERY lo pide). Depende de: S1.
...
- Task file `docs/tasks/C2S3.md` · ⬜ PENDING · Ruta vanta-worker. Depende de: S1, M1. Slices obligatorios (txn primero, cache después).
...
- Task file `docs/tasks/C2S5.md` · ⬜ PENDING · Ruta vanta-worker.
...
- Task file `docs/tasks/C2T1.md` · ⬜ PENDING · Ruta vanta-worker.
...
- Task file `docs/tasks/C2T2.md` · ⬜ PENDING · Ruta vanta-worker (mem0: con cuidado integrations).
...
- Task file `docs/tasks/C2C2.md` · ⬜ PENDING · Ruta vanta-docs (con vanta-worker para firmas). Slices por binding.
...
- Task file `docs/tasks/C2A2.md` · ⬜ PENDING · Ruta vanta-worker (frontend) o docs.
...
- Task file `docs/tasks/C2M3.md` · ⬜ PENDING · Ruta vanta-worker. Depende de: M1 (medir ciclo), A1 (boundaries). BLOQUEADA hasta re-medición.
...
- Task file `docs/tasks/C2S6.md` · ⬜ PENDING · Ruta vanta-arch (diseño) → vanta-worker.
