...
> **Fuente:** `docs/Backlog.md` filas FIND-63–88 + FIND-90/91 (28 filas; FIND-89 completada 2026-09-14)
> **Rehace a:** `docs/plans/2026-09-10-correcciones.md` (26 tasks, sin iniciar, verificado contra review-doc y no contra código actual)
> **Autonomous:** false
...
- FIND-78: `README.md:16` enlaza `docs/reviews/research-vantadb-node-20260825.md` INEXISTENTE (Test-Path False); `:27` dice Node ≥ 18 pero `vantadb-ts/package.json:7` exige `node>=22.19` → nota de compat real.
...
- Appetite 1d ≥ esfuerzo 🟡 ✔. Task file `docs/tasks/FIND-90.md` (EXISTE — continuar, no regenerar) · ⬜ PENDING · Ruta vanta-worker.
...
- Appetite 1h ≥ 🟢 ✔. Task file `docs/tasks/FIND-91.md` (EXISTE) · ⬜ PENDING · Ruta vanta-worker.
...
- Appetite 1h ≥ 🟢 ✔. Task file `docs/tasks/FIND-64.md` (EXISTE) · ⬜ PENDING · Ruta vanta-lead (CI).
...
- Appetite 4h ≥ 🟢 ✔. Task file `docs/tasks/FIND-63.md` (EXISTE) · ⬜ PENDING · Ruta vanta-worker.
...
- Appetite 2h ≥ 🟢 ✔. Task file `docs/tasks/FIND-65.md` · ⬜ PENDING · Ruta vanta-worker.
...
- Appetite 2d ≥ 🟠 ✔. Task file `docs/tasks/FIND-88.md` · ⬜ PENDING · Ruta vanta-worker.
...
- Appetite 1d ≥ 🟡 ✔. Task file `docs/tasks/FIND-79.md` · ⬜ PENDING · Ruta vanta-worker.
...
- Appetite 2h ≥ 🟢 ✔. Task file `docs/tasks/FIND-78.md` · ⬜ PENDING · Ruta vanta-docs.

**Task 9: FIND-70 — bench en nightly con feature o skip documentado**
- Appetite 2h · 🟢 · 🟡 · `.github/workflows/heavy-bench-nightly-51.yml`, `Cargo.toml:240` (solo lectura), `docs/operations/BENCHMARKS.md`
...
- ⬆️ 0 / ⬇️ 1 step. DoD: contrato + task file + recitation; commit `ci:`; sin deuda.
- Appetite 2h ≥ 🟢 ✔. Task file `docs/tasks/FIND-70.md` · ⬜ PENDING · Ruta vanta-lead (CI).
...
- Appetite 4h ≥ 🟡 ✔ (ajustado de 🟢 por decisión de packaging). Task file `docs/tasks/FIND-87.md` · ⬜ PENDING · Ruta vanta-worker.
...
- ⬆️ 0 / ⬇️ 2 steps. DoD: contrato + task file + recitation; commit `fix:`; sin deuda.
- Appetite 4h ≥ 🟢 ✔. Task file `docs/tasks/FIND-73.md` · ⬜ PENDING · Ruta vanta-worker.
...
- Appetite 1d ≥ 🟡 ✔. Task file `docs/tasks/FIND-71.md` · ⬜ PENDING · Ruta vanta-worker.
...
- ⬆️ 0 / ⬇️ 1 step. DoD: contrato + task file + recitation; commit `docs:`; sin deuda.
- Appetite 1h ≥ 🟢 ✔. Task file `docs/tasks/FIND-77.md` · ⬜ PENDING · Ruta vanta-worker.
...
- Appetite 4h ≥ 🟡 ✔. Task file `docs/tasks/FIND-82.md` · ⬜ PENDING · Ruta vanta-worker.
...
- Appetite 1d ≥ 🟡 ✔. Task file `docs/tasks/FIND-83.md` · ⬜ PENDING · Ruta vanta-docs.

### Wave5 — docs grandes + server (disjuntos)

**Task 16: FIND-67 — QUICKSTART a 0.5.0 (+ legacy `WANTA_*`)**
- Appetite 4h · 🟡 · 🟠 · `docs/QUICKSTART.md:6,12,90,188-189`
...
- Appetite 4h ≥ 🟡 ✔. Task file `docs/tasks/FIND-67.md` · ⬜ PENDING · Ruta vanta-docs.
...
- ⬆️ 0 / ⬇️ 2 steps. DoD: contrato + task file + recitation; commit `docs:`; sin deuda.
- Appetite 1d ≥ 🟡 ✔. Task file `docs/tasks/FIND-68.md` · ⬜ PENDING · Ruta vanta-docs.
...
- Appetite 2h ≥ 🟢 ✔. Task file `docs/tasks/FIND-81.md` · ⬜ PENDING · Ruta vanta-docs.
...
- Appetite 2h ≥ 🟢 ✔. Task file `docs/tasks/FIND-66.md` · ⬜ PENDING · Ruta vanta-docs.
...
- Appetite 4h ≥ 🟢 ✔. Task file `docs/tasks/FIND-75.md` · ⬜ PENDING · Ruta vanta-worker.
...
- ⬆️ 0 / ⬇️ 1 step. DoD: contrato + task file + recitation; commit `fix:`; sin deuda.
- Appetite 2h ≥ 🟢 ✔. Task file `docs/tasks/FIND-69.md` · ⬜ PENDING · Ruta vanta-worker.
...
- Appetite 1d ≥ 🟡 ✔. Task file `docs/tasks/FIND-84.md` · ⬜ PENDING · Ruta vanta-worker.
...
- Appetite 1d ≥ 🟡 ✔. Task file `docs/tasks/FIND-85.md` · ⬜ PENDING · Ruta vanta-lead (CI) + worker.
...
- Appetite 1d ≥ 🟡 ✔. Task file `docs/tasks/FIND-80.md` · ⬜ PENDING · Ruta vanta-worker.

### Wave8 — examples + memory + bench-py (disjuntos; 74 post-67)

**Task 25: FIND-74 — requirements + enlaces + decisión TS**
- Appetite 4h · 🟢 · 🟢 · `examples/demo/requirements.txt`, `examples/README.md`, `docs/QUICKSTART.md`, `README.md`
...
- ⬆️ 0 / ⬇️ 1 step. DoD: contrato + task file + recitation; commit `docs:`; sin deuda.
- Appetite 4h ≥ 🟢 ✔. Task file `docs/tasks/FIND-74.md` · ⬜ PENDING · Ruta vanta-docs.
...
- Appetite 2d ≥ 🟡 ✔. Task file `docs/tasks/FIND-86.md` · ⬜ PENDING · Ruta vanta-worker.
...
- ⬆️ 0 / ⬇️ 2 steps. DoD: contrato + task file + recitation; commit `fix:`; sin deuda.
- Appetite 1d ≥ 🟡 ✔. Task file `docs/tasks/FIND-72.md` · ⬜ PENDING · Ruta vanta-worker.
...
Resultado: OK
Próxima acción: Ninguno — tarea cerrada. Push vía vanta-lead.
Contrato: verificacion: cargo test -p vanta-proxy cache -j 2 → 18/18 OK (ttl_expiry_predicate ok) + fmt OK + clippy vanta-proxy 0 warnings + rg 2x checked_sub/0 restas + pre-commit hooks OK. clippy -D warnings global bloqueado por dead_code pre-existente txn.rs:158 (repro sin fix via stash) → FIND-93. evidencia: claim fix solo-test / evidencia git show 432eee45 (3 files) + diff cache.rs:752-771 / confianza alta; claim prod intacto / evidencia diff sin :107-108 / alta. invariantes: prod is_expired intacto; 3 casos sobreviven; WIP ajeno intacto (FIND-88.md preservado en disco, FIND-63 worktree no tocado). artefactos: commit 432eee45; docs/tasks/FIND-65.md; Backlog FIND-65 ✅ + FIND-93 nueva. deuda: ninguna (FIND-93 queda ⬜). queda_pendiente: push vía vanta-lead.
...
Resultado: ✅
Próxima acción: git add docs/QUICKSTART.md docs/tasks/FIND-67.md + commit docs: FIND-67.
...
Contrato: verificacion: clippy vantadb default ✅ exit 0 + clippy vanta-proxy ✅ exit 0 (desbloqueo) + check workspace ✅ + tests storage::engine 383/383 ✅ (txn 7/7) + fmt ✅ + diff-check ✅ + hooks pre-commit ✅ + review vanta-review APPROVE + commit 0cd54e47. evidencia: claim fix cfg-gate / evidencia git show 0cd54e47 (txn.rs +4/-0 + FIND-93.md) / confianza alta; claim desbloqueo / evidencia clippy proxy rojo pre-fix → verde post-fix / alta; claim sin deuda / evidencia sin allow/expect, cfg simétrico / alta. artefactos: commit 0cd54e47; docs/tasks/FIND-93.md. invariantes: WIP ajeno intacto (commit solo 2 archivos propios); API pública intacta (pub(crate)); ERR-037 intacto (rama rayon idéntica). deuda: ninguna (colateral no-default-features sin soporte pre-existente, NOTICED BUT NOT TOUCHING). queda_pendiente: push vía vanta-lead; Backlog→avance NO tocado (race paralelo, orquestador)
...
- **Progreso masivo:** 31 filas Backlog → `docs/avance/` por dominio (desktop 63; ci-cd 64/66/70/92/95; proxy 68/88; memory 86; core-engine 91/93; bindings 69/73/75/78/79/82/83/84/85/87/90/94; operaciones 65/67/71/72/74/81; seguridad 80); FIND-76 SKIP → `historial/backlog-history.md`. Backlog 102→70 abiertas.
