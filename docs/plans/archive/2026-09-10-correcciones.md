...
> **Fuente:** docs/Backlog-correcciones.md (derivado de review 19 módulos 2026-09-10)
> **Autonomous:** false
...
- Resto (68-88): evidencia file:línea + comando en `docs/reviews/review-full-20260910-modulos.md` + apéndice (no re-verificado hoy por economía; cada ejecutor re-verifica en DISCOVERY y reporta divergencia como HALLAZGO).
...
- Task file `docs/tasks/FIND-63.md` · ⬜ PENDING · Ruta vanta-worker. DoD task/commit/release §plan. ShapeUp sí/sí/sí.
...
- Task file `docs/tasks/FIND-79.md` · ⬜ PENDING · Ruta vanta-worker.
...
- Task file `docs/tasks/FIND-78.md` · ⬜ PENDING · Ruta vanta-docs.
...
- Task file `docs/tasks/FIND-65.md` · ⬜ PENDING · Ruta vanta-worker.
...
- Task file `docs/tasks/FIND-68.md` · ⬜ PENDING · Ruta vanta-docs.

**Task 9: FIND-74 re-scopeada — requirements + enlaces + TS**
- Appetite 4h · 🟢 · 🟢 · `examples/demo/requirements.txt`, `docs/QUICKSTART.md`, `README.md`
...
- Task file `docs/tasks/FIND-74.md` · ⬜ PENDING · Ruta vanta-docs.
...
- Task file `docs/tasks/FIND-66.md` · ⬜ PENDING · Ruta vanta-docs.
...
- Task file `docs/tasks/FIND-75.md` · ⬜ PENDING · Ruta vanta-worker.
...
- Task file `docs/tasks/FIND-81.md` · ⬜ PENDING · Ruta vanta-docs.
...
- Task file `docs/tasks/FIND-69.md` · ⬜ PENDING · Ruta vanta-worker.
...
- Task file `docs/tasks/FIND-84.md` · ⬜ PENDING · Ruta vanta-worker.
...
- Task file `docs/tasks/FIND-73.md` · ⬜ PENDING · Ruta vanta-worker.
...
- Task file `docs/tasks/FIND-70.md` · ⬜ PENDING · Ruta vanta-lead (CI).
...
- Task file `docs/tasks/FIND-80.md` · ⬜ PENDING · Ruta vanta-worker.
...
- Task file `docs/tasks/FIND-72.md` · ⬜ PENDING · Ruta vanta-worker.
...
- Task file `docs/tasks/FIND-71.md` · ⬜ PENDING · Ruta vanta-worker.
...
- Task file `docs/tasks/FIND-85.md` · ⬜ PENDING · Ruta vanta-lead (CI) + worker.
...
- Task file `docs/tasks/FIND-86.md` · ⬜ PENDING · Ruta vanta-worker.
...
- Task file `docs/tasks/FIND-87.md` · ⬜ PENDING · Ruta vanta-worker.
...
- Task file `docs/tasks/FIND-88.md` · ⬜ PENDING · Ruta vanta-worker.
...
- Task file `docs/tasks/FIND-83.md` · ⬜ PENDING · Ruta vanta-docs.
...
- Task file `docs/tasks/FIND-64.md` · ⬜ PENDING · Ruta vanta-lead (CI).
...
- Task file `docs/tasks/FIND-82.md` · ⬜ PENDING · Ruta vanta-worker.
