...
> **Fuente:** `docs/Backlog.md` (FIND-98/116/117/119, SHOW-05, FIND-110/113 re-DEFER como specs, IMPL-112 spec cerrada `docs/tasks/FIND-112.md`) + deuda viva del cierre seguimiento-mvp + Gate P owner 2026-09-18
> **Autonomous:** false
...
> **SPEC:** `SPEC.md` raíz (§ Alcance cierre-mvp 2026-09-18: IMPL-112→spec FIND-112, S4/S6b spec-first, TUI mutantes-o-límite, Ask-first `~/.cargo/bin` aprobado FIND-98, ts/examples referenciar; counts 87; Open Questions del cierre) + spec IMPL-112 `docs/tasks/FIND-112.md` (5 puntos, P2-01 approve).
...
- **IMPL-112 slices mecánicos** (`docs/tasks/FIND-112.md:244-261,302-307`): S1 = `IngestRunnerCfg` + enum + G1 + tests 1-6,9-10 · S2 = `llm-driver` + G2 + tests 7-8 (condicional a S1 sin fricción).
...
### Wave0 — paridad binario + specs S4/S6b (disjuntos: fuera-del-repo · docs/tasks/110 · docs/tasks/113)
...
- Task file `docs/tasks/FIND-98.md` · ✅ COMPLETED · Ruta vanta-worker. Branch develop. Commit `docs: FIND-98 — ...` (task file; binario fuera del repo).

**Task 2: FIND-110-spec — diseño lifecycle S4 (spec-first, cero código)**
- **Appetite:** 1d · **Esfuerzo:** 🟡 · **Prioridad:** 🟡 Media · **Archivos clave:** `docs/tasks/FIND-110.md` (lectura: 5 evidencias + motivo), `vanta-memory/src/core/record/approval.rs`, `vanta-memory/src/gateway/approval_handlers.rs` (lectura)
...
- **Contrato:** `docs/tasks/FIND-110-spec.md` con (a) diseño submit→queue→decisión (quién produce, quién posee, lifecycle restart), (b) qué cambia en gateway/handlers (sin código, solo diseño), (c) gates+tests futuros, (d) qué NO cambia (sin persistencia salvo que el diseño la exija con motivo) + P2-01-spec; **cero código**.
...
- Task file `docs/tasks/FIND-110-spec.md` (ES el entregable) · ✅ COMPLETED · Ruta vanta-worker. Branch develop. Commit `docs: FIND-110-spec — ...`.

**Task 3: FIND-113-spec — diseño dueño scheduler (spec-first, cero código)**
- **Appetite:** 1d · **Esfuerzo:** 🟡 · **Prioridad:** 🟡 Media · **Archivos clave:** `docs/tasks/FIND-113.md` (lectura), `vanta-memory/src/services/pipeline_worker.rs` (lectura), `docs/tasks/FIND-112.md` §(c) (coherencia dueño, lectura sin editar)
...
- **Contrato:** `docs/tasks/FIND-113-spec.md` con (a) dueño del backend (dir estado, quién reclama locks TTL, scope-proceso), (b) superficie mínima (`scheduler_status`/`run_once` o equivalente), (c) gates+tests futuros, (d) coherencia con FIND-112 §(c) escrita + P2-01-spec; **cero código**.
...
- Task file `docs/tasks/FIND-113-spec.md` (ES el entregable) · ✅ COMPLETED · Ruta vanta-worker. Branch develop. Commit `docs: FIND-113-spec — ...`.
...
- **Appetite:** 2d · **Esfuerzo:** 🟡 · **Prioridad:** 🟠 Media-Alta · **Archivos clave:** spec `docs/tasks/FIND-112.md` (§ constructor, gates G0/G1/G3, tests 1-6,9-10 — LEER completa, es el contrato), `vanta-memory/src/wiki.rs:399-409`, `vanta-memory/src/ingest/worker.rs:187-235`, `vantadb-mcp/src/wiki.rs:274`
...
- Task file `docs/tasks/IMPL-112-S1.md` · ✅ COMPLETED · Ruta vanta-worker. Branch develop. Commit `feat: IMPL-112-S1 — ...`.
...
- Task file `docs/tasks/FIND-116.md` · ✅ COMPLETED · Ruta vanta-worker. Branch develop. Commit `refactor: FIND-116 — ...`.
...
- ⬆️ 0 / ⬇️ 1 step. **DoD:** contrato + task file mínimo + recitation; commit `docs:` SOLO `docs/tasks/FIND-119.md` en el repo padre; sin deuda.
...
- Task file `docs/tasks/FIND-119.md` · ✅ COMPLETED · Ruta vanta-worker. Branch develop. Commit `docs: FIND-119 — ...` (task file padre).
...
- Task file `docs/tasks/IMPL-112-S2.md` · ✅ COMPLETED · Ruta vanta-worker. Branch develop. Commit `feat: IMPL-112-S2 — ...`.
...
- Task file `docs/tasks/FIND-117.md` · ✅ COMPLETED · Ruta vanta-worker. Branch develop. Commit `fix: FIND-117 — ...`.

**Task 9: SHOW-05 (resto) — decisión `vantadb-ts/examples` + referencia**
- **Appetite:** max 1h · **Esfuerzo:** 🟢 · **Prioridad:** 🟢 Baja · **Archivos clave:** `vantadb-ts/examples/` (existe), `README.md`/`docs/QUICKSTART.md` (1 línea de referencia)
...
- Task file `docs/tasks/SHOW-05.md` · ✅ COMPLETED · Ruta vanta-worker. Branch develop. Commit `docs: SHOW-05 — ...`.
...
- Fila FIND-98 refrescada + filas FIND-117/FIND-119 creadas en `docs/Backlog.md` durante este plan-mode (gaps verificados, no inventados).
