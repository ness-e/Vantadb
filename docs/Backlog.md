...
| `FIND-116` | Baja | Otros ejemplos con API legacy (`demo.py`, `autogen/crewai/haystack/langgraph/mem0`, `smoke_test_extended.py`, tabla `search_memory` stale en `vantadb-python/README.md`) -> migrar a `Client`/`search` (patron FIND-114). Origen: FIND-114 Gate C 2026-09-18 | `examples/python/`, `vantadb-python/README.md` | 🟢 | 🟢 Baja | ⬜ Pendiente |
