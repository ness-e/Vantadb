...
def run_test():
    ...
    db = vanta.Client(db_path=DB_PATH)
    ...
    db2 = vanta.Client(db_path=DB_PATH)
    print("9. Reading memory data again to verify persistence")
    read_res2 = db2.memory.get("smoke/main", "first")
