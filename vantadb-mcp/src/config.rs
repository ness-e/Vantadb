...
/// - `full` (81 tools): All tools including code, wiki, skills, threads, scenes, context. Default for compat.
#[derive(Clone, Copy, Debug, PartialEq, Eq, Default)]
pub enum McpProfile {
    /// Full tool surface (81 tools) — all tools including code, wiki, skills, threads, scenes, context.
