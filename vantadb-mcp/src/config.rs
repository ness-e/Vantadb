...
/// - `full` (84 tools): All tools including code, wiki, skills, threads, scenes, dreams, context. Default for compat.
#[derive(Clone, Copy, Debug, PartialEq, Eq, Default)]
pub enum McpProfile {
    /// Full tool surface (84 tools) — all tools including code, wiki, skills, threads, scenes, dreams, context.
