//! Derived index and text index state management for `VantaEmbedded`.

use super::super::builder::VantaEmbedded;
use super::super::types::*;
use super::{
    memory_record_from_node, namespace_index_key, node_id_bytes, now_ms, payload_index_key,
    TextIndexCounts, DERIVED_INDEX_SCHEMA_VERSION,
};
...
impl VantaEmbedded {
    ...
    pub(crate) fn fresh_text_index_state(counts: TextIndexCounts) -> TextIndexState {
