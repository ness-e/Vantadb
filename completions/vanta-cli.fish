...
complete -c vanta-cli -n "__fish_vanta_cli_needs_command" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand put" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand get" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand list" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand rebuild-index" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand audit-index" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand repair-text-index" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand export" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand import" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand query" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand query" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand status" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand backup" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand restore" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand doctor" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand inspect" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand stats" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand completions" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand search" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand delete" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand delete-by-filter" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand count" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand similar-to-key" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand migrate; and not __fish_seen_subcommand_from plan run check help" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand migrate; and __fish_seen_subcommand_from plan" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand migrate; and __fish_seen_subcommand_from run" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand migrate; and __fish_seen_subcommand_from check" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand namespace; and not __fish_seen_subcommand_from list info help" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand namespace; and __fish_seen_subcommand_from list" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand namespace; and __fish_seen_subcommand_from info" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand snapshot; and not __fish_seen_subcommand_from create list help" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand snapshot; and __fish_seen_subcommand_from create" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand snapshot; and __fish_seen_subcommand_from list" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand snapshot; and __fish_seen_subcommand_from list" -l memory-limit -d 'Optional memory limit for the database engine, in bytes. Accepts suffixes: KB, MB, GB (also KiB, MiB, GiB), e.g. `500MB` or `2GB`. Defaults to the value of the VANTADB_MEMORY_LIMIT environment variable' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand wal; and not __fish_seen_subcommand_from compact vacuum salvage help" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand wal; and not __fish_seen_subcommand_from compact vacuum salvage help" -l memory-limit -d 'Optional memory limit for the database engine, in bytes. Accepts suffixes: KB, MB, GB (also KiB, MiB, GiB), e.g. `500MB` or `2GB`. Defaults to the value of the VANTADB_MEMORY_LIMIT environment variable' -r
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand wal; and not __fish_seen_subcommand_from compact vacuum salvage help" -s v -l verbose -d 'Enable verbose output'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand wal; and not __fish_seen_subcommand_from compact vacuum salvage help" -s h -l help -d 'Print help'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand wal; and not __fish_seen_subcommand_from compact vacuum salvage help" -f -a "compact" -d 'Compact the WAL: flush all data, archive the current WAL file, and start a fresh one'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand wal; and not __fish_seen_subcommand_from compact vacuum salvage help" -f -a "vacuum" -d 'Remove tombstoned nodes from HNSW and reclaim space'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand wal; and not __fish_seen_subcommand_from compact vacuum salvage help" -f -a "salvage" -d 'Salvage a truncated sharded WAL (FIND-109, opt-in): replay the coherent prefix and report explicit discards. The ERR-011 guard still aborts normal opens; this command is the explicit repair path'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand wal; and not __fish_seen_subcommand_from compact vacuum salvage help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand wal; and __fish_seen_subcommand_from compact" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand wal; and __fish_seen_subcommand_from vacuum" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand wal; and __fish_seen_subcommand_from salvage" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand wal; and __fish_seen_subcommand_from salvage" -l memory-limit -d 'Optional memory limit for the database engine, in bytes. Accepts suffixes: KB, MB, GB (also KiB, MiB, GiB), e.g. `500MB` or `2GB`. Defaults to the value of the VANTADB_MEMORY_LIMIT environment variable' -r
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand wal; and __fish_seen_subcommand_from salvage" -l dry-run -d 'Preview only: report what would be kept/discarded without mutating'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand wal; and __fish_seen_subcommand_from salvage" -s v -l verbose -d 'Enable verbose output'
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand wal; and __fish_seen_subcommand_from salvage" -s h -l help -d 'Print help'
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand wal; and __fish_seen_subcommand_from help" -f -a "salvage" -d 'Salvage a truncated sharded WAL (FIND-109, opt-in): replay the coherent prefix and report explicit discards. The ERR-011 guard still aborts normal opens; this command is the explicit repair path'
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand search-multi" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand search-all" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand server" -s d -l db -d 'Path to the database directory. Defaults to the value of the VANTADB_STORAGE_PATH environment variable, or \'./db\' if neither is set' -r
...
complete -c vanta-cli -n "__fish_vanta_cli_using_subcommand help; and __fish_seen_subcommand_from wal" -f -a "salvage" -d 'Salvage a truncated sharded WAL (FIND-109, opt-in): replay the coherent prefix and report explicit discards. The ERR-011 guard still aborts normal opens; this command is the explicit repair path'
