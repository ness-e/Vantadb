...
- **Soberanía y Lóbulos de Memoria:** El almacenamiento RocksDB está particionado anatómicamente en Column Families: `default` (Primario), `shadow_kernel`, `tombstones` y ahora `deep_memory`.
